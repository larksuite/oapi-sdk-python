...
class FileStatistics(object):
    ...
    def get(self, request: GetFileStatisticsRequest, option: Optional[RequestOption] = None) -> GetFileStatisticsResponse:
        if option is None:
    ...
    async def aget(self, request: GetFileStatisticsRequest, option: Optional[RequestOption] = None) -> GetFileStatisticsResponse:
        if option is None:
            option = RequestOption()

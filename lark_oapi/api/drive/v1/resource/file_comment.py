...
class FileComment(object):
    ...
    def batch_query(self, request: BatchQueryFileCommentRequest, option: Optional[RequestOption] = None) -> BatchQueryFileCommentResponse:
        if option is None:
    ...
    async def abatch_query(self, request: BatchQueryFileCommentRequest, option: Optional[RequestOption] = None) -> BatchQueryFileCommentResponse:
        if option is None:
            option = RequestOption()
    ...
    def create(self, request: CreateFileCommentRequest, option: Optional[RequestOption] = None) -> CreateFileCommentResponse:
        if option is None:
            option = RequestOption()
    ...
    async def acreate(self, request: CreateFileCommentRequest, option: Optional[RequestOption] = None) -> CreateFileCommentResponse:
        if option is None:
            option = RequestOption()
    ...
    async def aget(self, request: GetFileCommentRequest, option: Optional[RequestOption] = None) -> GetFileCommentResponse:
        if option is None:
            option = RequestOption()
    ...
    async def alist(self, request: ListFileCommentRequest, option: Optional[RequestOption] = None) -> ListFileCommentResponse:
        if option is None:
            option = RequestOption()
    ...
    def patch(self, request: PatchFileCommentRequest, option: Optional[RequestOption] = None) -> PatchFileCommentResponse:
        if option is None:
            option = RequestOption()
    ...
    async def apatch(self, request: PatchFileCommentRequest, option: Optional[RequestOption] = None) -> PatchFileCommentResponse:
        if option is None:
            option = RequestOption()

...
class FileSubscription(object):
    ...
    def create(self, request: CreateFileSubscriptionRequest, option: Optional[RequestOption] = None) -> CreateFileSubscriptionResponse:
        if option is None:
    ...
    async def acreate(self, request: CreateFileSubscriptionRequest, option: Optional[RequestOption] = None) -> CreateFileSubscriptionResponse:
        if option is None:
            option = RequestOption()
    ...
    def get(self, request: GetFileSubscriptionRequest, option: Optional[RequestOption] = None) -> GetFileSubscriptionResponse:
        if option is None:
            option = RequestOption()
    ...
    async def aget(self, request: GetFileSubscriptionRequest, option: Optional[RequestOption] = None) -> GetFileSubscriptionResponse:
        if option is None:
            option = RequestOption()
    ...
    def patch(self, request: PatchFileSubscriptionRequest, option: Optional[RequestOption] = None) -> PatchFileSubscriptionResponse:
        if option is None:
            option = RequestOption()
    ...
    async def apatch(self, request: PatchFileSubscriptionRequest, option: Optional[RequestOption] = None) -> PatchFileSubscriptionResponse:
        if option is None:
            option = RequestOption()

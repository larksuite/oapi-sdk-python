...
class FileViewRecord(object):
    ...
    def list(self, request: ListFileViewRecordRequest, option: Optional[RequestOption] = None) -> ListFileViewRecordResponse:
        if option is None:
    ...
    async def alist(self, request: ListFileViewRecordRequest, option: Optional[RequestOption] = None) -> ListFileViewRecordResponse:
        if option is None:
            option = RequestOption()

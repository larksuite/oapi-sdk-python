...
class UpdatePermissionPublicPasswordRequestBuilder(object):
    ...
    def __init__(self, update_permission_public_password_request: UpdatePermissionPublicPasswordRequest = UpdatePermissionPublicPasswordRequest()) -> None:
    ...
    def type(self, type: str) -> "UpdatePermissionPublicPasswordRequestBuilder":
        ...
        self._update_permission_public_password_request.queries["type"] = str(type)
        return self
    ...
    def token(self, token: str) -> "UpdatePermissionPublicPasswordRequestBuilder":
        ...
        self._update_permission_public_password_request.paths["token"] = token
        return self

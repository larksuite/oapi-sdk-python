...
class CreateFileSubscriptionRequestBuilder(object):
    def __init__(self) -> None:
        ...
        create_file_subscription_request.uri = (
            "/open-apis/drive/v1/files/:file_token/subscriptions"
        )
        create_file_subscription_request.token_types = {AccessTokenType.USER}
        self._create_file_subscription_request: CreateFileSubscriptionRequest = (
            create_file_subscription_request
        )
    ...
    def request_body(
        self, request_body: FileSubscription
    ) -> "CreateFileSubscriptionRequestBuilder":

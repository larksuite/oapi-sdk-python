...
class BitableTableRecordActionFieldIdentityUserBuilder(object):
    def __init__(self, bitable_table_record_action_field_identity_user: BitableTableRecordActionFieldIdentityUser = BitableTableRecordActionFieldIdentityUser({})) -> None:

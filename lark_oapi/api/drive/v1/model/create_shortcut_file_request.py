...
class CreateShortcutFileRequestBuilder(object):
    def __init__(self) -> None:
        ...
        create_shortcut_file_request.token_types = {
            AccessTokenType.USER,
            AccessTokenType.TENANT,
        }
        self._create_shortcut_file_request: CreateShortcutFileRequest = (
            create_shortcut_file_request
        )
    ...
    def request_body(
        self, request_body: CreateShortcutFileRequestBody
    ) -> "CreateShortcutFileRequestBuilder":

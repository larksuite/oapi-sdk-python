...
class BearServerMetaIntegrationAuthInfo(object):
    _types = {
        "session_key": str,
        "user_id": str,
        "open_app_id": str,
    ...
    @staticmethod
    def builder() -> "BearServerMetaIntegrationAuthInfoBuilder":
        return BearServerMetaIntegrationAuthInfoBuilder()
...
class BearServerMetaIntegrationAuthInfoBuilder(object):
    ...
    def user_id(self, user_id: str) -> "BearServerMetaIntegrationAuthInfoBuilder":
    ...
    def region(self, region: str) -> "BearServerMetaIntegrationAuthInfoBuilder":
    ...
    def bot_id(self, bot_id: str) -> "BearServerMetaIntegrationAuthInfoBuilder":
        self._bear_server_meta_integration_auth_info.bot_id = bot_id
        return self

    def auth_type(self, auth_type: str) -> "BearServerMetaIntegrationAuthInfoBuilder":
    ...
    def build(self) -> "BearServerMetaIntegrationAuthInfo":
        return self._bear_server_meta_integration_auth_info

...
class TransferOwnerPermissionMemberRequestBuilder(object):
    ...
    def need_notification(
        ...
        self._transfer_owner_permission_member_request.need_notification = (
            need_notification
        )
        self._transfer_owner_permission_member_request.add_query(
            "need_notification", need_notification
        )
        return self

    def remove_old_owner(
        self, remove_old_owner: bool
    ) -> "TransferOwnerPermissionMemberRequestBuilder":
        self._transfer_owner_permission_member_request.remove_old_owner = (
            remove_old_owner
        )
        self._transfer_owner_permission_member_request.add_query(

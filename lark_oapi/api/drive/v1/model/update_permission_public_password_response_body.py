...
class UpdatePermissionPublicPasswordResponseBodyBuilder(object):
    def __init__(self, update_permission_public_password_response_body: UpdatePermissionPublicPasswordResponseBody = UpdatePermissionPublicPasswordResponseBody({})) -> None:

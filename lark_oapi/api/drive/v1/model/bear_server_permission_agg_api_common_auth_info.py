...
class BearServerPermissionAggApiCommonAuthInfo(object):
    _types = {
        "session_key": str,
        "user_id": str,
        "open_app_id": str,
    ...
    @staticmethod
    def builder() -> "BearServerPermissionAggApiCommonAuthInfoBuilder":
        return BearServerPermissionAggApiCommonAuthInfoBuilder()
...
class BearServerPermissionAggApiCommonAuthInfoBuilder(object):
    ...
    def region(self, region: str) -> "BearServerPermissionAggApiCommonAuthInfoBuilder":
    ...
    def bot_id(self, bot_id: str) -> "BearServerPermissionAggApiCommonAuthInfoBuilder":
    ...
    def build(self) -> "BearServerPermissionAggApiCommonAuthInfo":
        return self._bear_server_permission_agg_api_common_auth_info

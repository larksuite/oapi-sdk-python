...
class PatchFileSubscriptionRequestBodyBuilder(object):
    def __init__(self, patch_file_subscription_request_body: PatchFileSubscriptionRequestBody = PatchFileSubscriptionRequestBody({})) -> None:
        self._patch_file_subscription_request_body: PatchFileSubscriptionRequestBody = patch_file_subscription_request_body

...
class GetFileSubscriptionRequestBuilder(object):
    def __init__(self) -> None:
        ...
        get_file_subscription_request.uri = (
        ...
        self._get_file_subscription_request: GetFileSubscriptionRequest = (
            get_file_subscription_request
        )
    ...
    def subscription_id(
        ...
        self._get_file_subscription_request.paths["subscription_id"] = str(
            subscription_id
        )
        return self

    def request_body(
        self, request_body: GetFileSubscriptionRequestBody
    ) -> "GetFileSubscriptionRequestBuilder":

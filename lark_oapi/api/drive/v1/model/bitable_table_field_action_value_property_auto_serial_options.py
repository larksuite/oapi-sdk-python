...
class BitableTableFieldActionValuePropertyAutoSerialOptionsBuilder(object):
    def __init__(self, bitable_table_field_action_value_property_auto_serial_options: BitableTableFieldActionValuePropertyAutoSerialOptions = BitableTableFieldActionValuePropertyAutoSerialOptions({})) -> None:

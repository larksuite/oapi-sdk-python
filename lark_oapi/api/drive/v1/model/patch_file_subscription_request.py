...
class PatchFileSubscriptionRequestBuilder(object):
    def __init__(self) -> None:
        ...
        patch_file_subscription_request.uri = (
        ...
        self._patch_file_subscription_request: PatchFileSubscriptionRequest = (
            patch_file_subscription_request
        )
    ...
    ) -> "PatchFileSubscriptionRequestBuilder":
        self._patch_file_subscription_request.subscription_id = subscription_id
        self._patch_file_subscription_request.paths["subscription_id"] = str(
            subscription_id
        )
        return self

    def request_body(
        self, request_body: PatchFileSubscriptionRequestBody
    ) -> "PatchFileSubscriptionRequestBuilder":

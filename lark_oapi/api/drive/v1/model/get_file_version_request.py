...
class GetFileVersionRequestBuilder(object):
    ...
    def obj_type(self, obj_type: str) -> "GetFileVersionRequestBuilder":
        ...
        self._get_file_version_request.queries["obj_type"] = str(obj_type)
        return self

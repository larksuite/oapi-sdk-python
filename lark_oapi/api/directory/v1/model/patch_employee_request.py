...
from .patch_employee_request_body import PatchEmployeeRequestBody
...
class PatchEmployeeRequest(BaseRequest):
    def __init__(self) -> None:
        ...
        self.request_body: Optional[PatchEmployeeRequestBody] = None
...
class PatchEmployeeRequestBuilder(object):
    ...
    def employee_id_type(self, employee_id_type: str) -> "PatchEmployeeRequestBuilder":
        self._patch_employee_request.employee_id_type = employee_id_type

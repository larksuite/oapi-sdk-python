...
class DeleteDepartmentRequestBuilder(object):
    ...
    def __init__(self) -> None:
        ...
        delete_department_request.uri = "/open-apis/directory/v1/departments/:department_id"
        delete_department_request.token_types = {AccessTokenType.USER, AccessTokenType.TENANT}

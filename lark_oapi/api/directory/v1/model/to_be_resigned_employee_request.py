...
from .to_be_resigned_employee_request_body import ToBeResignedEmployeeRequestBody


class ToBeResignedEmployeeRequest(BaseRequest):
    def __init__(self) -> None:
        super().__init__()
        self.employee_id_type: Optional[str] = None
        self.department_id_type: Optional[str] = None
        self.employee_id: Optional[str] = None
        self.request_body: Optional[ToBeResignedEmployeeRequestBody] = None

    @staticmethod
    def builder() -> "ToBeResignedEmployeeRequestBuilder":
        return ToBeResignedEmployeeRequestBuilder()
...
class ToBeResignedEmployeeRequestBuilder(object):
    ...
    def employee_id(self, employee_id: str) -> "ToBeResignedEmployeeRequestBuilder":
        self._to_be_resigned_employee_request.employee_id = employee_id
    ...
    def build(self) -> ToBeResignedEmployeeRequest:
        return self._to_be_resigned_employee_request

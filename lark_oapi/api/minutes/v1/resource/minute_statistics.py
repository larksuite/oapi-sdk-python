...
from ..model.get_minute_statistics_request import GetMinuteStatisticsRequest
from ..model.get_minute_statistics_response import GetMinuteStatisticsResponse


class MinuteStatistics(object):

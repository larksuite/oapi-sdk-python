...
from ..model.get_minute_transcript_request import GetMinuteTranscriptRequest
from ..model.get_minute_transcript_response import GetMinuteTranscriptResponse


class MinuteTranscript(object):

...
class SearchCustomWorkplaceAccessDataRequestBuilder(object):
    ...
    def from_date(
        self, from_date: str
    ) -> "SearchCustomWorkplaceAccessDataRequestBuilder":
        self._search_custom_workplace_access_data_request.from_date = from_date
        self._search_custom_workplace_access_data_request.add_query(
            "from_date", from_date
        )
        return self
    ...
    def custom_workplace_id(
        self, custom_workplace_id: str
    ) -> "SearchCustomWorkplaceAccessDataRequestBuilder":
        self._search_custom_workplace_access_data_request.custom_workplace_id = (
            custom_workplace_id
        )
        self._search_custom_workplace_access_data_request.add_query(
            "custom_workplace_id", custom_workplace_id
        )
        return self

...
class SearchWorkplaceAccessDataResponseBodyBuilder(object):
    def __init__(self) -> None:
        self._search_workplace_access_data_response_body = (
            SearchWorkplaceAccessDataResponseBody()
        )

    def items(
        self, items: List[WorkplaceAccessData]
    ) -> "SearchWorkplaceAccessDataResponseBodyBuilder":

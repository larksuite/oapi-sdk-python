...
class SearchWorkplaceAccessDataRequestBuilder(object):
    ...
    def __init__(self, search_workplace_access_data_request: SearchWorkplaceAccessDataRequest = SearchWorkplaceAccessDataRequest()) -> None:
    ...
    def from_date(self, from_date: str) -> "SearchWorkplaceAccessDataRequestBuilder":
        ...
        self._search_workplace_access_data_request.queries["from_date"] = str(from_date)
        return self
    ...
    def to_date(self, to_date: str) -> "SearchWorkplaceAccessDataRequestBuilder":
        ...
        self._search_workplace_access_data_request.queries["to_date"] = str(to_date)
        return self
    ...
    def page_size(self, page_size: int) -> "SearchWorkplaceAccessDataRequestBuilder":
        ...
        self._search_workplace_access_data_request.queries["page_size"] = str(page_size)
        return self
    ...
    def page_token(self, page_token: str) -> "SearchWorkplaceAccessDataRequestBuilder":
        ...
        self._search_workplace_access_data_request.queries["page_token"] = str(page_token)
        return self

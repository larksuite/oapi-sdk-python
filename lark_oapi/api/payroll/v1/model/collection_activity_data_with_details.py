...
class CollectionActivityDataWithDetailsBuilder(object):
    def __init__(self) -> None:
        self._collection_activity_data_with_details = (
            CollectionActivityDataWithDetails()
        )

    def activity_id(
        self, activity_id: str
    ) -> "CollectionActivityDataWithDetailsBuilder":
    ...
    def template_version_id(
        ...
        self._collection_activity_data_with_details.template_version_id = (
            template_version_id
        )
        return self
    ...
    def calendar_effective_date(
        self, calendar_effective_date: str
    ) -> "CollectionActivityDataWithDetailsBuilder":
        self._collection_activity_data_with_details.calendar_effective_date = (
            calendar_effective_date
        )
        return self
    ...
    def collection_employee_datas(
        self, collection_employee_datas: List[CollectionEmployeeData]
    ) -> "CollectionActivityDataWithDetailsBuilder":
        self._collection_activity_data_with_details.collection_employee_datas = (
            collection_employee_datas
        )
        return self

    def activity_approval_pass_time(
        self, activity_approval_pass_time: str
    ) -> "CollectionActivityDataWithDetailsBuilder":
        self._collection_activity_data_with_details.activity_approval_pass_time = (
            activity_approval_pass_time
        )
        return self

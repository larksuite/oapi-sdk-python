...
from .upload_part_app_storage_request_body import UploadPartAppStorageRequestBody


class UploadPartAppStorageRequest(BaseRequest):
    def __init__(self) -> None:
        super().__init__()
        self.app_id: Optional[str] = None
        self.request_body: Optional[UploadPartAppStorageRequestBody] = None

    @staticmethod
    def builder() -> "UploadPartAppStorageRequestBuilder":
        return UploadPartAppStorageRequestBuilder()
...
class UploadPartAppStorageRequestBuilder(object):
    ...
    def build(self) -> UploadPartAppStorageRequest:
        return self._upload_part_app_storage_request

...
class RoomLevel(object):
    ...
    def create(self, request: CreateRoomLevelRequest, option: RequestOption = RequestOption()) -> CreateRoomLevelResponse:
        # 鉴权、获取token
    ...
    def search(self, request: SearchRoomLevelRequest, option: RequestOption = RequestOption()) -> SearchRoomLevelResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

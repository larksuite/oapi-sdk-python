...
class Meeting(object):
    ...
    def kickout(self, request: KickoutMeetingRequest, option: RequestOption = RequestOption()) -> KickoutMeetingResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def list_by_no(self, request: ListByNoMeetingRequest, option: RequestOption = RequestOption()) -> ListByNoMeetingResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def set_host(self, request: SetHostMeetingRequest, option: RequestOption = RequestOption()) -> SetHostMeetingResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

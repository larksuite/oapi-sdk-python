...
class MeetingRecording(object):
    ...
    def get(self, request: GetMeetingRecordingRequest, option: RequestOption = RequestOption()) -> GetMeetingRecordingResponse:
        # 鉴权、获取token
    ...
    def set_permission(self, request: SetPermissionMeetingRecordingRequest, option: RequestOption = RequestOption()) -> SetPermissionMeetingRecordingResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def start(self, request: StartMeetingRecordingRequest, option: RequestOption = RequestOption()) -> StartMeetingRecordingResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def stop(self, request: StopMeetingRecordingRequest, option: RequestOption = RequestOption()) -> StopMeetingRecordingResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

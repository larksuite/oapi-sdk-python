...
class ParticipantList(object):
    ...
    def get(self, request: GetParticipantListRequest, option: Optional[RequestOption] = None) -> GetParticipantListResponse:
        if option is None:
    ...
    async def aget(self, request: GetParticipantListRequest, option: Optional[RequestOption] = None) -> GetParticipantListResponse:
        if option is None:
            option = RequestOption()

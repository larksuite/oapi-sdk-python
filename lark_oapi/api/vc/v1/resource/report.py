...
class Report(object):
    ...
    def get_daily(self, request: GetDailyReportRequest, option: RequestOption = RequestOption()) -> GetDailyReportResponse:
        # 鉴权、获取token
    ...
    def get_top_user(self, request: GetTopUserReportRequest, option: RequestOption = RequestOption()) -> GetTopUserReportResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

...
class GetParticipantQualityListRequestBuilder(object):
    ...
    def __init__(self, get_participant_quality_list_request: GetParticipantQualityListRequest = GetParticipantQualityListRequest()) -> None:
    ...
    def meeting_start_time(self, meeting_start_time: int) -> "GetParticipantQualityListRequestBuilder":
        ...
        self._get_participant_quality_list_request.queries["meeting_start_time"] = str(meeting_start_time)
        return self
    ...
    def meeting_end_time(self, meeting_end_time: int) -> "GetParticipantQualityListRequestBuilder":
        ...
        self._get_participant_quality_list_request.queries["meeting_end_time"] = str(meeting_end_time)
        return self
    ...
    def meeting_no(self, meeting_no: str) -> "GetParticipantQualityListRequestBuilder":
        ...
        self._get_participant_quality_list_request.queries["meeting_no"] = str(meeting_no)
        return self
    ...
    def join_time(self, join_time: int) -> "GetParticipantQualityListRequestBuilder":
        ...
        self._get_participant_quality_list_request.queries["join_time"] = str(join_time)
        return self
    ...
    def user_id(self, user_id: str) -> "GetParticipantQualityListRequestBuilder":
        ...
        self._get_participant_quality_list_request.queries["user_id"] = str(user_id)
        return self
    ...
    def room_id(self, room_id: str) -> "GetParticipantQualityListRequestBuilder":
        ...
        self._get_participant_quality_list_request.queries["room_id"] = str(room_id)
        return self
    ...
    def page_size(self, page_size: int) -> "GetParticipantQualityListRequestBuilder":
        ...
        self._get_participant_quality_list_request.queries["page_size"] = str(page_size)
        return self
    ...
    def page_token(self, page_token: str) -> "GetParticipantQualityListRequestBuilder":
        ...
        self._get_participant_quality_list_request.queries["page_token"] = str(page_token)
        return self
    ...
    def user_id_type(self, user_id_type: str) -> "GetParticipantQualityListRequestBuilder":
        ...
        self._get_participant_quality_list_request.queries["user_id_type"] = str(user_id_type)
        return self

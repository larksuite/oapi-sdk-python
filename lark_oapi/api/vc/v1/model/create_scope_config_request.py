...
class CreateScopeConfigRequestBuilder(object):
    ...
    def __init__(self, create_scope_config_request: CreateScopeConfigRequest = CreateScopeConfigRequest()) -> None:
    ...
    def user_id_type(self, user_id_type: str) -> "CreateScopeConfigRequestBuilder":
        ...
        self._create_scope_config_request.queries["user_id_type"] = str(user_id_type)
        return self

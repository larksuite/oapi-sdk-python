...
class PatchReserveConfigFormRequestBuilder(object):
    def __init__(self) -> None:
        ...
        patch_reserve_config_form_request.uri = (
        ...
        self._patch_reserve_config_form_request: PatchReserveConfigFormRequest = (
            patch_reserve_config_form_request
        )
    ...
    ) -> "PatchReserveConfigFormRequestBuilder":
        self._patch_reserve_config_form_request.reserve_config_id = reserve_config_id
        self._patch_reserve_config_form_request.paths["reserve_config_id"] = str(
            reserve_config_id
        )
        return self

    def request_body(
        self, request_body: PatchReserveConfigFormRequestBody
    ) -> "PatchReserveConfigFormRequestBuilder":

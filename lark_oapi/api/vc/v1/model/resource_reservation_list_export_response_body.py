...
class ResourceReservationListExportResponseBodyBuilder(object):
    def __init__(self, resource_reservation_list_export_response_body: ResourceReservationListExportResponseBody = ResourceReservationListExportResponseBody({})) -> None:

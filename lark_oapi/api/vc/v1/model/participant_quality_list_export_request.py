...
class ParticipantQualityListExportRequestBuilder(object):
    ...
    def __init__(self, participant_quality_list_export_request: ParticipantQualityListExportRequest = ParticipantQualityListExportRequest()) -> None:
    ...
    def user_id_type(self, user_id_type: str) -> "ParticipantQualityListExportRequestBuilder":
        ...
        self._participant_quality_list_export_request.queries["user_id_type"] = str(user_id_type)
        return self

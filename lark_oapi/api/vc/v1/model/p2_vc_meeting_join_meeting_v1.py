...
class P2VcMeetingJoinMeetingV1Data(object):
    _types = {
...
class P2VcMeetingJoinMeetingV1(EventContext):
    _types = {"event": P2VcMeetingJoinMeetingV1Data}

    def __init__(self, d=None):
        super().__init__(d)
        self._types.update(super()._types)
        self.event: Optional[P2VcMeetingJoinMeetingV1Data] = None
        init(self, d, self._types)

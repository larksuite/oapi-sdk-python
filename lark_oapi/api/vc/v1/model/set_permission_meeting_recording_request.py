...
from .set_permission_meeting_recording_request_body import (
    SetPermissionMeetingRecordingRequestBody,
)
...
class SetPermissionMeetingRecordingRequestBuilder(object):
    ...
    ) -> "SetPermissionMeetingRecordingRequestBuilder":
        self._set_permission_meeting_recording_request.user_id_type = user_id_type
        self._set_permission_meeting_recording_request.add_query(
    ...
    def meeting_id(
        ...
        self._set_permission_meeting_recording_request.paths["meeting_id"] = str(
            meeting_id
        )
        return self

    def request_body(
        self, request_body: SetPermissionMeetingRecordingRequestBody
    ) -> "SetPermissionMeetingRecordingRequestBuilder":

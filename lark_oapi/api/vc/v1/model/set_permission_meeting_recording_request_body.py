...
class SetPermissionMeetingRecordingRequestBodyBuilder(object):
    def __init__(self, set_permission_meeting_recording_request_body: SetPermissionMeetingRecordingRequestBody = SetPermissionMeetingRecordingRequestBody({})) -> None:

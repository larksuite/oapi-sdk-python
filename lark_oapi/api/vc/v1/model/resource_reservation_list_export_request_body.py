...
class ResourceReservationListExportRequestBodyBuilder(object):
    def __init__(self, resource_reservation_list_export_request_body: ResourceReservationListExportRequestBody = ResourceReservationListExportRequestBody({})) -> None:

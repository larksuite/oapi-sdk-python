...
class ResourceReservationListExportRequestBodyBuilder(object):
    def __init__(self) -> None:
        self._resource_reservation_list_export_request_body = (
            ResourceReservationListExportRequestBody()
        )

    def room_level_id(
        self, room_level_id: str
    ) -> "ResourceReservationListExportRequestBodyBuilder":
        self._resource_reservation_list_export_request_body.room_level_id = (
            room_level_id
        )
        return self

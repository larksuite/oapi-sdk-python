...
class GetReserveConfigAdminRequestBuilder(object):
    def __init__(self) -> None:
        ...
        get_reserve_config_admin_request.uri = (
        ...
        self._get_reserve_config_admin_request: GetReserveConfigAdminRequest = (
            get_reserve_config_admin_request
        )
    ...
    ) -> "GetReserveConfigAdminRequestBuilder":
        self._get_reserve_config_admin_request.reserve_config_id = reserve_config_id
        self._get_reserve_config_admin_request.paths["reserve_config_id"] = str(
            reserve_config_id
        )
        return self

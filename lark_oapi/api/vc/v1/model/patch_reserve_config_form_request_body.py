...
class PatchReserveConfigFormRequestBodyBuilder(object):
    def __init__(self) -> None:
        self._patch_reserve_config_form_request_body = (
            PatchReserveConfigFormRequestBody()
        )
    ...
    ) -> "PatchReserveConfigFormRequestBodyBuilder":
        self._patch_reserve_config_form_request_body.reserve_form_config = (
            reserve_form_config
        )
        return self

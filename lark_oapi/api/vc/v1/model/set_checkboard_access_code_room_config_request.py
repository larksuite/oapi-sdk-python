...
class SetCheckboardAccessCodeRoomConfigRequestBuilder(object):
    ...
    def __init__(self, set_checkboard_access_code_room_config_request: SetCheckboardAccessCodeRoomConfigRequest = SetCheckboardAccessCodeRoomConfigRequest()) -> None:

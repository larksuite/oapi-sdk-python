...
class SetCheckboardAccessCodeRoomConfigResponseBodyBuilder(object):
    def __init__(self, set_checkboard_access_code_room_config_response_body: SetCheckboardAccessCodeRoomConfigResponseBody = SetCheckboardAccessCodeRoomConfigResponseBody({})) -> None:

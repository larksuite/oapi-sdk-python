...
class ParticipantListExportRequestBuilder(object):
    def __init__(self) -> None:
        ...
        participant_list_export_request.uri = (
            "/open-apis/vc/v1/exports/participant_list"
        )
        participant_list_export_request.token_types = {
            AccessTokenType.TENANT,
            AccessTokenType.USER,
        }
        self._participant_list_export_request: ParticipantListExportRequest = (
            participant_list_export_request
        )
    ...
    def request_body(
        self, request_body: ParticipantListExportRequestBody
    ) -> "ParticipantListExportRequestBuilder":

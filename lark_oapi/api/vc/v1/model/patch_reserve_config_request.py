...
class PatchReserveConfigRequestBuilder(object):
    def __init__(self) -> None:
        ...
        patch_reserve_config_request.uri = (
            "/open-apis/vc/v1/reserve_configs/:reserve_config_id"
        )
        patch_reserve_config_request.token_types = {AccessTokenType.TENANT}
        self._patch_reserve_config_request: PatchReserveConfigRequest = (
            patch_reserve_config_request
        )
    ...
    ) -> "PatchReserveConfigRequestBuilder":
        self._patch_reserve_config_request.reserve_config_id = reserve_config_id
        self._patch_reserve_config_request.paths["reserve_config_id"] = str(
            reserve_config_id
        )
        return self

    def request_body(
        self, request_body: PatchReserveConfigRequestBody
    ) -> "PatchReserveConfigRequestBuilder":

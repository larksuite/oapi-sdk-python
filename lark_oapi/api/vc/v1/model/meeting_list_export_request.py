...
class MeetingListExportRequestBuilder(object):
    def __init__(self) -> None:
        ...
        meeting_list_export_request.token_types = {
            AccessTokenType.TENANT,
            AccessTokenType.USER,
        }
        self._meeting_list_export_request: MeetingListExportRequest = (
            meeting_list_export_request
        )
    ...
    def request_body(
        self, request_body: MeetingListExportRequestBody
    ) -> "MeetingListExportRequestBuilder":

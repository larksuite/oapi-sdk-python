...
from .patch_reserve_config_disable_inform_request_body import (
    PatchReserveConfigDisableInformRequestBody,
)
...
class PatchReserveConfigDisableInformRequestBuilder(object):
    ...
    ) -> "PatchReserveConfigDisableInformRequestBuilder":
        self._patch_reserve_config_disable_inform_request.user_id_type = user_id_type
        self._patch_reserve_config_disable_inform_request.add_query(
    ...
    def reserve_config_id(
        ...
        self._patch_reserve_config_disable_inform_request.reserve_config_id = (
            reserve_config_id
        )
        self._patch_reserve_config_disable_inform_request.paths["reserve_config_id"] = (
            str(reserve_config_id)
        )
        return self

    def request_body(
        self, request_body: PatchReserveConfigDisableInformRequestBody
    ) -> "PatchReserveConfigDisableInformRequestBuilder":

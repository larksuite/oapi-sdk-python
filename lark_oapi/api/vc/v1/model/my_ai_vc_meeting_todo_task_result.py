...
class MyAiVcMeetingTodoTaskResultBuilder(object):
    ...
    def meeting_todo_task_or_fail_reason(
        self, meeting_todo_task_or_fail_reason: str
    ) -> "MyAiVcMeetingTodoTaskResultBuilder":
        self._my_ai_vc_meeting_todo_task_result.meeting_todo_task_or_fail_reason = (
            meeting_todo_task_or_fail_reason
        )
        return self

    def meeting_todo_task(
        self, meeting_todo_task: str
    ) -> "MyAiVcMeetingTodoTaskResultBuilder":

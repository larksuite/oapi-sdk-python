...
class GetReserveConfigFormRequestBuilder(object):
    def __init__(self) -> None:
        ...
        get_reserve_config_form_request.uri = (
            "/open-apis/vc/v1/reserve_configs/:reserve_config_id/form"
        )
        get_reserve_config_form_request.token_types = {AccessTokenType.TENANT}
        self._get_reserve_config_form_request: GetReserveConfigFormRequest = (
            get_reserve_config_form_request
        )
    ...
    ) -> "GetReserveConfigFormRequestBuilder":
        self._get_reserve_config_form_request.reserve_config_id = reserve_config_id
        self._get_reserve_config_form_request.paths["reserve_config_id"] = str(
            reserve_config_id
        )
        return self

...
class PatchReserveConfigDisableInformRequestBodyBuilder(object):
    def __init__(self, patch_reserve_config_disable_inform_request_body: PatchReserveConfigDisableInformRequestBody = PatchReserveConfigDisableInformRequestBody({})) -> None:

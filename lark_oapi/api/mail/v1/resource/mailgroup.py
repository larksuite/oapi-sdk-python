...
class Mailgroup(object):
    ...
    def create(self, request: CreateMailgroupRequest, option: RequestOption = RequestOption()) -> CreateMailgroupResponse:
        # 鉴权、获取token
    ...
    def delete(self, request: DeleteMailgroupRequest, option: RequestOption = RequestOption()) -> DeleteMailgroupResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def update(self, request: UpdateMailgroupRequest, option: RequestOption = RequestOption()) -> UpdateMailgroupResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

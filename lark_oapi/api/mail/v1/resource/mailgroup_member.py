...
class MailgroupMember(object):
    ...
    def batch_create(self, request: BatchCreateMailgroupMemberRequest, option: RequestOption = RequestOption()) -> BatchCreateMailgroupMemberResponse:
        # 鉴权、获取token
    ...
    def batch_delete(self, request: BatchDeleteMailgroupMemberRequest, option: RequestOption = RequestOption()) -> BatchDeleteMailgroupMemberResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def create(self, request: CreateMailgroupMemberRequest, option: RequestOption = RequestOption()) -> CreateMailgroupMemberResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def delete(self, request: DeleteMailgroupMemberRequest, option: RequestOption = RequestOption()) -> DeleteMailgroupMemberResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def get(self, request: GetMailgroupMemberRequest, option: RequestOption = RequestOption()) -> GetMailgroupMemberResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def list(self, request: ListMailgroupMemberRequest, option: RequestOption = RequestOption()) -> ListMailgroupMemberResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

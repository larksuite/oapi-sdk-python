...
class MailgroupAlias(object):
    ...
    def create(self, request: CreateMailgroupAliasRequest, option: RequestOption = RequestOption()) -> CreateMailgroupAliasResponse:
        # 鉴权、获取token
    ...
    def delete(self, request: DeleteMailgroupAliasRequest, option: RequestOption = RequestOption()) -> DeleteMailgroupAliasResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def list(self, request: ListMailgroupAliasRequest, option: RequestOption = RequestOption()) -> ListMailgroupAliasResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

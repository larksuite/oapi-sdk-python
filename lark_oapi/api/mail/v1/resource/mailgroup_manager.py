...
class MailgroupManager(object):
    ...
    def batch_create(self, request: BatchCreateMailgroupManagerRequest, option: RequestOption = RequestOption()) -> BatchCreateMailgroupManagerResponse:
        # 鉴权、获取token
    ...
    def batch_delete(self, request: BatchDeleteMailgroupManagerRequest, option: RequestOption = RequestOption()) -> BatchDeleteMailgroupManagerResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def list(self, request: ListMailgroupManagerRequest, option: RequestOption = RequestOption()) -> ListMailgroupManagerResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

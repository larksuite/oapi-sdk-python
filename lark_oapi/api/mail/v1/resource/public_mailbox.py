...
class PublicMailbox(object):
    ...
    def create(self, request: CreatePublicMailboxRequest, option: RequestOption = RequestOption()) -> CreatePublicMailboxResponse:
        # 鉴权、获取token
    ...
    def delete(self, request: DeletePublicMailboxRequest, option: RequestOption = RequestOption()) -> DeletePublicMailboxResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def get(self, request: GetPublicMailboxRequest, option: RequestOption = RequestOption()) -> GetPublicMailboxResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def list(self, request: ListPublicMailboxRequest, option: RequestOption = RequestOption()) -> ListPublicMailboxResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def patch(self, request: PatchPublicMailboxRequest, option: RequestOption = RequestOption()) -> PatchPublicMailboxResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def update(self, request: UpdatePublicMailboxRequest, option: RequestOption = RequestOption()) -> UpdatePublicMailboxResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

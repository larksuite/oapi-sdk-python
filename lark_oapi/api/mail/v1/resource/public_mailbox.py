...
class PublicMailbox(object):
    ...
    def create(self, request: CreatePublicMailboxRequest, option: Optional[RequestOption] = None) -> CreatePublicMailboxResponse:
        if option is None:
    ...
    async def acreate(self, request: CreatePublicMailboxRequest, option: Optional[RequestOption] = None) -> CreatePublicMailboxResponse:
        if option is None:
            option = RequestOption()
    ...
    def delete(self, request: DeletePublicMailboxRequest, option: Optional[RequestOption] = None) -> DeletePublicMailboxResponse:
        if option is None:
            option = RequestOption()
    ...
    async def adelete(self, request: DeletePublicMailboxRequest, option: Optional[RequestOption] = None) -> DeletePublicMailboxResponse:
        if option is None:
            option = RequestOption()
    ...
    async def aget(self, request: GetPublicMailboxRequest, option: Optional[RequestOption] = None) -> GetPublicMailboxResponse:
        if option is None:
            option = RequestOption()
    ...
    def list(self, request: ListPublicMailboxRequest, option: Optional[RequestOption] = None) -> ListPublicMailboxResponse:
        if option is None:
            option = RequestOption()
    ...
    async def alist(self, request: ListPublicMailboxRequest, option: Optional[RequestOption] = None) -> ListPublicMailboxResponse:
        if option is None:
            option = RequestOption()
    ...
    def patch(self, request: PatchPublicMailboxRequest, option: Optional[RequestOption] = None) -> PatchPublicMailboxResponse:
        if option is None:
            option = RequestOption()
    ...
    async def apatch(self, request: PatchPublicMailboxRequest, option: Optional[RequestOption] = None) -> PatchPublicMailboxResponse:
        if option is None:
            option = RequestOption()
    ...
    def remove_to_recycle_bin(self, request: RemoveToRecycleBinPublicMailboxRequest, option: Optional[RequestOption] = None) -> RemoveToRecycleBinPublicMailboxResponse:
        if option is None:
            option = RequestOption()
        ...
        # 反序列化
        response: RemoveToRecycleBinPublicMailboxResponse = JSON.unmarshal(str(resp.content, UTF_8), RemoveToRecycleBinPublicMailboxResponse)
        response.raw = resp

        return response
        

    async def aremove_to_recycle_bin(self, request: RemoveToRecycleBinPublicMailboxRequest, option: Optional[RequestOption] = None) -> RemoveToRecycleBinPublicMailboxResponse:
        if option is None:
            option = RequestOption()
    ...
    def update(self, request: UpdatePublicMailboxRequest, option: Optional[RequestOption] = None) -> UpdatePublicMailboxResponse:
        if option is None:
            option = RequestOption()
    ...
    async def aupdate(self, request: UpdatePublicMailboxRequest, option: Optional[RequestOption] = None) -> UpdatePublicMailboxResponse:
        if option is None:
            option = RequestOption()

...
class GetPublicMailboxMemberRequestBuilder(object):
    def __init__(self) -> None:
        ...
        get_public_mailbox_member_request.uri = (
        ...
        self._get_public_mailbox_member_request: GetPublicMailboxMemberRequest = (
            get_public_mailbox_member_request
        )
    ...
    ) -> "GetPublicMailboxMemberRequestBuilder":
        self._get_public_mailbox_member_request.public_mailbox_id = public_mailbox_id
        self._get_public_mailbox_member_request.paths["public_mailbox_id"] = str(
            public_mailbox_id
        )
        return self

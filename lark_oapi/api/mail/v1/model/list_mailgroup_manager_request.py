...
class ListMailgroupManagerRequestBuilder(object):
    ...
    def __init__(self, list_mailgroup_manager_request: ListMailgroupManagerRequest = ListMailgroupManagerRequest()) -> None:
    ...
    def page_size(self, page_size: int) -> "ListMailgroupManagerRequestBuilder":
        ...
        self._list_mailgroup_manager_request.queries["page_size"] = str(page_size)
        return self
    ...
    def page_token(self, page_token: str) -> "ListMailgroupManagerRequestBuilder":
        ...
        self._list_mailgroup_manager_request.queries["page_token"] = str(page_token)
        return self
    ...
    def user_id_type(self, user_id_type: str) -> "ListMailgroupManagerRequestBuilder":
        ...
        self._list_mailgroup_manager_request.queries["user_id_type"] = str(user_id_type)
        return self
    ...
    def mailgroup_id(self, mailgroup_id: str) -> "ListMailgroupManagerRequestBuilder":
        ...
        self._list_mailgroup_manager_request.paths["mailgroup_id"] = mailgroup_id
        return self

...
class CreateMailgroupPermissionMemberRequestBuilder(object):
    ...
    ) -> "CreateMailgroupPermissionMemberRequestBuilder":
        self._create_mailgroup_permission_member_request.user_id_type = user_id_type
        self._create_mailgroup_permission_member_request.add_query(
    ...
    def department_id_type(
        ...
        self._create_mailgroup_permission_member_request.department_id_type = (
            department_id_type
        )
        self._create_mailgroup_permission_member_request.add_query(
    ...
    def mailgroup_id(
        ...
        self._create_mailgroup_permission_member_request.paths["mailgroup_id"] = str(
            mailgroup_id
        )
        return self

    def request_body(
        self, request_body: MailgroupPermissionMember
    ) -> "CreateMailgroupPermissionMemberRequestBuilder":

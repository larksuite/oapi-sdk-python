...
class SubscriptionUserMailboxEventRequestBuilder(object):
    def __init__(self) -> None:
        ...
        subscription_user_mailbox_event_request.uri = (
            "/open-apis/mail/v1/user_mailboxes/:user_mailbox_id/event/subscription"
        )
    ...
    ) -> "SubscriptionUserMailboxEventRequestBuilder":
        self._subscription_user_mailbox_event_request.user_mailbox_id = user_mailbox_id
        self._subscription_user_mailbox_event_request.paths["user_mailbox_id"] = str(
            user_mailbox_id
        )
        return self

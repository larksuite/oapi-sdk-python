...
from .batch_delete_mailgroup_permission_member_request_body import (
    BatchDeleteMailgroupPermissionMemberRequestBody,
)
...
class BatchDeleteMailgroupPermissionMemberRequest(BaseRequest):
    def __init__(self) -> None:
        ...
        self.request_body: Optional[BatchDeleteMailgroupPermissionMemberRequestBody] = (
            None
        )
...
class BatchDeleteMailgroupPermissionMemberRequestBuilder(object):
    def __init__(self) -> None:
        batch_delete_mailgroup_permission_member_request = (
        ...
        batch_delete_mailgroup_permission_member_request.token_types = {
    ...
    ) -> "BatchDeleteMailgroupPermissionMemberRequestBuilder":
        self._batch_delete_mailgroup_permission_member_request.mailgroup_id = (
            mailgroup_id
        )
        self._batch_delete_mailgroup_permission_member_request.paths["mailgroup_id"] = (
            str(mailgroup_id)
        )
        return self

    def request_body(
        self, request_body: BatchDeleteMailgroupPermissionMemberRequestBody
    ) -> "BatchDeleteMailgroupPermissionMemberRequestBuilder":
        self._batch_delete_mailgroup_permission_member_request.request_body = (
            request_body
        )

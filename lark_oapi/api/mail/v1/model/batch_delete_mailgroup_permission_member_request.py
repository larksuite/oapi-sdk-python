...
class BatchDeleteMailgroupPermissionMemberRequestBuilder(object):
    ...
    def __init__(self, batch_delete_mailgroup_permission_member_request: BatchDeleteMailgroupPermissionMemberRequest = BatchDeleteMailgroupPermissionMemberRequest()) -> None:
    ...
    def mailgroup_id(self, mailgroup_id: str) -> "BatchDeleteMailgroupPermissionMemberRequestBuilder":
        ...
        self._batch_delete_mailgroup_permission_member_request.paths["mailgroup_id"] = mailgroup_id
        return self

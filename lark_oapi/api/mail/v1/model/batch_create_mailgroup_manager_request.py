...
class BatchCreateMailgroupManagerRequest(BaseRequest):
    def __init__(self) -> None:
        ...
        self.request_body: Optional[BatchCreateMailgroupManagerRequestBody] = None

    @staticmethod
    def builder() -> "BatchCreateMailgroupManagerRequestBuilder":
        return BatchCreateMailgroupManagerRequestBuilder()


class BatchCreateMailgroupManagerRequestBuilder(object):

    def __init__(self, batch_create_mailgroup_manager_request: BatchCreateMailgroupManagerRequest = BatchCreateMailgroupManagerRequest()) -> None:
    ...
    def user_id_type(self, user_id_type: str) -> "BatchCreateMailgroupManagerRequestBuilder":
        ...
        self._batch_create_mailgroup_manager_request.queries["user_id_type"] = str(user_id_type)
        return self
    ...
    def mailgroup_id(self, mailgroup_id: str) -> "BatchCreateMailgroupManagerRequestBuilder":
        ...
        self._batch_create_mailgroup_manager_request.paths["mailgroup_id"] = mailgroup_id
        return self
    ...
    def build(self) -> BatchCreateMailgroupManagerRequest:
        return self._batch_create_mailgroup_manager_request

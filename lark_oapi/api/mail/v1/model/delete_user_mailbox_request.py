...
class DeleteUserMailboxRequestBuilder(object):
    def __init__(self) -> None:
        ...
        delete_user_mailbox_request.uri = (
            "/open-apis/mail/v1/user_mailboxes/:user_mailbox_id"
        )
        delete_user_mailbox_request.token_types = {AccessTokenType.TENANT}
        self._delete_user_mailbox_request: DeleteUserMailboxRequest = (
            delete_user_mailbox_request
        )

    def transfer_mailbox(
        self, transfer_mailbox: str
    ) -> "DeleteUserMailboxRequestBuilder":
        self._delete_user_mailbox_request.transfer_mailbox = transfer_mailbox
        self._delete_user_mailbox_request.add_query(
            "transfer_mailbox", transfer_mailbox
        )
        return self
    ...
    def user_mailbox_id(
        ...
        self._delete_user_mailbox_request.paths["user_mailbox_id"] = str(
            user_mailbox_id
        )
        return self

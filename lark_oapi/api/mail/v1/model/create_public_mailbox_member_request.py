...
class CreatePublicMailboxMemberRequestBuilder(object):
    def __init__(self) -> None:
        ...
        create_public_mailbox_member_request.uri = (
        ...
        self._create_public_mailbox_member_request: CreatePublicMailboxMemberRequest = (
            create_public_mailbox_member_request
        )

    def user_id_type(
        self, user_id_type: str
    ) -> "CreatePublicMailboxMemberRequestBuilder":
        self._create_public_mailbox_member_request.user_id_type = user_id_type
        self._create_public_mailbox_member_request.add_query(
    ...
    def public_mailbox_id(
        ...
        self._create_public_mailbox_member_request.paths["public_mailbox_id"] = str(
            public_mailbox_id
        )
        return self

    def request_body(
        self, request_body: PublicMailboxMember
    ) -> "CreatePublicMailboxMemberRequestBuilder":

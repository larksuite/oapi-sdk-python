...
class BatchCreateMailgroupPermissionMemberRequest(BaseRequest):
    def __init__(self) -> None:
        ...
        self.request_body: Optional[BatchCreateMailgroupPermissionMemberRequestBody] = (
            None
        )
...
class BatchCreateMailgroupPermissionMemberRequestBuilder(object):
    def __init__(self) -> None:
        batch_create_mailgroup_permission_member_request = (
        ...
        batch_create_mailgroup_permission_member_request.token_types = {
    ...
    ) -> "BatchCreateMailgroupPermissionMemberRequestBuilder":
        self._batch_create_mailgroup_permission_member_request.user_id_type = (
            user_id_type
        )
        self._batch_create_mailgroup_permission_member_request.add_query(
    ...
    def department_id_type(
        ...
        self._batch_create_mailgroup_permission_member_request.department_id_type = (
            department_id_type
        )
        self._batch_create_mailgroup_permission_member_request.add_query(
    ...
    def mailgroup_id(
        ...
        self._batch_create_mailgroup_permission_member_request.mailgroup_id = (
            mailgroup_id
        )
        self._batch_create_mailgroup_permission_member_request.paths["mailgroup_id"] = (
            str(mailgroup_id)
        )
        return self

    def request_body(
        self, request_body: BatchCreateMailgroupPermissionMemberRequestBody
    ) -> "BatchCreateMailgroupPermissionMemberRequestBuilder":
        self._batch_create_mailgroup_permission_member_request.request_body = (
            request_body
        )

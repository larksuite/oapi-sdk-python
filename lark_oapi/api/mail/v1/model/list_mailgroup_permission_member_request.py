...
class ListMailgroupPermissionMemberRequestBuilder(object):
    ...
    def __init__(self, list_mailgroup_permission_member_request: ListMailgroupPermissionMemberRequest = ListMailgroupPermissionMemberRequest()) -> None:
    ...
    def user_id_type(self, user_id_type: str) -> "ListMailgroupPermissionMemberRequestBuilder":
        ...
        self._list_mailgroup_permission_member_request.queries["user_id_type"] = str(user_id_type)
        return self
    ...
    def department_id_type(self, department_id_type: str) -> "ListMailgroupPermissionMemberRequestBuilder":
        ...
        self._list_mailgroup_permission_member_request.queries["department_id_type"] = str(department_id_type)
        return self
    ...
    def page_token(self, page_token: str) -> "ListMailgroupPermissionMemberRequestBuilder":
        ...
        self._list_mailgroup_permission_member_request.queries["page_token"] = str(page_token)
        return self
    ...
    def page_size(self, page_size: int) -> "ListMailgroupPermissionMemberRequestBuilder":
        ...
        self._list_mailgroup_permission_member_request.queries["page_size"] = str(page_size)
        return self
    ...
    def mailgroup_id(self, mailgroup_id: str) -> "ListMailgroupPermissionMemberRequestBuilder":
        ...
        self._list_mailgroup_permission_member_request.paths["mailgroup_id"] = mailgroup_id
        return self

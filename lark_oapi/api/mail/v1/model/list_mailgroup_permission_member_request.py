...
class ListMailgroupPermissionMemberRequestBuilder(object):
    ...
    ) -> "ListMailgroupPermissionMemberRequestBuilder":
        self._list_mailgroup_permission_member_request.user_id_type = user_id_type
        self._list_mailgroup_permission_member_request.add_query(
    ...
    def department_id_type(
        ...
        self._list_mailgroup_permission_member_request.department_id_type = (
            department_id_type
        )
        self._list_mailgroup_permission_member_request.add_query(
    ...
    def mailgroup_id(
        ...
        self._list_mailgroup_permission_member_request.paths["mailgroup_id"] = str(
            mailgroup_id
        )
        return self

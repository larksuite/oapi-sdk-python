...
class CreateMailgroupMemberRequestBuilder(object):
    ...
    def __init__(self, create_mailgroup_member_request: CreateMailgroupMemberRequest = CreateMailgroupMemberRequest()) -> None:
    ...
    def user_id_type(self, user_id_type: str) -> "CreateMailgroupMemberRequestBuilder":
        ...
        self._create_mailgroup_member_request.queries["user_id_type"] = str(user_id_type)
        return self
    ...
    def department_id_type(self, department_id_type: str) -> "CreateMailgroupMemberRequestBuilder":
        ...
        self._create_mailgroup_member_request.queries["department_id_type"] = str(department_id_type)
        return self
    ...
    def mailgroup_id(self, mailgroup_id: str) -> "CreateMailgroupMemberRequestBuilder":
        ...
        self._create_mailgroup_member_request.paths["mailgroup_id"] = mailgroup_id
        return self

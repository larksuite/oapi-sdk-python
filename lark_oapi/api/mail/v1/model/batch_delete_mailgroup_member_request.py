...
class BatchDeleteMailgroupMemberRequestBuilder(object):
    def __init__(self) -> None:
        ...
        batch_delete_mailgroup_member_request.uri = (
    ...
    ) -> "BatchDeleteMailgroupMemberRequestBuilder":
        self._batch_delete_mailgroup_member_request.mailgroup_id = mailgroup_id
        self._batch_delete_mailgroup_member_request.paths["mailgroup_id"] = str(
            mailgroup_id
        )
        return self

    def request_body(
        self, request_body: BatchDeleteMailgroupMemberRequestBody
    ) -> "BatchDeleteMailgroupMemberRequestBuilder":

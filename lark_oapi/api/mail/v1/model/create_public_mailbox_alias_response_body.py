...
class CreatePublicMailboxAliasResponseBodyBuilder(object):
    def __init__(self) -> None:
        self._create_public_mailbox_alias_response_body = (
            CreatePublicMailboxAliasResponseBody()
        )

    def public_mailbox_alias(
        self, public_mailbox_alias: EmailAlias
    ) -> "CreatePublicMailboxAliasResponseBodyBuilder":
        self._create_public_mailbox_alias_response_body.public_mailbox_alias = (

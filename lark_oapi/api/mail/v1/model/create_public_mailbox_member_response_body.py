...
class CreatePublicMailboxMemberResponseBodyBuilder(object):
    def __init__(self, create_public_mailbox_member_response_body: CreatePublicMailboxMemberResponseBody = CreatePublicMailboxMemberResponseBody({})) -> None:
        self._create_public_mailbox_member_response_body: CreatePublicMailboxMemberResponseBody = create_public_mailbox_member_response_body

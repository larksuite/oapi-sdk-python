...
class CreateUserMailboxAliasRequestBuilder(object):
    def __init__(self) -> None:
        ...
        create_user_mailbox_alias_request.uri = (
        ...
        self._create_user_mailbox_alias_request: CreateUserMailboxAliasRequest = (
            create_user_mailbox_alias_request
        )

    def user_mailbox_id(
        self, user_mailbox_id: str
    ) -> "CreateUserMailboxAliasRequestBuilder":
        self._create_user_mailbox_alias_request.user_mailbox_id = user_mailbox_id
        self._create_user_mailbox_alias_request.paths["user_mailbox_id"] = str(
            user_mailbox_id
        )
        return self

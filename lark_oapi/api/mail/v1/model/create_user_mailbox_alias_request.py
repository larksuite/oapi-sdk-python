...
class CreateUserMailboxAliasRequestBuilder(object):
    ...
    def __init__(self, create_user_mailbox_alias_request: CreateUserMailboxAliasRequest = CreateUserMailboxAliasRequest()) -> None:
    ...
    def user_mailbox_id(self, user_mailbox_id: str) -> "CreateUserMailboxAliasRequestBuilder":
        ...
        self._create_user_mailbox_alias_request.paths["user_mailbox_id"] = user_mailbox_id
        return self

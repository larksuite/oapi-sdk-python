...
from .batch_create_mailgroup_member_request_body import (
    BatchCreateMailgroupMemberRequestBody,
)
...
class BatchCreateMailgroupMemberRequestBuilder(object):
    def __init__(self) -> None:
        ...
        batch_create_mailgroup_member_request.uri = (
    ...
    ) -> "BatchCreateMailgroupMemberRequestBuilder":
        self._batch_create_mailgroup_member_request.user_id_type = user_id_type
        self._batch_create_mailgroup_member_request.add_query(
    ...
    def department_id_type(
        ...
        self._batch_create_mailgroup_member_request.department_id_type = (
            department_id_type
        )
        self._batch_create_mailgroup_member_request.add_query(
    ...
    def mailgroup_id(
        ...
        self._batch_create_mailgroup_member_request.paths["mailgroup_id"] = str(
            mailgroup_id
        )
        return self

    def request_body(
        self, request_body: BatchCreateMailgroupMemberRequestBody
    ) -> "BatchCreateMailgroupMemberRequestBuilder":

...
class DeletePublicMailboxAliasRequestBuilder(object):
    def __init__(self) -> None:
        ...
        delete_public_mailbox_alias_request.uri = (
        ...
        self._delete_public_mailbox_alias_request: DeletePublicMailboxAliasRequest = (
            delete_public_mailbox_alias_request
        )

    def public_mailbox_id(
        self, public_mailbox_id: str
    ) -> "DeletePublicMailboxAliasRequestBuilder":
        self._delete_public_mailbox_alias_request.public_mailbox_id = public_mailbox_id
        self._delete_public_mailbox_alias_request.paths["public_mailbox_id"] = str(
            public_mailbox_id
        )
        return self

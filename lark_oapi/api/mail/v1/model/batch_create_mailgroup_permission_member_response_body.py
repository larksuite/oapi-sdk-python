...
class BatchCreateMailgroupPermissionMemberResponseBodyBuilder(object):
    def __init__(self, batch_create_mailgroup_permission_member_response_body: BatchCreateMailgroupPermissionMemberResponseBody = BatchCreateMailgroupPermissionMemberResponseBody({})) -> None:

...
class DownloadUrlUserMailboxMessageAttachmentRequestBuilder(object):
    def __init__(self) -> None:
        download_url_user_mailbox_message_attachment_request = (
            DownloadUrlUserMailboxMessageAttachmentRequest()
        )
        download_url_user_mailbox_message_attachment_request.http_method = (
            HttpMethod.GET
        )
        ...
        download_url_user_mailbox_message_attachment_request.token_types = {
    ...
    def attachment_ids(
        ...
        self._download_url_user_mailbox_message_attachment_request.attachment_ids = (
            attachment_ids
        )
        self._download_url_user_mailbox_message_attachment_request.add_query(
    ...
    def user_mailbox_id(
        ...
        self._download_url_user_mailbox_message_attachment_request.user_mailbox_id = (
            user_mailbox_id
        )
        self._download_url_user_mailbox_message_attachment_request.paths[
            "user_mailbox_id"
        ] = str(user_mailbox_id)
        return self
    ...
    def message_id(
        ...
        self._download_url_user_mailbox_message_attachment_request.message_id = (
            message_id
        )
        self._download_url_user_mailbox_message_attachment_request.paths[
            "message_id"

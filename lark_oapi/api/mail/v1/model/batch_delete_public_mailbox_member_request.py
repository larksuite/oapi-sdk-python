...
class BatchDeletePublicMailboxMemberRequestBuilder(object):
    def __init__(self) -> None:
        batch_delete_public_mailbox_member_request = (
        ...
        batch_delete_public_mailbox_member_request.token_types = {
    ...
    ) -> "BatchDeletePublicMailboxMemberRequestBuilder":
        self._batch_delete_public_mailbox_member_request.public_mailbox_id = (
            public_mailbox_id
        )
        self._batch_delete_public_mailbox_member_request.paths["public_mailbox_id"] = (
            str(public_mailbox_id)
        )
        return self

    def request_body(
        self, request_body: BatchDeletePublicMailboxMemberRequestBody
    ) -> "BatchDeletePublicMailboxMemberRequestBuilder":

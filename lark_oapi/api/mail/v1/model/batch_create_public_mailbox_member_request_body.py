...
class BatchCreatePublicMailboxMemberRequestBodyBuilder(object):
    def __init__(self, batch_create_public_mailbox_member_request_body: BatchCreatePublicMailboxMemberRequestBody = BatchCreatePublicMailboxMemberRequestBody({})) -> None:

...
from .batch_delete_mailgroup_manager_request_body import (
    BatchDeleteMailgroupManagerRequestBody,
)
...
class BatchDeleteMailgroupManagerRequestBuilder(object):
    def __init__(self) -> None:
        ...
        batch_delete_mailgroup_manager_request.uri = (
    ...
    ) -> "BatchDeleteMailgroupManagerRequestBuilder":
        self._batch_delete_mailgroup_manager_request.user_id_type = user_id_type
        self._batch_delete_mailgroup_manager_request.add_query(
    ...
    def mailgroup_id(
        ...
        self._batch_delete_mailgroup_manager_request.paths["mailgroup_id"] = str(
            mailgroup_id
        )
        return self

    def request_body(
        self, request_body: BatchDeleteMailgroupManagerRequestBody
    ) -> "BatchDeleteMailgroupManagerRequestBuilder":

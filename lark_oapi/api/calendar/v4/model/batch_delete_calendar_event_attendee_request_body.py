...
class BatchDeleteCalendarEventAttendeeRequestBodyBuilder(object):
    def __init__(self) -> None:
        self._batch_delete_calendar_event_attendee_request_body = (
            BatchDeleteCalendarEventAttendeeRequestBody()
        )

    def attendee_ids(
        self, attendee_ids: List[str]
    ) -> "BatchDeleteCalendarEventAttendeeRequestBodyBuilder":
        self._batch_delete_calendar_event_attendee_request_body.attendee_ids = (
            attendee_ids
        )
        return self

    def delete_ids(
        self, delete_ids: List[CalendarEventAttendeeId]
    ) -> "BatchDeleteCalendarEventAttendeeRequestBodyBuilder":
    ...
    def need_notification(
        ...
        self._batch_delete_calendar_event_attendee_request_body.need_notification = (
            need_notification
        )
        return self
    ...
    def is_enable_admin(
        ...
        self._batch_delete_calendar_event_attendee_request_body.is_enable_admin = (
            is_enable_admin
        )
        return self

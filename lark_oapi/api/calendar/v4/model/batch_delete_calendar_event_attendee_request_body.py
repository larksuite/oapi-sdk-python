...
class BatchDeleteCalendarEventAttendeeRequestBodyBuilder(object):
    def __init__(self, batch_delete_calendar_event_attendee_request_body: BatchDeleteCalendarEventAttendeeRequestBody = BatchDeleteCalendarEventAttendeeRequestBody({})) -> None:

...
class ListCalendarEventResponseBodyBuilder(object):
    def __init__(self, list_calendar_event_response_body: ListCalendarEventResponseBody = ListCalendarEventResponseBody({})) -> None:
        self._list_calendar_event_response_body: ListCalendarEventResponseBody = list_calendar_event_response_body

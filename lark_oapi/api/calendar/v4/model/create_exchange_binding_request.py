...
class CreateExchangeBindingRequestBuilder(object):
    def __init__(self) -> None:
        ...
        self._create_exchange_binding_request: CreateExchangeBindingRequest = (
            create_exchange_binding_request
        )
    ...
    def request_body(
        self, request_body: ExchangeBinding
    ) -> "CreateExchangeBindingRequestBuilder":

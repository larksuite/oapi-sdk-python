...
class SubscriptionCalendarEventRequestBuilder(object):
    ...
    def __init__(self, subscription_calendar_event_request: SubscriptionCalendarEventRequest = SubscriptionCalendarEventRequest()) -> None:
    ...
    def calendar_id(self, calendar_id: str) -> "SubscriptionCalendarEventRequestBuilder":
        ...
        self._subscription_calendar_event_request.paths["calendar_id"] = calendar_id
        return self

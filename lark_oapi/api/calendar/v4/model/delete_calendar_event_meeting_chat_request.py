...
class DeleteCalendarEventMeetingChatRequestBuilder(object):
    def __init__(self) -> None:
        delete_calendar_event_meeting_chat_request = (
        ...
        delete_calendar_event_meeting_chat_request.token_types = {
    ...
    ) -> "DeleteCalendarEventMeetingChatRequestBuilder":
        self._delete_calendar_event_meeting_chat_request.meeting_chat_id = (
            meeting_chat_id
        )
        self._delete_calendar_event_meeting_chat_request.add_query(
    ...
    def calendar_id(
        ...
        self._delete_calendar_event_meeting_chat_request.paths["calendar_id"] = str(
            calendar_id
        )
        return self
    ...
    def event_id(self, event_id: str) -> "DeleteCalendarEventMeetingChatRequestBuilder":
        ...
        self._delete_calendar_event_meeting_chat_request.paths["event_id"] = str(
            event_id
        )
        return self

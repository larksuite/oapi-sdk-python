...
class CreateCalendarEventMeetingChatRequestBuilder(object):
    def __init__(self) -> None:
        create_calendar_event_meeting_chat_request = (
        ...
        create_calendar_event_meeting_chat_request.token_types = {
    ...
    ) -> "CreateCalendarEventMeetingChatRequestBuilder":
        self._create_calendar_event_meeting_chat_request.calendar_id = calendar_id
        self._create_calendar_event_meeting_chat_request.paths["calendar_id"] = str(
            calendar_id
        )
        return self
    ...
    def event_id(self, event_id: str) -> "CreateCalendarEventMeetingChatRequestBuilder":
        ...
        self._create_calendar_event_meeting_chat_request.paths["event_id"] = str(
            event_id
        )
        return self

...
class UnsubscriptionCalendarAclRequestBuilder(object):
    ...
    def __init__(self, unsubscription_calendar_acl_request: UnsubscriptionCalendarAclRequest = UnsubscriptionCalendarAclRequest()) -> None:
    ...
    def calendar_id(self, calendar_id: str) -> "UnsubscriptionCalendarAclRequestBuilder":
        ...
        self._unsubscription_calendar_acl_request.paths["calendar_id"] = calendar_id
        return self

...
class CreateTimeoffEventRequestBuilder(object):
    ...
    def __init__(self, create_timeoff_event_request: CreateTimeoffEventRequest = CreateTimeoffEventRequest()) -> None:
    ...
    def user_id_type(self, user_id_type: str) -> "CreateTimeoffEventRequestBuilder":
        ...
        self._create_timeoff_event_request.queries["user_id_type"] = str(user_id_type)
        return self

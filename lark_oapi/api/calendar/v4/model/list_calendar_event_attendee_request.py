...
class ListCalendarEventAttendeeRequestBuilder(object):
    def __init__(self) -> None:
        ...
        list_calendar_event_attendee_request.uri = (
            "/open-apis/calendar/v4/calendars/:calendar_id/events/:event_id/attendees"
        )
        list_calendar_event_attendee_request.token_types = {
            AccessTokenType.TENANT,
            AccessTokenType.USER,
        }
        self._list_calendar_event_attendee_request: ListCalendarEventAttendeeRequest = (
            list_calendar_event_attendee_request
        )
    ...
    def user_id_type(
        ...
        self._list_calendar_event_attendee_request.add_query(
            "user_id_type", user_id_type
        )
        return self

    def need_resource_customization(
        self, need_resource_customization: bool
    ) -> "ListCalendarEventAttendeeRequestBuilder":
        self._list_calendar_event_attendee_request.need_resource_customization = (
            need_resource_customization
        )
        self._list_calendar_event_attendee_request.add_query(
            "need_resource_customization", need_resource_customization
        )
        return self
    ...
    def calendar_id(
        ...
        self._list_calendar_event_attendee_request.paths["calendar_id"] = str(
            calendar_id
        )
        return self

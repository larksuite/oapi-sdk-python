...
class CreateCalendarEventAttendeeRequestBodyBuilder(object):
    def __init__(self) -> None:
        self._create_calendar_event_attendee_request_body = (
    ...
    def need_notification(
        ...
        self._create_calendar_event_attendee_request_body.need_notification = (
            need_notification
        )
        return self

    def instance_start_time_admin(
        self, instance_start_time_admin: str
    ) -> "CreateCalendarEventAttendeeRequestBodyBuilder":
        self._create_calendar_event_attendee_request_body.instance_start_time_admin = (
            instance_start_time_admin
        )
        return self

    def is_enable_admin(
        self, is_enable_admin: bool
    ) -> "CreateCalendarEventAttendeeRequestBodyBuilder":
        self._create_calendar_event_attendee_request_body.is_enable_admin = (
            is_enable_admin
        )
        return self

    def add_operator_to_attendee(
        self, add_operator_to_attendee: bool
    ) -> "CreateCalendarEventAttendeeRequestBodyBuilder":
        self._create_calendar_event_attendee_request_body.add_operator_to_attendee = (

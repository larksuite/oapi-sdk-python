...
class CreateCalendarEventMeetingMinuteRequestBuilder(object):
    def __init__(self) -> None:
        create_calendar_event_meeting_minute_request = (
        ...
        create_calendar_event_meeting_minute_request.token_types = {
    ...
    ) -> "CreateCalendarEventMeetingMinuteRequestBuilder":
        self._create_calendar_event_meeting_minute_request.calendar_id = calendar_id
        self._create_calendar_event_meeting_minute_request.paths["calendar_id"] = str(
            calendar_id
        )
        return self
    ...
    def event_id(
        ...
        self._create_calendar_event_meeting_minute_request.paths["event_id"] = str(
            event_id
        )
        return self

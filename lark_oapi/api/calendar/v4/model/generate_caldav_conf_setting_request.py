...
class GenerateCaldavConfSettingRequestBuilder(object):
    def __init__(self) -> None:
        ...
        generate_caldav_conf_setting_request.uri = (
            "/open-apis/calendar/v4/settings/generate_caldav_conf"
        )
        generate_caldav_conf_setting_request.token_types = {AccessTokenType.USER}
        self._generate_caldav_conf_setting_request: GenerateCaldavConfSettingRequest = (
            generate_caldav_conf_setting_request
        )

    def request_body(
        self, request_body: GenerateCaldavConfSettingRequestBody
    ) -> "GenerateCaldavConfSettingRequestBuilder":

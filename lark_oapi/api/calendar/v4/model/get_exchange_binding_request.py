...
class GetExchangeBindingRequestBuilder(object):
    def __init__(self) -> None:
        ...
        get_exchange_binding_request.uri = (
            "/open-apis/calendar/v4/exchange_bindings/:exchange_binding_id"
        )
        get_exchange_binding_request.token_types = {AccessTokenType.USER}
        self._get_exchange_binding_request: GetExchangeBindingRequest = (
            get_exchange_binding_request
        )
    ...
    ) -> "GetExchangeBindingRequestBuilder":
        self._get_exchange_binding_request.exchange_binding_id = exchange_binding_id
        self._get_exchange_binding_request.paths["exchange_binding_id"] = str(
            exchange_binding_id
        )
        return self

...
class ListCalendarEventAttendeeChatMemberRequestBuilder(object):
    def __init__(self) -> None:
        list_calendar_event_attendee_chat_member_request = (
        ...
        list_calendar_event_attendee_chat_member_request.token_types = {
    ...
    def page_token(
        self, page_token: str
    ) -> "ListCalendarEventAttendeeChatMemberRequestBuilder":
        self._list_calendar_event_attendee_chat_member_request.page_token = page_token
        self._list_calendar_event_attendee_chat_member_request.add_query(
    ...
    def user_id_type(
        ...
        self._list_calendar_event_attendee_chat_member_request.user_id_type = (
            user_id_type
        )
        self._list_calendar_event_attendee_chat_member_request.add_query(
    ...
    def calendar_id(
        ...
        self._list_calendar_event_attendee_chat_member_request.paths["calendar_id"] = (
            str(calendar_id)
        )
        return self
    ...
    def event_id(
        ...
        self._list_calendar_event_attendee_chat_member_request.paths["event_id"] = str(
            event_id
        )
        return self
    ...
    def attendee_id(
        ...
        self._list_calendar_event_attendee_chat_member_request.paths["attendee_id"] = (
            str(attendee_id)
        )
        return self

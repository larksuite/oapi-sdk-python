...
class ListCalendarEventAttendeeChatMemberRequestBuilder(object):
    ...
    def __init__(self, list_calendar_event_attendee_chat_member_request: ListCalendarEventAttendeeChatMemberRequest = ListCalendarEventAttendeeChatMemberRequest()) -> None:

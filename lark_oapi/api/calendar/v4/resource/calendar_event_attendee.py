...
class CalendarEventAttendee(object):
    ...
    def batch_delete(self, request: BatchDeleteCalendarEventAttendeeRequest, option: Optional[RequestOption] = None) -> BatchDeleteCalendarEventAttendeeResponse:
        if option is None:
    ...
    async def abatch_delete(self, request: BatchDeleteCalendarEventAttendeeRequest, option: Optional[RequestOption] = None) -> BatchDeleteCalendarEventAttendeeResponse:
        if option is None:
            option = RequestOption()
    ...
    def create(self, request: CreateCalendarEventAttendeeRequest, option: Optional[RequestOption] = None) -> CreateCalendarEventAttendeeResponse:
        if option is None:
            option = RequestOption()
    ...
    async def acreate(self, request: CreateCalendarEventAttendeeRequest, option: Optional[RequestOption] = None) -> CreateCalendarEventAttendeeResponse:
        if option is None:
            option = RequestOption()
    ...
    def list(self, request: ListCalendarEventAttendeeRequest, option: Optional[RequestOption] = None) -> ListCalendarEventAttendeeResponse:
        if option is None:
            option = RequestOption()
    ...
    async def alist(self, request: ListCalendarEventAttendeeRequest, option: Optional[RequestOption] = None) -> ListCalendarEventAttendeeResponse:
        if option is None:
            option = RequestOption()

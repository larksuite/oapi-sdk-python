...
class CalendarEvent(object):
    ...
    def create(self, request: CreateCalendarEventRequest, option: RequestOption = RequestOption()) -> CreateCalendarEventResponse:
        # 鉴权、获取token
    ...
    def delete(self, request: DeleteCalendarEventRequest, option: RequestOption = RequestOption()) -> DeleteCalendarEventResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def get(self, request: GetCalendarEventRequest, option: RequestOption = RequestOption()) -> GetCalendarEventResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def list(self, request: ListCalendarEventRequest, option: RequestOption = RequestOption()) -> ListCalendarEventResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def patch(self, request: PatchCalendarEventRequest, option: RequestOption = RequestOption()) -> PatchCalendarEventResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def search(self, request: SearchCalendarEventRequest, option: RequestOption = RequestOption()) -> SearchCalendarEventResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def subscription(self, request: SubscriptionCalendarEventRequest, option: RequestOption = RequestOption()) -> SubscriptionCalendarEventResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def unsubscription(self, request: UnsubscriptionCalendarEventRequest, option: RequestOption = RequestOption()) -> UnsubscriptionCalendarEventResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

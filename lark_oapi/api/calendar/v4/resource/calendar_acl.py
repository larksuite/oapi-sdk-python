...
class CalendarAcl(object):
    ...
    def create(self, request: CreateCalendarAclRequest, option: RequestOption = RequestOption()) -> CreateCalendarAclResponse:
        # 鉴权、获取token
    ...
    def delete(self, request: DeleteCalendarAclRequest, option: RequestOption = RequestOption()) -> DeleteCalendarAclResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def subscription(self, request: SubscriptionCalendarAclRequest, option: RequestOption = RequestOption()) -> SubscriptionCalendarAclResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def unsubscription(self, request: UnsubscriptionCalendarAclRequest, option: RequestOption = RequestOption()) -> UnsubscriptionCalendarAclResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

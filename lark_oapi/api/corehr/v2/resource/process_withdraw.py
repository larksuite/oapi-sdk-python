...
from ..model.update_process_withdraw_request import UpdateProcessWithdrawRequest
from ..model.update_process_withdraw_response import UpdateProcessWithdrawResponse


class ProcessWithdraw(object):

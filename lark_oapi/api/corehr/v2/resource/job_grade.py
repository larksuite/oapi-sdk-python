...
class JobGrade(object):
    ...
    def query_recent_change(self, request: QueryRecentChangeJobGradeRequest, option: Optional[RequestOption] = None) -> QueryRecentChangeJobGradeResponse:
        if option is None:
            option = RequestOption()
        ...
        # 反序列化
        response: QueryRecentChangeJobGradeResponse = JSON.unmarshal(str(resp.content, UTF_8), QueryRecentChangeJobGradeResponse)
        response.raw = resp

        return response
        

    async def aquery_recent_change(self, request: QueryRecentChangeJobGradeRequest, option: Optional[RequestOption] = None) -> QueryRecentChangeJobGradeResponse:
        if option is None:
            option = RequestOption()

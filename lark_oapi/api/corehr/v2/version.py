...
class V2(object):
	def __init__(self, config: Config) -> None:
		...
		self.basic_info_country_region_subdivision: BasicInfoCountryRegionSubdivision = BasicInfoCountryRegionSubdivision(config)
		...
		self.employees_international_assignment: EmployeesInternationalAssignment = EmployeesInternationalAssignment(config)

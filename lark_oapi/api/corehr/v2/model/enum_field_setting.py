...
class EnumFieldSetting(object):
    _types = {
        "enum_field_options": List[CommonSchemaOption],
        "is_multiple": bool,
    }

    def __init__(self, d=None):
        self.enum_field_options: Optional[List[CommonSchemaOption]] = None
...
class EnumFieldSettingBuilder(object):
    ...
    def enum_field_options(
        self, enum_field_options: List[CommonSchemaOption]
    ) -> "EnumFieldSettingBuilder":
        self._enum_field_setting.enum_field_options = enum_field_options
        return self

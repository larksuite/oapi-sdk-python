...
class FormVariableValueInfoBuilder(object):
    ...
    def department_value(
        self, department_value: FormFieldVariableStringValue
    ) -> "FormVariableValueInfoBuilder":
    ...
    def object_value(
        self, object_value: FormFieldVariableStringValue
    ) -> "FormVariableValueInfoBuilder":

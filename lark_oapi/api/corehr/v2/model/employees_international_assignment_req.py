...
class EmployeesInternationalAssignmentReqBuilder(object):
    def __init__(self) -> None:
        self._employees_international_assignment_req = (
            EmployeesInternationalAssignmentReq()
        )

    def work_location_id(
        self, work_location_id: str
    ) -> "EmployeesInternationalAssignmentReqBuilder":
    ...
    def weekly_working_hours_v2(
        ...
        self._employees_international_assignment_req.weekly_working_hours_v2 = (
    ...
    def working_hours_type_id(
        ...
        self._employees_international_assignment_req.working_hours_type_id = (
    ...
    def compensation_type(
        ...
        self._employees_international_assignment_req.compensation_type = (
            compensation_type
        )
        return self
    ...
    def direct_manager_id(
        ...
        self._employees_international_assignment_req.direct_manager_id = (
            direct_manager_id
        )
        return self
    ...
    def dotted_line_manager_id(
        ...
        self._employees_international_assignment_req.dotted_line_manager_id = (
    ...
    def international_assignment_reason(
        ...
        self._employees_international_assignment_req.international_assignment_reason = (
    ...
    def international_assignment_type(
        self, international_assignment_type: str
    ) -> "EmployeesInternationalAssignmentReqBuilder":
        self._employees_international_assignment_req.international_assignment_type = (

...
class SignatureTemplatePermissionInfoBuilder(object):
    ...
    def read_permission(
        self, read_permission: bool
    ) -> "SignatureTemplatePermissionInfoBuilder":

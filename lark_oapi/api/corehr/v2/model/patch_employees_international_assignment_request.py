...
class PatchEmployeesInternationalAssignmentRequestBuilder(object):
    def __init__(self) -> None:
        patch_employees_international_assignment_request = (
        ...
        patch_employees_international_assignment_request.token_types = {
    ...
    ) -> "PatchEmployeesInternationalAssignmentRequestBuilder":
        self._patch_employees_international_assignment_request.client_token = (
            client_token
        )
        self._patch_employees_international_assignment_request.add_query(
    ...
    def user_id_type(
        ...
        self._patch_employees_international_assignment_request.user_id_type = (
            user_id_type
        )
        self._patch_employees_international_assignment_request.add_query(
    ...
    def department_id_type(
        ...
        self._patch_employees_international_assignment_request.department_id_type = (
            department_id_type
        )
        self._patch_employees_international_assignment_request.add_query(
    ...
    def international_assignment_id(
        ...
        self._patch_employees_international_assignment_request.paths[
    ...
    def request_body(
        ...
        self._patch_employees_international_assignment_request.request_body = (
            request_body
        )

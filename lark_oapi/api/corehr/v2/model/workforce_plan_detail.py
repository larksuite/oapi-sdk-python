...
class WorkforcePlanDetail(object):
    ...
    def __init__(self, d=None):
        ...
        self.estimated_active_individuals_detail: Optional[
...
class WorkforcePlanDetailBuilder(object):
    ...
    def employee_type(
        self, employee_type: DimensionInfo
    ) -> "WorkforcePlanDetailBuilder":
        self._workforce_plan_detail.employee_type = employee_type
        return self

    def work_location(
        self, work_location: DimensionInfo
    ) -> "WorkforcePlanDetailBuilder":
    ...
    def individuals_to_be_removed(
        ...
        self._workforce_plan_detail.individuals_to_be_removed = (
    ...
    def estimated_active_individuals_detail(
        self, estimated_active_individuals_detail: List[WorkforcePlanEaiDetail]
    ) -> "WorkforcePlanDetailBuilder":
        self._workforce_plan_detail.estimated_active_individuals_detail = (

...
class FieldVariableValueToForReviewBuilder(object):
    ...
    def date_time_value(
        self, date_time_value: str
    ) -> "FieldVariableValueToForReviewBuilder":
    ...
    def file_value(
        self, file_value: FieldVariableValueToFileForWrite
    ) -> "FieldVariableValueToForReviewBuilder":

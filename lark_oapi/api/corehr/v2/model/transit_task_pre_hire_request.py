...
class TransitTaskPreHireRequestBuilder(object):
    def __init__(self) -> None:
        ...
        transit_task_pre_hire_request.uri = (
            "/open-apis/corehr/v2/pre_hires/:pre_hire_id/transit_task"
        )
        transit_task_pre_hire_request.token_types = {AccessTokenType.TENANT}
        self._transit_task_pre_hire_request: TransitTaskPreHireRequest = (
            transit_task_pre_hire_request
        )
    ...
    def request_body(
        self, request_body: TransitTaskPreHireRequestBody
    ) -> "TransitTaskPreHireRequestBuilder":

...
from .search_basic_info_country_region_request_body import (
    SearchBasicInfoCountryRegionRequestBody,
)
...
class SearchBasicInfoCountryRegionRequestBuilder(object):
    def __init__(self) -> None:
        ...
        search_basic_info_country_region_request.uri = (
    ...
    def page_token(
        self, page_token: str
    ) -> "SearchBasicInfoCountryRegionRequestBuilder":
        self._search_basic_info_country_region_request.page_token = page_token
        self._search_basic_info_country_region_request.add_query(
            "page_token", page_token
        )
        return self

    def request_body(
        self, request_body: SearchBasicInfoCountryRegionRequestBody
    ) -> "SearchBasicInfoCountryRegionRequestBuilder":

...
class BatchGetEmployeesBpRequestBuilder(object):
    def __init__(self) -> None:
        ...
        batch_get_employees_bp_request.uri = (
            "/open-apis/corehr/v2/employees/bps/batch_get"
        )
        batch_get_employees_bp_request.token_types = {AccessTokenType.TENANT}
        self._batch_get_employees_bp_request: BatchGetEmployeesBpRequest = (
            batch_get_employees_bp_request
        )
    ...
    def request_body(
        self, request_body: BatchGetEmployeesBpRequestBody
    ) -> "BatchGetEmployeesBpRequestBuilder":

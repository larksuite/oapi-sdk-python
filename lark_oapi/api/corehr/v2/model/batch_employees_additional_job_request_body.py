...
class BatchEmployeesAdditionalJobRequestBodyBuilder(object):
    def __init__(self) -> None:
        self._batch_employees_additional_job_request_body = (
            BatchEmployeesAdditionalJobRequestBody()
        )

    def employment_ids(
        self, employment_ids: List[str]
    ) -> "BatchEmployeesAdditionalJobRequestBodyBuilder":
        self._batch_employees_additional_job_request_body.employment_ids = (
            employment_ids
        )
        return self

    def additional_job_ids(
        self, additional_job_ids: List[str]
    ) -> "BatchEmployeesAdditionalJobRequestBodyBuilder":
        self._batch_employees_additional_job_request_body.additional_job_ids = (
            additional_job_ids
        )
        return self

    def start_date(
        self, start_date: EmployeesAdditionalJobBatchReqDate
    ) -> "BatchEmployeesAdditionalJobRequestBodyBuilder":
        self._batch_employees_additional_job_request_body.start_date = start_date
        return self

    def end_date(
        self, end_date: EmployeesAdditionalJobBatchReqDate
    ) -> "BatchEmployeesAdditionalJobRequestBodyBuilder":

...
class EmployeesAdditionalJobEdit(object):
    _types = {
    ...
    @staticmethod
    def builder() -> "EmployeesAdditionalJobEditBuilder":
        return EmployeesAdditionalJobEditBuilder()
...
class EmployeesAdditionalJobEditBuilder(object):
    ...
    ) -> "EmployeesAdditionalJobEditBuilder":
    ...
    def working_hours_type_id(
        ...
        self._employees_additional_job_edit.working_hours_type_id = (
    ...
    def dotted_line_manager_id(
        ...
        self._employees_additional_job_edit.dotted_line_manager_id = (

...
class SearchBasicInfoCountryRegionSubdivisionRequestBodyBuilder(object):
    ...
    def status_list(
        ...
        self._search_basic_info_country_region_subdivision_request_body.status_list = (
            status_list
        )
        return self

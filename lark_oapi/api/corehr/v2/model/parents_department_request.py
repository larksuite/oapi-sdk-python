...
class ParentsDepartmentRequestBuilder(object):
    def __init__(self) -> None:
        ...
        parents_department_request.token_types = {
            AccessTokenType.TENANT,
            AccessTokenType.USER,
        }
        self._parents_department_request: ParentsDepartmentRequest = (
            parents_department_request
        )

    def department_id_type(
        self, department_id_type: str
    ) -> "ParentsDepartmentRequestBuilder":
        self._parents_department_request.department_id_type = department_id_type
        self._parents_department_request.add_query(
            "department_id_type", department_id_type
        )
        return self

    def request_body(
        self, request_body: ParentsDepartmentRequestBody
    ) -> "ParentsDepartmentRequestBuilder":

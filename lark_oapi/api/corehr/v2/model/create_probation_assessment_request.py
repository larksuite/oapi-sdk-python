...
from .create_probation_assessment_request_body import (
    CreateProbationAssessmentRequestBody,
)
...
class CreateProbationAssessmentRequestBuilder(object):
    def __init__(self) -> None:
        ...
        create_probation_assessment_request.uri = (
            "/open-apis/corehr/v2/probation/assessments"
        )
        create_probation_assessment_request.token_types = {AccessTokenType.TENANT}
        self._create_probation_assessment_request: CreateProbationAssessmentRequest = (
            create_probation_assessment_request
        )

    def client_token(
        self, client_token: str
    ) -> "CreateProbationAssessmentRequestBuilder":
        self._create_probation_assessment_request.client_token = client_token
        self._create_probation_assessment_request.add_query(
    ...
    def request_body(
        self, request_body: CreateProbationAssessmentRequestBody
    ) -> "CreateProbationAssessmentRequestBuilder":

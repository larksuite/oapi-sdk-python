...
class DeleteCostCenterRequestBuilder(object):
    ...
    def request_body(
        self, request_body: DeleteCostCenterRequestBody
    ) -> "DeleteCostCenterRequestBuilder":

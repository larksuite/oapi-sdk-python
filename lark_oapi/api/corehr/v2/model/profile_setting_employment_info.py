...
class ProfileSettingEmploymentInfoBuilder(object):
    ...
    def basic_info(
        self, basic_info: ProfileSettingEmploymentBasicInfo
    ) -> "ProfileSettingEmploymentInfoBuilder":
    ...
    def employment_record(
        self, employment_record: ProfileSettingEmploymentRecord
    ) -> "ProfileSettingEmploymentInfoBuilder":
        self._profile_setting_employment_info.employment_record = employment_record
        return self

    def emp_contract_record(
        self, emp_contract_record: ProfileSettingEmpContractRecord
    ) -> "ProfileSettingEmploymentInfoBuilder":
    ...
    def custom_org_groups(
        self, custom_org_groups: List[JobDataCustomOrg]
    ) -> "ProfileSettingEmploymentInfoBuilder":
    ...
    def seniority_adjust_informations(
        ...
        self._profile_setting_employment_info.seniority_adjust_informations = (
            seniority_adjust_informations
        )
        return self

    def default_cost_center(
        self, default_cost_center: DefaultCostCenterRecord
    ) -> "ProfileSettingEmploymentInfoBuilder":

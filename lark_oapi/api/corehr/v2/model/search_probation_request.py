...
class SearchProbationRequestBuilder(object):
    def __init__(self) -> None:
        ...
        self._search_probation_request: SearchProbationRequest = (
            search_probation_request
        )
    ...
    ) -> "SearchProbationRequestBuilder":
        self._search_probation_request.department_id_type = department_id_type
        self._search_probation_request.add_query(
            "department_id_type", department_id_type
        )
        return self

    def request_body(
        self, request_body: SearchProbationRequestBody
    ) -> "SearchProbationRequestBuilder":

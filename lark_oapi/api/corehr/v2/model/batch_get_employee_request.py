...
class BatchGetEmployeeRequestBuilder(object):
    def __init__(self) -> None:
        ...
        self._batch_get_employee_request: BatchGetEmployeeRequest = (
            batch_get_employee_request
        )
    ...
    ) -> "BatchGetEmployeeRequestBuilder":
        self._batch_get_employee_request.department_id_type = department_id_type
        self._batch_get_employee_request.add_query(
            "department_id_type", department_id_type
        )
        return self

    def request_body(
        self, request_body: BatchGetEmployeeRequestBody
    ) -> "BatchGetEmployeeRequestBuilder":

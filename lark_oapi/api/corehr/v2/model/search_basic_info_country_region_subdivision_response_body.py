...
class SearchBasicInfoCountryRegionSubdivisionResponseBodyBuilder(object):
    def __init__(self) -> None:
        self._search_basic_info_country_region_subdivision_response_body = (
            SearchBasicInfoCountryRegionSubdivisionResponseBody()
        )

    def items(
        self, items: List[CountryRegionSubdivision]
    ) -> "SearchBasicInfoCountryRegionSubdivisionResponseBodyBuilder":
    ...
    def page_token(
        ...
        self._search_basic_info_country_region_subdivision_response_body.page_token = (
            page_token
        )
        return self
    ...
    def has_more(
        ...
        self._search_basic_info_country_region_subdivision_response_body.has_more = (
            has_more
        )
        return self

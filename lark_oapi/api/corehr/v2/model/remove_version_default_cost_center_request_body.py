...
class RemoveVersionDefaultCostCenterRequestBodyBuilder(object):
    def __init__(self) -> None:
        self._remove_version_default_cost_center_request_body = (
            RemoveVersionDefaultCostCenterRequestBody()
        )

    def employment_id(
        self, employment_id: str
    ) -> "RemoveVersionDefaultCostCenterRequestBodyBuilder":
        self._remove_version_default_cost_center_request_body.employment_id = (
            employment_id
        )
        return self
    ...
    def default_cost_center(
        ...
        self._remove_version_default_cost_center_request_body.default_cost_center = (
            default_cost_center
        )
        return self

...
from .open_query_department_change_list_by_ids_approval_groups_request_body import OpenQueryDepartmentChangeListByIdsApprovalGroupsRequestBody
...
class OpenQueryDepartmentChangeListByIdsApprovalGroupsRequestBuilder(object):
    ...
    def department_id_type(self, department_id_type: str) -> "OpenQueryDepartmentChangeListByIdsApprovalGroupsRequestBuilder":
        ...
        self._open_query_department_change_list_by_ids_approval_groups_request.add_query("department_id_type", department_id_type)
        return self

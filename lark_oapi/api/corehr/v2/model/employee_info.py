...
class EmployeeInfoBuilder(object):
    ...
    def id(self, id: str) -> "EmployeeInfoBuilder":
        self._employee_info.id = id
        return self

    def name(self, name: str) -> "EmployeeInfoBuilder":
        self._employee_info.name = name
        return self

    def avatar(self, avatar: str) -> "EmployeeInfoBuilder":
        self._employee_info.avatar = avatar
        return self

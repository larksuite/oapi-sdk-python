...
class CreateJobChangeRequestBuilder(object):
    def __init__(self) -> None:
        ...
        create_job_change_request.uri = "/open-apis/corehr/v2/job_changes"
        create_job_change_request.token_types = {AccessTokenType.TENANT}
        self._create_job_change_request: CreateJobChangeRequest = (
            create_job_change_request
        )
    ...
    ) -> "CreateJobChangeRequestBuilder":
        self._create_job_change_request.department_id_type = department_id_type
        self._create_job_change_request.add_query(
            "department_id_type", department_id_type
        )
        return self

    def request_body(
        self, request_body: CreateJobChangeRequestBody
    ) -> "CreateJobChangeRequestBuilder":

...
class SearchBasicInfoCountryRegionSubdivisionRequestBuilder(object):
    def __init__(self) -> None:
        search_basic_info_country_region_subdivision_request = (
            SearchBasicInfoCountryRegionSubdivisionRequest()
        )
        search_basic_info_country_region_subdivision_request.http_method = (
            HttpMethod.POST
        )
        search_basic_info_country_region_subdivision_request.uri = (
            "/open-apis/corehr/v2/basic_info/country_region_subdivisions/search"
        )
        search_basic_info_country_region_subdivision_request.token_types = {
    ...
    def page_size(
        self, page_size: int
    ) -> "SearchBasicInfoCountryRegionSubdivisionRequestBuilder":
        self._search_basic_info_country_region_subdivision_request.page_size = page_size
        self._search_basic_info_country_region_subdivision_request.add_query(
            "page_size", page_size
        )
        return self
    ...
    def page_token(
        ...
        self._search_basic_info_country_region_subdivision_request.page_token = (
            page_token
        )
        self._search_basic_info_country_region_subdivision_request.add_query(
    ...
    def request_body(
        self, request_body: SearchBasicInfoCountryRegionSubdivisionRequestBody
    ) -> "SearchBasicInfoCountryRegionSubdivisionRequestBuilder":
        self._search_basic_info_country_region_subdivision_request.request_body = (
            request_body
        )

...
class CreateEmployeesAdditionalJobRequestBuilder(object):
    def __init__(self) -> None:
        ...
        create_employees_additional_job_request.uri = (
    ...
    ) -> "CreateEmployeesAdditionalJobRequestBuilder":
        self._create_employees_additional_job_request.client_token = client_token
        self._create_employees_additional_job_request.add_query(
    ...
    def department_id_type(
        ...
        self._create_employees_additional_job_request.department_id_type = (
            department_id_type
        )
        self._create_employees_additional_job_request.add_query(

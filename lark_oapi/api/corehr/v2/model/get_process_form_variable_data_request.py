...
class GetProcessFormVariableDataRequestBuilder(object):
    def __init__(self) -> None:
        ...
        get_process_form_variable_data_request.uri = (
    ...
    ) -> "GetProcessFormVariableDataRequestBuilder":
        self._get_process_form_variable_data_request.user_id_type = user_id_type
        self._get_process_form_variable_data_request.add_query(
    ...
    def department_id_type(
        ...
        self._get_process_form_variable_data_request.department_id_type = (
            department_id_type
        )
        self._get_process_form_variable_data_request.add_query(
    ...
    def process_id(self, process_id: str) -> "GetProcessFormVariableDataRequestBuilder":
        ...
        self._get_process_form_variable_data_request.paths["process_id"] = str(
            process_id
        )
        return self

...
class SearchProbationRequestBodyBuilder(object):
    ...
    ) -> "SearchProbationRequestBodyBuilder":
    ...
    def probation_start_date_start(
        self, probation_start_date_start: str
    ) -> "SearchProbationRequestBodyBuilder":
        self._search_probation_request_body.probation_start_date_start = (
            probation_start_date_start
        )
        return self

    def probation_start_date_end(
        self, probation_start_date_end: str
    ) -> "SearchProbationRequestBodyBuilder":
        self._search_probation_request_body.probation_start_date_end = (
            probation_start_date_end
        )
        return self

    def probation_expected_end_date_start(
        self, probation_expected_end_date_start: str
    ) -> "SearchProbationRequestBodyBuilder":
        self._search_probation_request_body.probation_expected_end_date_start = (
            probation_expected_end_date_start
        )
        return self

    def probation_expected_end_date_end(
        self, probation_expected_end_date_end: str
    ) -> "SearchProbationRequestBodyBuilder":
        self._search_probation_request_body.probation_expected_end_date_end = (
            probation_expected_end_date_end
        )
        return self

    def actual_probation_end_date_start(
        self, actual_probation_end_date_start: str
    ) -> "SearchProbationRequestBodyBuilder":
        self._search_probation_request_body.actual_probation_end_date_start = (
            actual_probation_end_date_start
        )
        return self

    def actual_probation_end_date_end(
        self, actual_probation_end_date_end: str
    ) -> "SearchProbationRequestBodyBuilder":
        self._search_probation_request_body.actual_probation_end_date_end = (
            actual_probation_end_date_end
        )
        return self

    def initiating_time_start(
        self, initiating_time_start: str
    ) -> "SearchProbationRequestBodyBuilder":
        self._search_probation_request_body.initiating_time_start = (
            initiating_time_start
        )
        return self

    def initiating_time_end(
        self, initiating_time_end: str
    ) -> "SearchProbationRequestBodyBuilder":
        self._search_probation_request_body.initiating_time_end = initiating_time_end
        return self

    def probation_status(
        self, probation_status: str
    ) -> "SearchProbationRequestBodyBuilder":
        self._search_probation_request_body.probation_status = probation_status
        return self

    def final_assessment_result(
        self, final_assessment_result: str
    ) -> "SearchProbationRequestBodyBuilder":
        self._search_probation_request_body.final_assessment_result = (
            final_assessment_result
        )
        return self

    def final_assessment_grade(
        self, final_assessment_grade: str
    ) -> "SearchProbationRequestBodyBuilder":
        self._search_probation_request_body.final_assessment_grade = (

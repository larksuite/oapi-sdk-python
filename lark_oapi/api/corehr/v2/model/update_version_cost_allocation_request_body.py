...
class UpdateVersionCostAllocationRequestBody(object):
    _types = {
        "employment_id": str,
    ...
    def builder() -> "UpdateVersionCostAllocationRequestBodyBuilder":
        return UpdateVersionCostAllocationRequestBodyBuilder()
...
class UpdateVersionCostAllocationRequestBodyBuilder(object):
    ...
    def build(self) -> "UpdateVersionCostAllocationRequestBody":
        return self._update_version_cost_allocation_request_body

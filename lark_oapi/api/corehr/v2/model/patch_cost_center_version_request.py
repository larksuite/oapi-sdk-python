...
class PatchCostCenterVersionRequestBuilder(object):
    def __init__(self) -> None:
        ...
        patch_cost_center_version_request.uri = (
        ...
        self._patch_cost_center_version_request: PatchCostCenterVersionRequest = (
            patch_cost_center_version_request
        )
    ...
    ) -> "PatchCostCenterVersionRequestBuilder":
        self._patch_cost_center_version_request.cost_center_id = cost_center_id
        self._patch_cost_center_version_request.paths["cost_center_id"] = str(
            cost_center_id
        )
        return self
    ...
    def request_body(
        self, request_body: PatchCostCenterVersionRequestBody
    ) -> "PatchCostCenterVersionRequestBuilder":

...
class BatchWorkforcePlanDetailRequestBodyBuilder(object):
    def __init__(self) -> None:
        self._batch_workforce_plan_detail_request_body = (
            BatchWorkforcePlanDetailRequestBody()
        )

    def workforce_plan_id(
        self, workforce_plan_id: str
    ) -> "BatchWorkforcePlanDetailRequestBodyBuilder":
        self._batch_workforce_plan_detail_request_body.workforce_plan_id = (
            workforce_plan_id
        )
        return self
    ...
    def employee_type_ids(
        ...
        self._batch_workforce_plan_detail_request_body.employee_type_ids = (
            employee_type_ids
        )
        return self
    ...
    def work_location_ids(
        ...
        self._batch_workforce_plan_detail_request_body.work_location_ids = (
            work_location_ids
        )
        return self

...
class QueryEmployeesJobDataRequestBuilder(object):
    def __init__(self) -> None:
        ...
        query_employees_job_data_request.uri = (
            "/open-apis/corehr/v2/employees/job_datas/query"
        )
        query_employees_job_data_request.token_types = {AccessTokenType.TENANT}
        self._query_employees_job_data_request: QueryEmployeesJobDataRequest = (
            query_employees_job_data_request
        )
    ...
    ) -> "QueryEmployeesJobDataRequestBuilder":
        self._query_employees_job_data_request.department_id_type = department_id_type
        self._query_employees_job_data_request.add_query(
            "department_id_type", department_id_type
        )
        return self

    def request_body(
        self, request_body: QueryEmployeesJobDataRequestBody
    ) -> "QueryEmployeesJobDataRequestBuilder":

...
class BatchV2WorkforcePlanDetailResponseBodyBuilder(object):
    def __init__(self) -> None:
        self._batch_v2_workforce_plan_detail_response_body = (
            BatchV2WorkforcePlanDetailResponseBody()
        )

    def workforce_plan_id(
        self, workforce_plan_id: str
    ) -> "BatchV2WorkforcePlanDetailResponseBodyBuilder":
        self._batch_v2_workforce_plan_detail_response_body.workforce_plan_id = (
            workforce_plan_id
        )
        return self
    ...
    def items(
        self, items: List[WorkforcePlanDetailV2]
    ) -> "BatchV2WorkforcePlanDetailResponseBodyBuilder":

...
class ProfileSettingProbationInfoBuilder(object):
    ...
    ) -> "ProfileSettingProbationInfoBuilder":
    ...
    def probation_expected_end_date(
        ...
        self._profile_setting_probation_info.probation_expected_end_date = (
    ...
    def actual_probation_end_date(
        ...
        self._profile_setting_probation_info.actual_probation_end_date = (

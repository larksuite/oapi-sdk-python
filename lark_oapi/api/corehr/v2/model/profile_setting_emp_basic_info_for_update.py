...
class ProfileSettingEmpBasicInfoForUpdateBuilder(object):
    def __init__(self) -> None:
        self._profile_setting_emp_basic_info_for_update = (
            ProfileSettingEmpBasicInfoForUpdate()
        )

    def employee_number(
        self, employee_number: str
    ) -> "ProfileSettingEmpBasicInfoForUpdateBuilder":
        self._profile_setting_emp_basic_info_for_update.employee_number = (
            employee_number
        )
        return self
    ...
    def regular_employee_start_date(
        ...
        self._profile_setting_emp_basic_info_for_update.regular_employee_start_date = (

...
class QueryEmployeesJobDataRequestBodyBuilder(object):
    ...
    ) -> "QueryEmployeesJobDataRequestBodyBuilder":
    ...
    def effective_date_start(
        ...
        self._query_employees_job_data_request_body.effective_date_start = (
    ...
    def effective_date_end(
        ...
        self._query_employees_job_data_request_body.effective_date_end = (
            effective_date_end
        )
        return self
    ...
    def assignment_start_reasons(
        ...
        self._query_employees_job_data_request_body.assignment_start_reasons = (

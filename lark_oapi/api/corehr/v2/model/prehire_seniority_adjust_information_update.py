...
class PrehireSeniorityAdjustInformationUpdateBuilder(object):
    def __init__(self) -> None:
        self._prehire_seniority_adjust_information_update = (
            PrehireSeniorityAdjustInformationUpdate()
        )

    def seniority_adjustment(
        self, seniority_adjustment: float
    ) -> "PrehireSeniorityAdjustInformationUpdateBuilder":
        self._prehire_seniority_adjust_information_update.seniority_adjustment = (
    ...
    def seniority_adjustment_type(
        ...
        self._prehire_seniority_adjust_information_update.seniority_adjustment_type = (

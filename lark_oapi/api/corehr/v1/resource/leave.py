...
class Leave(object):
    ...
    def leave_balances(self, request: LeaveBalancesLeaveRequest, option: RequestOption = RequestOption()) -> LeaveBalancesLeaveResponse:
        # 鉴权、获取token
    ...
    def leave_request_history(self, request: LeaveRequestHistoryLeaveRequest, option: RequestOption = RequestOption()) -> LeaveRequestHistoryLeaveResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def leave_types(self, request: LeaveTypesLeaveRequest, option: RequestOption = RequestOption()) -> LeaveTypesLeaveResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

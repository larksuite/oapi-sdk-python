...
class NationalIdType(object):
    ...
    def create(self, request: CreateNationalIdTypeRequest, option: Optional[RequestOption] = None) -> CreateNationalIdTypeResponse:
        if option is None:
    ...
    async def acreate(self, request: CreateNationalIdTypeRequest, option: Optional[RequestOption] = None) -> CreateNationalIdTypeResponse:
        if option is None:
            option = RequestOption()
    ...
    def delete(self, request: DeleteNationalIdTypeRequest, option: Optional[RequestOption] = None) -> DeleteNationalIdTypeResponse:
        if option is None:
            option = RequestOption()
    ...
    async def adelete(self, request: DeleteNationalIdTypeRequest, option: Optional[RequestOption] = None) -> DeleteNationalIdTypeResponse:
        if option is None:
            option = RequestOption()
    ...
    def get(self, request: GetNationalIdTypeRequest, option: Optional[RequestOption] = None) -> GetNationalIdTypeResponse:
        if option is None:
            option = RequestOption()
    ...
    async def aget(self, request: GetNationalIdTypeRequest, option: Optional[RequestOption] = None) -> GetNationalIdTypeResponse:
        if option is None:
            option = RequestOption()
    ...
    def list(self, request: ListNationalIdTypeRequest, option: Optional[RequestOption] = None) -> ListNationalIdTypeResponse:
        if option is None:
            option = RequestOption()
    ...
    async def alist(self, request: ListNationalIdTypeRequest, option: Optional[RequestOption] = None) -> ListNationalIdTypeResponse:
        if option is None:
            option = RequestOption()
    ...
    def patch(self, request: PatchNationalIdTypeRequest, option: Optional[RequestOption] = None) -> PatchNationalIdTypeResponse:
        if option is None:
            option = RequestOption()
    ...
    async def apatch(self, request: PatchNationalIdTypeRequest, option: Optional[RequestOption] = None) -> PatchNationalIdTypeResponse:
        if option is None:
            option = RequestOption()

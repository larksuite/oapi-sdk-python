...
class JobLevel(object):
    ...
    def patch(
        self, request: PatchJobLevelRequest, option: Optional[RequestOption] = None
    ) -> PatchJobLevelResponse:
        if option is None:
            option = RequestOption()
        ...
        # 反序列化
        response: PatchJobLevelResponse = JSON.unmarshal(
            str(resp.content, UTF_8), PatchJobLevelResponse
        )
        response.raw = resp

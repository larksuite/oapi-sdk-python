...
class WorkingHoursType(object):
    ...
    def create(self, request: CreateWorkingHoursTypeRequest, option: RequestOption = RequestOption()) -> CreateWorkingHoursTypeResponse:
        # 鉴权、获取token
    ...
    def delete(self, request: DeleteWorkingHoursTypeRequest, option: RequestOption = RequestOption()) -> DeleteWorkingHoursTypeResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def get(self, request: GetWorkingHoursTypeRequest, option: RequestOption = RequestOption()) -> GetWorkingHoursTypeResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def list(self, request: ListWorkingHoursTypeRequest, option: RequestOption = RequestOption()) -> ListWorkingHoursTypeResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def patch(self, request: PatchWorkingHoursTypeRequest, option: RequestOption = RequestOption()) -> PatchWorkingHoursTypeResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

...
class Offboarding(object):
    ...
    def query(self, request: QueryOffboardingRequest, option: RequestOption = RequestOption()) -> QueryOffboardingResponse:
        # 鉴权、获取token
    ...
    def search(self, request: SearchOffboardingRequest, option: RequestOption = RequestOption()) -> SearchOffboardingResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def submit(self, request: SubmitOffboardingRequest, option: RequestOption = RequestOption()) -> SubmitOffboardingResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

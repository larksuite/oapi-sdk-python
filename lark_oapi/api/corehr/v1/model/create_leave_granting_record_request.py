...
class CreateLeaveGrantingRecordRequestBuilder(object):
    ...
    def __init__(self, create_leave_granting_record_request: CreateLeaveGrantingRecordRequest = CreateLeaveGrantingRecordRequest()) -> None:
    ...
    def user_id_type(self, user_id_type: str) -> "CreateLeaveGrantingRecordRequestBuilder":
        ...
        self._create_leave_granting_record_request.queries["user_id_type"] = str(user_id_type)
        return self

...
from .edit_enum_option_common_data_meta_data_request_body import (
    EditEnumOptionCommonDataMetaDataRequestBody,
)
...
class EditEnumOptionCommonDataMetaDataRequestBuilder(object):
    ...
    ) -> "EditEnumOptionCommonDataMetaDataRequestBuilder":
        self._edit_enum_option_common_data_meta_data_request.client_token = client_token
        self._edit_enum_option_common_data_meta_data_request.add_query(
            "client_token", client_token
        )
        return self

    def request_body(
        self, request_body: EditEnumOptionCommonDataMetaDataRequestBody
    ) -> "EditEnumOptionCommonDataMetaDataRequestBuilder":

...
class SubmitOffboardingRequestBodyBuilder(object):
    ...
    ) -> "SubmitOffboardingRequestBodyBuilder":
    ...
    def offboarding_reason_unique_identifier(
        ...
        self._submit_offboarding_request_body.offboarding_reason_unique_identifier = (
    ...
    def offboarding_reason_explanation(
        ...
        self._submit_offboarding_request_body.offboarding_reason_explanation = (
    ...
    def block_reason_explanation(
        ...
        self._submit_offboarding_request_body.block_reason_explanation = (

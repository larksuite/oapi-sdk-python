...
class SearchAssignedUserRequestBuilder(object):
    def __init__(self) -> None:
        ...
        self._search_assigned_user_request: SearchAssignedUserRequest = (
            search_assigned_user_request
        )
    ...
    def request_body(
        self, request_body: SearchAssignedUserRequestBody
    ) -> "SearchAssignedUserRequestBuilder":

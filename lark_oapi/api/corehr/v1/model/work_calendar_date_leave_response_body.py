...
class WorkCalendarDateLeaveResponseBodyBuilder(object):
    def __init__(self) -> None:
        self._work_calendar_date_leave_response_body = (
            WorkCalendarDateLeaveResponseBody()
        )

    def calendar_dates(
        self, calendar_dates: List[WkCalendarDate]
    ) -> "WorkCalendarDateLeaveResponseBodyBuilder":

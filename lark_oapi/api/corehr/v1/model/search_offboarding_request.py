...
class SearchOffboardingRequestBuilder(object):
    ...
    def __init__(self, search_offboarding_request: SearchOffboardingRequest = SearchOffboardingRequest()) -> None:
    ...
    def page_size(self, page_size: int) -> "SearchOffboardingRequestBuilder":
        ...
        self._search_offboarding_request.queries["page_size"] = str(page_size)
        return self

    def page_token(self, page_token: str) -> "SearchOffboardingRequestBuilder":
        self._search_offboarding_request.page_token = page_token
        self._search_offboarding_request.queries["page_token"] = str(page_token)
        return self
    ...
    def user_id_type(self, user_id_type: str) -> "SearchOffboardingRequestBuilder":
        ...
        self._search_offboarding_request.queries["user_id_type"] = str(user_id_type)
        return self

...
class SubmitOffboardingRequestBuilder(object):
    def __init__(self) -> None:
        ...
        self._submit_offboarding_request: SubmitOffboardingRequest = (
            submit_offboarding_request
        )
    ...
    def request_body(
        self, request_body: SubmitOffboardingRequestBody
    ) -> "SubmitOffboardingRequestBuilder":

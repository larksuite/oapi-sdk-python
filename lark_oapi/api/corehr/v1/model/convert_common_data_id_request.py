...
class ConvertCommonDataIdRequestBuilder(object):
    def __init__(self) -> None:
        ...
        convert_common_data_id_request.uri = (
            "/open-apis/corehr/v1/common_data/id/convert"
        )
        convert_common_data_id_request.token_types = {AccessTokenType.TENANT}
        self._convert_common_data_id_request: ConvertCommonDataIdRequest = (
            convert_common_data_id_request
        )

    def id_transform_type(
        self, id_transform_type: int
    ) -> "ConvertCommonDataIdRequestBuilder":
        self._convert_common_data_id_request.id_transform_type = id_transform_type
        self._convert_common_data_id_request.add_query(
            "id_transform_type", id_transform_type
        )
        return self
    ...
    def feishu_user_id_type(
        self, feishu_user_id_type: str
    ) -> "ConvertCommonDataIdRequestBuilder":
        self._convert_common_data_id_request.feishu_user_id_type = feishu_user_id_type
        self._convert_common_data_id_request.add_query(
            "feishu_user_id_type", feishu_user_id_type
        )
        return self

    def feishu_department_id_type(
        self, feishu_department_id_type: str
    ) -> "ConvertCommonDataIdRequestBuilder":
        self._convert_common_data_id_request.feishu_department_id_type = (
            feishu_department_id_type
        )
        self._convert_common_data_id_request.add_query(
            "feishu_department_id_type", feishu_department_id_type
        )
        return self

    def request_body(
        self, request_body: ConvertCommonDataIdRequestBody
    ) -> "ConvertCommonDataIdRequestBuilder":

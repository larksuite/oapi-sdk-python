...
class CreateNationalIdTypeRequestBuilder(object):
    ...
    def __init__(self, create_national_id_type_request: CreateNationalIdTypeRequest = CreateNationalIdTypeRequest()) -> None:
    ...
    def client_token(self, client_token: str) -> "CreateNationalIdTypeRequestBuilder":
        ...
        self._create_national_id_type_request.queries["client_token"] = str(client_token)
        return self

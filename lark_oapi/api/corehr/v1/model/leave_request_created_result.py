...
class LeaveRequestCreatedResultBuilder(object):
    ...
    def error_messages(
        self, error_messages: List[LeaveRequestCreatedErrorMessage]
    ) -> "LeaveRequestCreatedResultBuilder":
        self._leave_request_created_result.error_messages = error_messages
        return self

    def leave_request_results(
        self, leave_request_results: List[LeaveRequest]
    ) -> "LeaveRequestCreatedResultBuilder":

...
class QueryTransferReasonRequestBuilder(object):
    ...
    def __init__(self, query_transfer_reason_request: QueryTransferReasonRequest = QueryTransferReasonRequest()) -> None:
    ...
    def transfer_reason_unique_identifier(self, transfer_reason_unique_identifier: List[str]) -> "QueryTransferReasonRequestBuilder":
        ...
        self._query_transfer_reason_request.queries["transfer_reason_unique_identifier"] = str(transfer_reason_unique_identifier)
        return self

...
class QueryTransferReasonRequestBuilder(object):
    def __init__(self) -> None:
        ...
        query_transfer_reason_request.uri = (
            "/open-apis/corehr/v1/transfer_reasons/query"
        )
        query_transfer_reason_request.token_types = {
            AccessTokenType.USER,
            AccessTokenType.TENANT,
        }
        self._query_transfer_reason_request: QueryTransferReasonRequest = (
            query_transfer_reason_request
        )
    ...
    ) -> "QueryTransferReasonRequestBuilder":
        self._query_transfer_reason_request.transfer_reason_unique_identifier = (
            transfer_reason_unique_identifier
        )
        self._query_transfer_reason_request.add_query(
            "transfer_reason_unique_identifier", transfer_reason_unique_identifier
        )
        return self

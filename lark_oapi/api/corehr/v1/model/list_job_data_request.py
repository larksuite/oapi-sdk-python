...
class ListJobDataRequestBuilder(object):
    ...
    def __init__(self, list_job_data_request: ListJobDataRequest = ListJobDataRequest()) -> None:
    ...
    def page_token(self, page_token: str) -> "ListJobDataRequestBuilder":
        ...
        self._list_job_data_request.queries["page_token"] = str(page_token)
        return self

    def page_size(self, page_size: str) -> "ListJobDataRequestBuilder":
        self._list_job_data_request.page_size = page_size
        self._list_job_data_request.queries["page_size"] = str(page_size)
        return self
    ...
    def employment_id(self, employment_id: str) -> "ListJobDataRequestBuilder":
        ...
        self._list_job_data_request.queries["employment_id"] = str(employment_id)
        return self
    ...
    def job_data_id_list(self, job_data_id_list: List[str]) -> "ListJobDataRequestBuilder":
        ...
        self._list_job_data_request.queries["job_data_id_list"] = str(job_data_id_list)
        return self
    ...
    def department_id(self, department_id: str) -> "ListJobDataRequestBuilder":
        ...
        self._list_job_data_request.queries["department_id"] = str(department_id)
        return self

    def job_id(self, job_id: str) -> "ListJobDataRequestBuilder":
        self._list_job_data_request.job_id = job_id
        self._list_job_data_request.queries["job_id"] = str(job_id)
        return self
    ...
    def get_all_version(self, get_all_version: bool) -> "ListJobDataRequestBuilder":
        ...
        self._list_job_data_request.queries["get_all_version"] = str(get_all_version)
        return self

    def user_id_type(self, user_id_type: str) -> "ListJobDataRequestBuilder":
        self._list_job_data_request.user_id_type = user_id_type
        self._list_job_data_request.queries["user_id_type"] = str(user_id_type)
        return self
    ...
    def department_id_type(self, department_id_type: str) -> "ListJobDataRequestBuilder":
        ...
        self._list_job_data_request.queries["department_id_type"] = str(department_id_type)
        return self

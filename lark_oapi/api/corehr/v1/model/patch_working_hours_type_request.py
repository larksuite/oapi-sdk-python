...
class PatchWorkingHoursTypeRequestBuilder(object):
    def __init__(self) -> None:
        ...
        patch_working_hours_type_request.uri = (
        ...
        self._patch_working_hours_type_request: PatchWorkingHoursTypeRequest = (
            patch_working_hours_type_request
        )
    ...
    ) -> "PatchWorkingHoursTypeRequestBuilder":
        self._patch_working_hours_type_request.working_hours_type_id = (
            working_hours_type_id
        )
        self._patch_working_hours_type_request.paths["working_hours_type_id"] = str(
            working_hours_type_id
        )
        return self

    def request_body(
        self, request_body: WorkingHoursType
    ) -> "PatchWorkingHoursTypeRequestBuilder":

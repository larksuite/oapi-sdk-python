...
class DeleteWorkingHoursTypeRequestBuilder(object):
    def __init__(self) -> None:
        ...
        delete_working_hours_type_request.uri = (
        ...
        self._delete_working_hours_type_request: DeleteWorkingHoursTypeRequest = (
            delete_working_hours_type_request
        )

    def working_hours_type_id(
        self, working_hours_type_id: str
    ) -> "DeleteWorkingHoursTypeRequestBuilder":
        self._delete_working_hours_type_request.working_hours_type_id = (
            working_hours_type_id
        )
        self._delete_working_hours_type_request.paths["working_hours_type_id"] = str(
            working_hours_type_id
        )
        return self

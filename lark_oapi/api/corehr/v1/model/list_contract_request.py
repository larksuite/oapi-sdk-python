...
class ListContractRequestBuilder(object):
    ...
    def __init__(self, list_contract_request: ListContractRequest = ListContractRequest()) -> None:
    ...
    def page_token(self, page_token: str) -> "ListContractRequestBuilder":
        ...
        self._list_contract_request.queries["page_token"] = str(page_token)
        return self

    def page_size(self, page_size: str) -> "ListContractRequestBuilder":
        self._list_contract_request.page_size = page_size
        self._list_contract_request.queries["page_size"] = str(page_size)
        return self

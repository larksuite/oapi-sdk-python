...
class AddEnumOptionCommonDataMetaDataRequestBuilder(object):
    ...
    ) -> "AddEnumOptionCommonDataMetaDataRequestBuilder":
        self._add_enum_option_common_data_meta_data_request.client_token = client_token
        self._add_enum_option_common_data_meta_data_request.add_query(
            "client_token", client_token
        )
        return self

    def request_body(
        self, request_body: AddEnumOptionCommonDataMetaDataRequestBody
    ) -> "AddEnumOptionCommonDataMetaDataRequestBuilder":

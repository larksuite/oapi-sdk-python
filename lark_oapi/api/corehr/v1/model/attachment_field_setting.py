...
class AttachmentFieldSettingBuilder(object):
    def __init__(self, attachment_field_setting: AttachmentFieldSetting = AttachmentFieldSetting({})) -> None:
        self._attachment_field_setting: AttachmentFieldSetting = attachment_field_setting

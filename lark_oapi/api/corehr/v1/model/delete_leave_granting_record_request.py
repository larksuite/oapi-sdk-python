...
class DeleteLeaveGrantingRecordRequestBuilder(object):
    def __init__(self) -> None:
        ...
        delete_leave_granting_record_request.uri = (
        ...
        self._delete_leave_granting_record_request: DeleteLeaveGrantingRecordRequest = (
            delete_leave_granting_record_request
        )

    def leave_granting_record_id(
        self, leave_granting_record_id: str
    ) -> "DeleteLeaveGrantingRecordRequestBuilder":
        self._delete_leave_granting_record_request.leave_granting_record_id = (
            leave_granting_record_id
        )
        self._delete_leave_granting_record_request.paths["leave_granting_record_id"] = (
            str(leave_granting_record_id)
        )
        return self

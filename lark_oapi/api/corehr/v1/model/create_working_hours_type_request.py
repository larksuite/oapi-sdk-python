...
class CreateWorkingHoursTypeRequestBuilder(object):
    def __init__(self) -> None:
        ...
        create_working_hours_type_request.uri = (
            "/open-apis/corehr/v1/working_hours_types"
        )
        create_working_hours_type_request.token_types = {AccessTokenType.TENANT}
        self._create_working_hours_type_request: CreateWorkingHoursTypeRequest = (
            create_working_hours_type_request
        )
    ...
    ) -> "CreateWorkingHoursTypeRequestBuilder":

...
class PatchJobRequestBuilder(object):
    ...
    def __init__(self, patch_job_request: PatchJobRequest = PatchJobRequest()) -> None:
    ...
    def client_token(self, client_token: str) -> "PatchJobRequestBuilder":
        ...
        self._patch_job_request.queries["client_token"] = str(client_token)
        return self

    def job_id(self, job_id: str) -> "PatchJobRequestBuilder":
        self._patch_job_request.job_id = job_id
        self._patch_job_request.paths["job_id"] = job_id
        return self

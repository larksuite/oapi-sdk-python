...
class CreateLeaveGrantingRecordRequestBodyBuilder(object):
    def __init__(self) -> None:
        self._create_leave_granting_record_request_body = (
            CreateLeaveGrantingRecordRequestBody()
        )

    def leave_type_id(
        self, leave_type_id: str
    ) -> "CreateLeaveGrantingRecordRequestBodyBuilder":
    ...
    def granting_quantity(
        ...
        self._create_leave_granting_record_request_body.granting_quantity = (
            granting_quantity
        )
        return self

    def granting_unit(
        self, granting_unit: int
    ) -> "CreateLeaveGrantingRecordRequestBodyBuilder":
    ...
    def expiration_date(
        ...
        self._create_leave_granting_record_request_body.expiration_date = (
            expiration_date
        )
        return self

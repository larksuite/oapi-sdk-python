...
class Spreadsheet(object):
    ...
    def create(self, request: CreateSpreadsheetRequest, option: RequestOption = RequestOption()) -> CreateSpreadsheetResponse:
        # 鉴权、获取token
    ...
    def patch(self, request: PatchSpreadsheetRequest, option: RequestOption = RequestOption()) -> PatchSpreadsheetResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

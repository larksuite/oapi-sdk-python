...
class QuerySpreadsheetSheetFloatImageRequestBuilder(object):
    def __init__(self) -> None:
        query_spreadsheet_sheet_float_image_request = (
        ...
        query_spreadsheet_sheet_float_image_request.token_types = {
    ...
    ) -> "QuerySpreadsheetSheetFloatImageRequestBuilder":
        self._query_spreadsheet_sheet_float_image_request.spreadsheet_token = (
            spreadsheet_token
        )
        self._query_spreadsheet_sheet_float_image_request.paths["spreadsheet_token"] = (
    ...
    def sheet_id(
        ...
        self._query_spreadsheet_sheet_float_image_request.paths["sheet_id"] = str(
            sheet_id
        )
        return self

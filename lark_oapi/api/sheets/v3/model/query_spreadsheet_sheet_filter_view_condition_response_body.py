...
class QuerySpreadsheetSheetFilterViewConditionResponseBodyBuilder(object):
    def __init__(self, query_spreadsheet_sheet_filter_view_condition_response_body: QuerySpreadsheetSheetFilterViewConditionResponseBody = QuerySpreadsheetSheetFilterViewConditionResponseBody({})) -> None:

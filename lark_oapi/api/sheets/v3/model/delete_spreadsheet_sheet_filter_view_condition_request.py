...
class DeleteSpreadsheetSheetFilterViewConditionRequestBuilder(object):
    def __init__(self) -> None:
        delete_spreadsheet_sheet_filter_view_condition_request = (
            DeleteSpreadsheetSheetFilterViewConditionRequest()
        )
        delete_spreadsheet_sheet_filter_view_condition_request.http_method = (
            HttpMethod.DELETE
        )
        ...
        delete_spreadsheet_sheet_filter_view_condition_request.token_types = {
    ...
    ) -> "DeleteSpreadsheetSheetFilterViewConditionRequestBuilder":
        self._delete_spreadsheet_sheet_filter_view_condition_request.spreadsheet_token = spreadsheet_token
        self._delete_spreadsheet_sheet_filter_view_condition_request.paths[
            "spreadsheet_token"
    ...
    def filter_view_id(
        ...
        self._delete_spreadsheet_sheet_filter_view_condition_request.filter_view_id = (
            filter_view_id
        )
        self._delete_spreadsheet_sheet_filter_view_condition_request.paths[
            "filter_view_id"
    ...
    def condition_id(
        ...
        self._delete_spreadsheet_sheet_filter_view_condition_request.condition_id = (
            condition_id
        )
        self._delete_spreadsheet_sheet_filter_view_condition_request.paths[
            "condition_id"

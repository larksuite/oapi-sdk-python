...
class CreateSpreadsheetSheetFilterViewConditionRequestBuilder(object):
    def __init__(self) -> None:
        create_spreadsheet_sheet_filter_view_condition_request = (
            CreateSpreadsheetSheetFilterViewConditionRequest()
        )
        create_spreadsheet_sheet_filter_view_condition_request.http_method = (
            HttpMethod.POST
        )
        ...
        create_spreadsheet_sheet_filter_view_condition_request.token_types = {
    ...
    ) -> "CreateSpreadsheetSheetFilterViewConditionRequestBuilder":
        self._create_spreadsheet_sheet_filter_view_condition_request.spreadsheet_token = spreadsheet_token
        self._create_spreadsheet_sheet_filter_view_condition_request.paths[
            "spreadsheet_token"
    ...
    def filter_view_id(
        ...
        self._create_spreadsheet_sheet_filter_view_condition_request.filter_view_id = (
            filter_view_id
        )
        self._create_spreadsheet_sheet_filter_view_condition_request.paths[
            "filter_view_id"
    ...
    def request_body(
        ...
        self._create_spreadsheet_sheet_filter_view_condition_request.request_body = (
            request_body
        )

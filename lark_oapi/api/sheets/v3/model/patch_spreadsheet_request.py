...
class PatchSpreadsheetRequestBuilder(object):
    def __init__(self) -> None:
        ...
        patch_spreadsheet_request.uri = (
            "/open-apis/sheets/v3/spreadsheets/:spreadsheet_token"
        )
        patch_spreadsheet_request.token_types = {
            AccessTokenType.TENANT,
            AccessTokenType.USER,
        }
        self._patch_spreadsheet_request: PatchSpreadsheetRequest = (
            patch_spreadsheet_request
        )
    ...
    def spreadsheet_token(
        ...
        self._patch_spreadsheet_request.paths["spreadsheet_token"] = str(
            spreadsheet_token
        )
        return self

    def request_body(
        self, request_body: UpdateSpreadsheetProperties
    ) -> "PatchSpreadsheetRequestBuilder":

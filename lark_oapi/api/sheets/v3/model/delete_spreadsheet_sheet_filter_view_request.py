...
class DeleteSpreadsheetSheetFilterViewRequestBuilder(object):
    ...
    def __init__(self, delete_spreadsheet_sheet_filter_view_request: DeleteSpreadsheetSheetFilterViewRequest = DeleteSpreadsheetSheetFilterViewRequest()) -> None:
    ...
    def spreadsheet_token(self, spreadsheet_token: str) -> "DeleteSpreadsheetSheetFilterViewRequestBuilder":
        ...
        self._delete_spreadsheet_sheet_filter_view_request.paths["spreadsheet_token"] = spreadsheet_token
        return self
    ...
    def sheet_id(self, sheet_id: str) -> "DeleteSpreadsheetSheetFilterViewRequestBuilder":
        ...
        self._delete_spreadsheet_sheet_filter_view_request.paths["sheet_id"] = sheet_id
        return self
    ...
    def filter_view_id(self, filter_view_id: str) -> "DeleteSpreadsheetSheetFilterViewRequestBuilder":
        ...
        self._delete_spreadsheet_sheet_filter_view_request.paths["filter_view_id"] = filter_view_id
        return self

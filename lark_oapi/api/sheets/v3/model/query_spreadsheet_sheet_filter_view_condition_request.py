...
class QuerySpreadsheetSheetFilterViewConditionRequestBuilder(object):
    ...
    def __init__(self, query_spreadsheet_sheet_filter_view_condition_request: QuerySpreadsheetSheetFilterViewConditionRequest = QuerySpreadsheetSheetFilterViewConditionRequest()) -> None:
        ...
        query_spreadsheet_sheet_filter_view_condition_request.token_types = {AccessTokenType.TENANT, AccessTokenType.USER}

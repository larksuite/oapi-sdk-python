...
class GetSpreadsheetSheetFilterViewRequestBuilder(object):
    ...
    def __init__(self, get_spreadsheet_sheet_filter_view_request: GetSpreadsheetSheetFilterViewRequest = GetSpreadsheetSheetFilterViewRequest()) -> None:
    ...
    def spreadsheet_token(self, spreadsheet_token: str) -> "GetSpreadsheetSheetFilterViewRequestBuilder":
        ...
        self._get_spreadsheet_sheet_filter_view_request.paths["spreadsheet_token"] = spreadsheet_token
        return self
    ...
    def sheet_id(self, sheet_id: str) -> "GetSpreadsheetSheetFilterViewRequestBuilder":
        ...
        self._get_spreadsheet_sheet_filter_view_request.paths["sheet_id"] = sheet_id
        return self
    ...
    def filter_view_id(self, filter_view_id: str) -> "GetSpreadsheetSheetFilterViewRequestBuilder":
        ...
        self._get_spreadsheet_sheet_filter_view_request.paths["filter_view_id"] = filter_view_id
        return self

...
class GetSpreadsheetSheetFilterViewRequestBuilder(object):
    def __init__(self) -> None:
        get_spreadsheet_sheet_filter_view_request = (
        ...
        get_spreadsheet_sheet_filter_view_request.token_types = {
    ...
    ) -> "GetSpreadsheetSheetFilterViewRequestBuilder":
        self._get_spreadsheet_sheet_filter_view_request.spreadsheet_token = (
            spreadsheet_token
        )
        self._get_spreadsheet_sheet_filter_view_request.paths["spreadsheet_token"] = (
    ...
    def sheet_id(self, sheet_id: str) -> "GetSpreadsheetSheetFilterViewRequestBuilder":
        ...
        self._get_spreadsheet_sheet_filter_view_request.paths["sheet_id"] = str(
            sheet_id
        )
        return self
    ...
    def filter_view_id(
        ...
        self._get_spreadsheet_sheet_filter_view_request.paths["filter_view_id"] = str(
            filter_view_id
        )
        return self

...
class CreateSpreadsheetSheetFloatImageResponseBodyBuilder(object):
    def __init__(self, create_spreadsheet_sheet_float_image_response_body: CreateSpreadsheetSheetFloatImageResponseBody = CreateSpreadsheetSheetFloatImageResponseBody({})) -> None:

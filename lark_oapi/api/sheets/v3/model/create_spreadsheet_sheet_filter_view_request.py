...
class CreateSpreadsheetSheetFilterViewRequestBuilder(object):
    ...
    def __init__(self, create_spreadsheet_sheet_filter_view_request: CreateSpreadsheetSheetFilterViewRequest = CreateSpreadsheetSheetFilterViewRequest()) -> None:
    ...
    def spreadsheet_token(self, spreadsheet_token: str) -> "CreateSpreadsheetSheetFilterViewRequestBuilder":
        ...
        self._create_spreadsheet_sheet_filter_view_request.paths["spreadsheet_token"] = spreadsheet_token
        return self
    ...
    def sheet_id(self, sheet_id: str) -> "CreateSpreadsheetSheetFilterViewRequestBuilder":
        ...
        self._create_spreadsheet_sheet_filter_view_request.paths["sheet_id"] = sheet_id
        return self

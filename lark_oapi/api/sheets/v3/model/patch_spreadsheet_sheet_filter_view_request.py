...
class PatchSpreadsheetSheetFilterViewRequestBuilder(object):
    def __init__(self) -> None:
        patch_spreadsheet_sheet_filter_view_request = (
        ...
        patch_spreadsheet_sheet_filter_view_request.token_types = {
    ...
    ) -> "PatchSpreadsheetSheetFilterViewRequestBuilder":
        self._patch_spreadsheet_sheet_filter_view_request.spreadsheet_token = (
            spreadsheet_token
        )
        self._patch_spreadsheet_sheet_filter_view_request.paths["spreadsheet_token"] = (
    ...
    def sheet_id(
        ...
        self._patch_spreadsheet_sheet_filter_view_request.paths["sheet_id"] = str(
            sheet_id
        )
        return self
    ...
    def filter_view_id(
        ...
        self._patch_spreadsheet_sheet_filter_view_request.filter_view_id = (
            filter_view_id
        )
        self._patch_spreadsheet_sheet_filter_view_request.paths["filter_view_id"] = str(
            filter_view_id
        )
        return self

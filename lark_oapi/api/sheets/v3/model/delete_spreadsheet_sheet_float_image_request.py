...
class DeleteSpreadsheetSheetFloatImageRequestBuilder(object):
    def __init__(self) -> None:
        delete_spreadsheet_sheet_float_image_request = (
        ...
        delete_spreadsheet_sheet_float_image_request.token_types = {
    ...
    ) -> "DeleteSpreadsheetSheetFloatImageRequestBuilder":
        self._delete_spreadsheet_sheet_float_image_request.spreadsheet_token = (
            spreadsheet_token
        )
        self._delete_spreadsheet_sheet_float_image_request.paths[
            "spreadsheet_token"
    ...
    def sheet_id(
        ...
        self._delete_spreadsheet_sheet_float_image_request.paths["sheet_id"] = str(
            sheet_id
        )
        return self
    ...
    def float_image_id(
        ...
        self._delete_spreadsheet_sheet_float_image_request.float_image_id = (
            float_image_id
        )
        self._delete_spreadsheet_sheet_float_image_request.paths["float_image_id"] = (
            str(float_image_id)
        )
        return self

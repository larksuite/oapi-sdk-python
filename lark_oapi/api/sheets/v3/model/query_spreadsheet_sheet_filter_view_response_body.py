...
class QuerySpreadsheetSheetFilterViewResponseBodyBuilder(object):
    def __init__(self, query_spreadsheet_sheet_filter_view_response_body: QuerySpreadsheetSheetFilterViewResponseBody = QuerySpreadsheetSheetFilterViewResponseBody({})) -> None:

...
class GetSpreadsheetSheetFilterViewResponseBodyBuilder(object):
    def __init__(self, get_spreadsheet_sheet_filter_view_response_body: GetSpreadsheetSheetFilterViewResponseBody = GetSpreadsheetSheetFilterViewResponseBody({})) -> None:

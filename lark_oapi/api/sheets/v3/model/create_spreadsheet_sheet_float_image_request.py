...
class CreateSpreadsheetSheetFloatImageRequestBuilder(object):
    def __init__(self) -> None:
        create_spreadsheet_sheet_float_image_request = (
        ...
        create_spreadsheet_sheet_float_image_request.token_types = {
    ...
    ) -> "CreateSpreadsheetSheetFloatImageRequestBuilder":
        self._create_spreadsheet_sheet_float_image_request.spreadsheet_token = (
            spreadsheet_token
        )
        self._create_spreadsheet_sheet_float_image_request.paths[
            "spreadsheet_token"
    ...
    def sheet_id(
        ...
        self._create_spreadsheet_sheet_float_image_request.paths["sheet_id"] = str(
            sheet_id
        )
        return self

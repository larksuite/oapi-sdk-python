...
class UpdateSpreadsheetSheetFilterViewConditionRequestBuilder(object):
    def __init__(self) -> None:
        update_spreadsheet_sheet_filter_view_condition_request = (
            UpdateSpreadsheetSheetFilterViewConditionRequest()
        )
        update_spreadsheet_sheet_filter_view_condition_request.http_method = (
            HttpMethod.PUT
        )
        ...
        update_spreadsheet_sheet_filter_view_condition_request.token_types = {
    ...
    ) -> "UpdateSpreadsheetSheetFilterViewConditionRequestBuilder":
        self._update_spreadsheet_sheet_filter_view_condition_request.spreadsheet_token = spreadsheet_token
        self._update_spreadsheet_sheet_filter_view_condition_request.paths[
            "spreadsheet_token"
    ...
    def filter_view_id(
        ...
        self._update_spreadsheet_sheet_filter_view_condition_request.filter_view_id = (
            filter_view_id
        )
        self._update_spreadsheet_sheet_filter_view_condition_request.paths[
            "filter_view_id"
    ...
    def condition_id(
        ...
        self._update_spreadsheet_sheet_filter_view_condition_request.condition_id = (
            condition_id
        )
        self._update_spreadsheet_sheet_filter_view_condition_request.paths[
            "condition_id"
    ...
    def request_body(
        self, request_body: FilterViewCondition
    ) -> "UpdateSpreadsheetSheetFilterViewConditionRequestBuilder":
        self._update_spreadsheet_sheet_filter_view_condition_request.request_body = (
            request_body
        )

...
class GetSpreadsheetSheetFloatImageResponseBodyBuilder(object):
    def __init__(self, get_spreadsheet_sheet_float_image_response_body: GetSpreadsheetSheetFloatImageResponseBody = GetSpreadsheetSheetFloatImageResponseBody({})) -> None:

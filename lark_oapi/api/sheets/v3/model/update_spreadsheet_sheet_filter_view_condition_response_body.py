...
class UpdateSpreadsheetSheetFilterViewConditionResponseBodyBuilder(object):
    def __init__(self, update_spreadsheet_sheet_filter_view_condition_response_body: UpdateSpreadsheetSheetFilterViewConditionResponseBody = UpdateSpreadsheetSheetFilterViewConditionResponseBody({})) -> None:

...
class GetSpreadsheetSheetRequest(BaseRequest):
    ...
    def builder() -> "GetSpreadsheetSheetRequestBuilder":
        return GetSpreadsheetSheetRequestBuilder()


class GetSpreadsheetSheetRequestBuilder(object):
    def __init__(self) -> None:
        get_spreadsheet_sheet_request = GetSpreadsheetSheetRequest()
        get_spreadsheet_sheet_request.http_method = HttpMethod.GET
        get_spreadsheet_sheet_request.uri = (
            "/open-apis/sheets/v3/spreadsheets/:spreadsheet_token/sheets/:sheet_id"
        )
        get_spreadsheet_sheet_request.token_types = {
            AccessTokenType.TENANT,
            AccessTokenType.USER,
        }
        self._get_spreadsheet_sheet_request: GetSpreadsheetSheetRequest = (
            get_spreadsheet_sheet_request
        )

    def spreadsheet_token(
        self, spreadsheet_token: str
    ) -> "GetSpreadsheetSheetRequestBuilder":
        self._get_spreadsheet_sheet_request.spreadsheet_token = spreadsheet_token
        self._get_spreadsheet_sheet_request.paths["spreadsheet_token"] = str(
            spreadsheet_token
        )
        return self

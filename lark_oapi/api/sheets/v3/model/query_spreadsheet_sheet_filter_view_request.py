...
class QuerySpreadsheetSheetFilterViewRequestBuilder(object):
    def __init__(self) -> None:
        query_spreadsheet_sheet_filter_view_request = (
        ...
        query_spreadsheet_sheet_filter_view_request.token_types = {
    ...
    ) -> "QuerySpreadsheetSheetFilterViewRequestBuilder":
        self._query_spreadsheet_sheet_filter_view_request.spreadsheet_token = (
            spreadsheet_token
        )
        self._query_spreadsheet_sheet_filter_view_request.paths["spreadsheet_token"] = (
    ...
    def sheet_id(
        ...
        self._query_spreadsheet_sheet_filter_view_request.paths["sheet_id"] = str(
            sheet_id
        )
        return self

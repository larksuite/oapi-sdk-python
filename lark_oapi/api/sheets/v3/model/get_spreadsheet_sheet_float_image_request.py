...
class GetSpreadsheetSheetFloatImageRequestBuilder(object):
    def __init__(self) -> None:
        get_spreadsheet_sheet_float_image_request = (
        ...
        get_spreadsheet_sheet_float_image_request.token_types = {
    ...
    ) -> "GetSpreadsheetSheetFloatImageRequestBuilder":
        self._get_spreadsheet_sheet_float_image_request.spreadsheet_token = (
            spreadsheet_token
        )
        self._get_spreadsheet_sheet_float_image_request.paths["spreadsheet_token"] = (
    ...
    def sheet_id(self, sheet_id: str) -> "GetSpreadsheetSheetFloatImageRequestBuilder":
        ...
        self._get_spreadsheet_sheet_float_image_request.paths["sheet_id"] = str(
            sheet_id
        )
        return self
    ...
    def float_image_id(
        ...
        self._get_spreadsheet_sheet_float_image_request.paths["float_image_id"] = str(
            float_image_id
        )
        return self

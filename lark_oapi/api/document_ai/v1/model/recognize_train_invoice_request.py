...
class RecognizeTrainInvoiceRequestBuilder(object):
    def __init__(self) -> None:
        ...
        recognize_train_invoice_request.uri = (
            "/open-apis/document_ai/v1/train_invoice/recognize"
        )
        recognize_train_invoice_request.token_types = {AccessTokenType.TENANT}
        self._recognize_train_invoice_request: RecognizeTrainInvoiceRequest = (
            recognize_train_invoice_request
        )

    def request_body(
        self, request_body: RecognizeTrainInvoiceRequestBody
    ) -> "RecognizeTrainInvoiceRequestBuilder":

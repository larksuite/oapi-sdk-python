...
class RecognizeIdCardRequestBuilder(object):
    def __init__(self) -> None:
        ...
        self._recognize_id_card_request: RecognizeIdCardRequest = (
            recognize_id_card_request
        )

    def request_body(
        self, request_body: RecognizeIdCardRequestBody
    ) -> "RecognizeIdCardRequestBuilder":

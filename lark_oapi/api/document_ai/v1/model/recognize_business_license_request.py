...
class RecognizeBusinessLicenseRequestBuilder(object):
    def __init__(self) -> None:
        ...
        recognize_business_license_request.uri = (
            "/open-apis/document_ai/v1/business_license/recognize"
        )
        recognize_business_license_request.token_types = {AccessTokenType.TENANT}
        self._recognize_business_license_request: RecognizeBusinessLicenseRequest = (
            recognize_business_license_request
        )

    def request_body(
        self, request_body: RecognizeBusinessLicenseRequestBody
    ) -> "RecognizeBusinessLicenseRequestBuilder":

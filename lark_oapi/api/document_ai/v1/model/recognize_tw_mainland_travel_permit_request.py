...
from .recognize_tw_mainland_travel_permit_request_body import (
    RecognizeTwMainlandTravelPermitRequestBody,
)
...
class RecognizeTwMainlandTravelPermitRequestBuilder(object):
    ...
    def request_body(
        self, request_body: RecognizeTwMainlandTravelPermitRequestBody
    ) -> "RecognizeTwMainlandTravelPermitRequestBuilder":

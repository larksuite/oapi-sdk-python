...
class Comment(object):
    ...
    async def acreate(self, request: CreateCommentRequest, option: Optional[RequestOption] = None) -> CreateCommentResponse:
        if option is None:
            option = RequestOption()
    ...
    async def adelete(self, request: DeleteCommentRequest, option: Optional[RequestOption] = None) -> DeleteCommentResponse:
        if option is None:
            option = RequestOption()
    ...
    async def apatch(self, request: PatchCommentRequest, option: Optional[RequestOption] = None) -> PatchCommentResponse:
        if option is None:
            option = RequestOption()

...
class Task(object):
    ...
    def add_dependencies(self, request: AddDependenciesTaskRequest, option: Optional[RequestOption] = None) -> AddDependenciesTaskResponse:
        if option is None:
    ...
    async def aadd_dependencies(self, request: AddDependenciesTaskRequest, option: Optional[RequestOption] = None) -> AddDependenciesTaskResponse:
        if option is None:
            option = RequestOption()
    ...
    def add_members(self, request: AddMembersTaskRequest, option: Optional[RequestOption] = None) -> AddMembersTaskResponse:
        if option is None:
            option = RequestOption()
    ...
    async def aadd_members(self, request: AddMembersTaskRequest, option: Optional[RequestOption] = None) -> AddMembersTaskResponse:
        if option is None:
            option = RequestOption()
    ...
    def add_reminders(self, request: AddRemindersTaskRequest, option: Optional[RequestOption] = None) -> AddRemindersTaskResponse:
        if option is None:
            option = RequestOption()
    ...
    async def aadd_reminders(self, request: AddRemindersTaskRequest, option: Optional[RequestOption] = None) -> AddRemindersTaskResponse:
        if option is None:
            option = RequestOption()
    ...
    def add_tasklist(self, request: AddTasklistTaskRequest, option: Optional[RequestOption] = None) -> AddTasklistTaskResponse:
        if option is None:
            option = RequestOption()
    ...
    async def aadd_tasklist(self, request: AddTasklistTaskRequest, option: Optional[RequestOption] = None) -> AddTasklistTaskResponse:
        if option is None:
            option = RequestOption()
    ...
    def remove_dependencies(self, request: RemoveDependenciesTaskRequest, option: Optional[RequestOption] = None) -> RemoveDependenciesTaskResponse:
        if option is None:
            option = RequestOption()
        ...
        # 反序列化
        response: RemoveDependenciesTaskResponse = JSON.unmarshal(str(resp.content, UTF_8), RemoveDependenciesTaskResponse)
        response.raw = resp

        return response
        

    async def aremove_dependencies(self, request: RemoveDependenciesTaskRequest, option: Optional[RequestOption] = None) -> RemoveDependenciesTaskResponse:
        if option is None:
            option = RequestOption()
    ...
    def remove_members(self, request: RemoveMembersTaskRequest, option: Optional[RequestOption] = None) -> RemoveMembersTaskResponse:
        if option is None:
            option = RequestOption()
    ...
    async def aremove_members(self, request: RemoveMembersTaskRequest, option: Optional[RequestOption] = None) -> RemoveMembersTaskResponse:
        if option is None:
            option = RequestOption()
    ...
    def remove_reminders(self, request: RemoveRemindersTaskRequest, option: Optional[RequestOption] = None) -> RemoveRemindersTaskResponse:
        if option is None:
            option = RequestOption()
    ...
    async def aremove_reminders(self, request: RemoveRemindersTaskRequest, option: Optional[RequestOption] = None) -> RemoveRemindersTaskResponse:
        if option is None:
            option = RequestOption()
    ...
    def remove_tasklist(self, request: RemoveTasklistTaskRequest, option: Optional[RequestOption] = None) -> RemoveTasklistTaskResponse:
        if option is None:
            option = RequestOption()
    ...
    async def aremove_tasklist(self, request: RemoveTasklistTaskRequest, option: Optional[RequestOption] = None) -> RemoveTasklistTaskResponse:
        if option is None:
            option = RequestOption()
    ...
    async def atasklists(self, request: TasklistsTaskRequest, option: Optional[RequestOption] = None) -> TasklistsTaskResponse:
        if option is None:
            option = RequestOption()

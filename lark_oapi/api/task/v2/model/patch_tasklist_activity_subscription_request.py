...
from .patch_tasklist_activity_subscription_request_body import (
    PatchTasklistActivitySubscriptionRequestBody,
)
...
class PatchTasklistActivitySubscriptionRequestBuilder(object):
    def __init__(self) -> None:
        patch_tasklist_activity_subscription_request = (
        ...
        patch_tasklist_activity_subscription_request.token_types = {
    ...
    ) -> "PatchTasklistActivitySubscriptionRequestBuilder":
        self._patch_tasklist_activity_subscription_request.user_id_type = user_id_type
        self._patch_tasklist_activity_subscription_request.add_query(
    ...
    def tasklist_guid(
        ...
        self._patch_tasklist_activity_subscription_request.paths["tasklist_guid"] = str(
            tasklist_guid
        )
        return self
    ...
    def activity_subscription_guid(
        ...
        self._patch_tasklist_activity_subscription_request.paths[
            "activity_subscription_guid"
        ] = str(activity_subscription_guid)
        return self

    def request_body(
        self, request_body: PatchTasklistActivitySubscriptionRequestBody
    ) -> "PatchTasklistActivitySubscriptionRequestBuilder":

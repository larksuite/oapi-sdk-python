...
class AddCustomFieldRequestBuilder(object):
    def __init__(self) -> None:
        ...
        add_custom_field_request.uri = (
            "/open-apis/task/v2/custom_fields/:custom_field_guid/add"
        )
        add_custom_field_request.token_types = {
    ...
    ) -> "AddCustomFieldRequestBuilder":
        self._add_custom_field_request.custom_field_guid = custom_field_guid
        self._add_custom_field_request.paths["custom_field_guid"] = str(
            custom_field_guid
        )
        return self

    def request_body(
        self, request_body: AddCustomFieldRequestBody
    ) -> "AddCustomFieldRequestBuilder":

...
class RemoveMembersTasklistRequestBuilder(object):
    def __init__(self) -> None:
        ...
        remove_members_tasklist_request.uri = (
            "/open-apis/task/v2/tasklists/:tasklist_guid/remove_members"
        )
        remove_members_tasklist_request.token_types = {
            AccessTokenType.TENANT,
            AccessTokenType.USER,
        }
        self._remove_members_tasklist_request: RemoveMembersTasklistRequest = (
            remove_members_tasklist_request
        )
    ...
    ) -> "RemoveMembersTasklistRequestBuilder":
        self._remove_members_tasklist_request.tasklist_guid = tasklist_guid
        self._remove_members_tasklist_request.paths["tasklist_guid"] = str(
            tasklist_guid
        )
        return self

    def request_body(
        self, request_body: RemoveMembersTasklistRequestBody
    ) -> "RemoveMembersTasklistRequestBuilder":

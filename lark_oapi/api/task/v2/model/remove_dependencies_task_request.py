...
class RemoveDependenciesTaskRequestBuilder(object):
    def __init__(self) -> None:
        ...
        remove_dependencies_task_request.uri = (
            "/open-apis/task/v2/tasks/:task_guid/remove_dependencies"
        )
        remove_dependencies_task_request.token_types = {
            AccessTokenType.TENANT,
            AccessTokenType.USER,
        }
        self._remove_dependencies_task_request: RemoveDependenciesTaskRequest = (
            remove_dependencies_task_request
        )
    ...
    def request_body(
        self, request_body: RemoveDependenciesTaskRequestBody
    ) -> "RemoveDependenciesTaskRequestBuilder":

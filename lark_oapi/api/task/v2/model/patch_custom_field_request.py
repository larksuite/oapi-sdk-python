...
class PatchCustomFieldRequestBuilder(object):
    def __init__(self) -> None:
        ...
        patch_custom_field_request.uri = (
            "/open-apis/task/v2/custom_fields/:custom_field_guid"
        )
        patch_custom_field_request.token_types = {
            AccessTokenType.TENANT,
            AccessTokenType.USER,
        }
        self._patch_custom_field_request: PatchCustomFieldRequest = (
    ...
    ) -> "PatchCustomFieldRequestBuilder":
        self._patch_custom_field_request.custom_field_guid = custom_field_guid
        self._patch_custom_field_request.paths["custom_field_guid"] = str(
            custom_field_guid
        )
        return self

    def request_body(
        self, request_body: PatchCustomFieldRequestBody
    ) -> "PatchCustomFieldRequestBuilder":

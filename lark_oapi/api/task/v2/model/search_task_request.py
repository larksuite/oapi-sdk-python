...
from .search_task_request_body import SearchTaskRequestBody
...
class SearchTaskRequest(BaseRequest):
    def __init__(self) -> None:
        ...
        self.request_body: Optional[SearchTaskRequestBody] = None
...
class SearchTaskRequestBuilder(object):
    ...
    def __init__(self) -> None:
        ...
        search_task_request.uri = "/open-apis/task/v2/tasks/search"
        search_task_request.token_types = {AccessTokenType.USER}

...
class DeleteTasklistActivitySubscriptionRequestBuilder(object):
    def __init__(self) -> None:
        delete_tasklist_activity_subscription_request = (
        ...
        delete_tasklist_activity_subscription_request.token_types = {
    ...
    ) -> "DeleteTasklistActivitySubscriptionRequestBuilder":
        self._delete_tasklist_activity_subscription_request.tasklist_guid = (
            tasklist_guid
        )
        self._delete_tasklist_activity_subscription_request.paths["tasklist_guid"] = (
            str(tasklist_guid)
        )
        return self
    ...
    def activity_subscription_guid(
        ...
        self._delete_tasklist_activity_subscription_request.paths[

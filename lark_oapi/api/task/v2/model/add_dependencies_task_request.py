...
class AddDependenciesTaskRequestBuilder(object):
    def __init__(self) -> None:
        ...
        add_dependencies_task_request.uri = (
            "/open-apis/task/v2/tasks/:task_guid/add_dependencies"
        )
        add_dependencies_task_request.token_types = {
            AccessTokenType.TENANT,
            AccessTokenType.USER,
        }
        self._add_dependencies_task_request: AddDependenciesTaskRequest = (
            add_dependencies_task_request
        )
    ...
    def request_body(
        self, request_body: AddDependenciesTaskRequestBody
    ) -> "AddDependenciesTaskRequestBuilder":

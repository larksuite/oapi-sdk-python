...
class PatchTasklistActivitySubscriptionRequestBodyBuilder(object):
    def __init__(self) -> None:
        self._patch_tasklist_activity_subscription_request_body = (
    ...
    ) -> "PatchTasklistActivitySubscriptionRequestBodyBuilder":
    ...
    def update_fields(
        ...
        self._patch_tasklist_activity_subscription_request_body.update_fields = (
            update_fields
        )
        return self

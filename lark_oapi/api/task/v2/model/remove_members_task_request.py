...
from .remove_members_task_request_body import RemoveMembersTaskRequestBody
...
class RemoveMembersTaskRequest(BaseRequest):
    def __init__(self) -> None:
        ...
        self.request_body: Optional[RemoveMembersTaskRequestBody] = None

    @staticmethod
    def builder() -> "RemoveMembersTaskRequestBuilder":
        return RemoveMembersTaskRequestBuilder()
...
class RemoveMembersTaskRequestBuilder(object):
    ...
    def build(self) -> RemoveMembersTaskRequest:
        return self._remove_members_task_request

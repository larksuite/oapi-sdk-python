...
class CreateTaskCollaboratorRequestBuilder(object):
    ...
    def __init__(self, create_task_collaborator_request: CreateTaskCollaboratorRequest = CreateTaskCollaboratorRequest()) -> None:
    ...
    def user_id_type(self, user_id_type: str) -> "CreateTaskCollaboratorRequestBuilder":
        ...
        self._create_task_collaborator_request.queries["user_id_type"] = str(user_id_type)
        return self
    
    def task_id(self, task_id: str) -> "CreateTaskCollaboratorRequestBuilder":
        self._create_task_collaborator_request.task_id = task_id
        self._create_task_collaborator_request.paths["task_id"] = task_id
        return self

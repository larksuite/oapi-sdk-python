...
class ListTaskFollowerResponseBodyBuilder(object):
    def __init__(self, list_task_follower_response_body: ListTaskFollowerResponseBody = ListTaskFollowerResponseBody({})) -> None:
        self._list_task_follower_response_body: ListTaskFollowerResponseBody = list_task_follower_response_body

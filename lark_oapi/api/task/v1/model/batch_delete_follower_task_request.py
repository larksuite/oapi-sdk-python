...
class BatchDeleteFollowerTaskRequestBuilder(object):
    def __init__(self) -> None:
        ...
        batch_delete_follower_task_request.uri = (
            "/open-apis/task/v1/tasks/:task_id/batch_delete_follower"
        )
        batch_delete_follower_task_request.token_types = {
            AccessTokenType.TENANT,
            AccessTokenType.USER,
        }
        self._batch_delete_follower_task_request: BatchDeleteFollowerTaskRequest = (
            batch_delete_follower_task_request
        )

    def user_id_type(
        self, user_id_type: str
    ) -> "BatchDeleteFollowerTaskRequestBuilder":

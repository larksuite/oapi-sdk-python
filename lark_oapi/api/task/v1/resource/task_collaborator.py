...
class TaskCollaborator(object):
    ...
    def create(self, request: CreateTaskCollaboratorRequest, option: RequestOption = RequestOption()) -> CreateTaskCollaboratorResponse:
        # 鉴权、获取token
    ...
    def delete(self, request: DeleteTaskCollaboratorRequest, option: RequestOption = RequestOption()) -> DeleteTaskCollaboratorResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def list(self, request: ListTaskCollaboratorRequest, option: RequestOption = RequestOption()) -> ListTaskCollaboratorResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

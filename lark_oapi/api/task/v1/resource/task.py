...
class Task(object):
    ...
    def batch_delete_collaborator(self, request: BatchDeleteCollaboratorTaskRequest, option: RequestOption = RequestOption()) -> BatchDeleteCollaboratorTaskResponse:
        # 鉴权、获取token
    ...
    def batch_delete_follower(self, request: BatchDeleteFollowerTaskRequest, option: RequestOption = RequestOption()) -> BatchDeleteFollowerTaskResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def uncomplete(self, request: UncompleteTaskRequest, option: RequestOption = RequestOption()) -> UncompleteTaskResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

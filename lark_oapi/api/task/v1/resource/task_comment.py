...
class TaskComment(object):
    ...
    def create(self, request: CreateTaskCommentRequest, option: RequestOption = RequestOption()) -> CreateTaskCommentResponse:
        # 鉴权、获取token
    ...
    def delete(self, request: DeleteTaskCommentRequest, option: RequestOption = RequestOption()) -> DeleteTaskCommentResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def update(self, request: UpdateTaskCommentRequest, option: RequestOption = RequestOption()) -> UpdateTaskCommentResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

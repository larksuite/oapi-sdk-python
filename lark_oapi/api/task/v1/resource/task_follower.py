...
class TaskFollower(object):
    ...
    def create(self, request: CreateTaskFollowerRequest, option: Optional[RequestOption] = None) -> CreateTaskFollowerResponse:
        if option is None:
    ...
    async def acreate(self, request: CreateTaskFollowerRequest, option: Optional[RequestOption] = None) -> CreateTaskFollowerResponse:
        if option is None:
            option = RequestOption()
    ...
    def delete(self, request: DeleteTaskFollowerRequest, option: Optional[RequestOption] = None) -> DeleteTaskFollowerResponse:
        if option is None:
            option = RequestOption()
    ...
    async def adelete(self, request: DeleteTaskFollowerRequest, option: Optional[RequestOption] = None) -> DeleteTaskFollowerResponse:
        if option is None:
            option = RequestOption()
    ...
    def list(self, request: ListTaskFollowerRequest, option: Optional[RequestOption] = None) -> ListTaskFollowerResponse:
        if option is None:
            option = RequestOption()
    ...
    async def alist(self, request: ListTaskFollowerRequest, option: Optional[RequestOption] = None) -> ListTaskFollowerResponse:
        if option is None:
            option = RequestOption()

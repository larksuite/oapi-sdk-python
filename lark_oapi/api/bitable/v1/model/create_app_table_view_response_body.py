...
class CreateAppTableViewResponseBodyBuilder(object):
    def __init__(self, create_app_table_view_response_body: CreateAppTableViewResponseBody = CreateAppTableViewResponseBody({})) -> None:
        self._create_app_table_view_response_body: CreateAppTableViewResponseBody = create_app_table_view_response_body

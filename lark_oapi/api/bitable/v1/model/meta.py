...
class Meta(object):
    ...
    def __init__(self, d=None):
        ...
        self.mix_state: Optional[str] = None
        self.sec_label_id: Optional[str] = None
        self.sec_label_type: Optional[str] = None
...
class MetaBuilder(object):
    ...
    def doc_version(self, doc_version: str) -> "MetaBuilder":
    ...
    def mix_state(self, mix_state: str) -> "MetaBuilder":
    ...
    def sec_label_type(self, sec_label_type: str) -> "MetaBuilder":

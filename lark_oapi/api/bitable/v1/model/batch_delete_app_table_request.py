...
class BatchDeleteAppTableRequestBuilder(object):
    ...
    def __init__(self, batch_delete_app_table_request: BatchDeleteAppTableRequest = BatchDeleteAppTableRequest()) -> None:
    ...
    def app_token(self, app_token: str) -> "BatchDeleteAppTableRequestBuilder":
        ...
        self._batch_delete_app_table_request.paths["app_token"] = app_token
        return self

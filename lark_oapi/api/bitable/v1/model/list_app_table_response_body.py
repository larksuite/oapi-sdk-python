...
class ListAppTableResponseBodyBuilder(object):
    def __init__(self, list_app_table_response_body: ListAppTableResponseBody = ListAppTableResponseBody({})) -> None:
        self._list_app_table_response_body: ListAppTableResponseBody = list_app_table_response_body

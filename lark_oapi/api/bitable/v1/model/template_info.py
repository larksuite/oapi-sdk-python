...
class TemplateInfo(object):
    ...
    def __init__(self, d=None):
        ...
        self.publish_flag: Optional[str] = None
...
class TemplateInfoBuilder(object):
    ...
    def template_type(self, template_type: str) -> "TemplateInfoBuilder":
        self._template_info.template_type = template_type
        return self

    def publish_flag(self, publish_flag: str) -> "TemplateInfoBuilder":

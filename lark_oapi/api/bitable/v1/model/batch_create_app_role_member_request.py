...
class BatchCreateAppRoleMemberRequestBuilder(object):
    ...
    def __init__(self, batch_create_app_role_member_request: BatchCreateAppRoleMemberRequest = BatchCreateAppRoleMemberRequest()) -> None:
    ...
    def app_token(self, app_token: str) -> "BatchCreateAppRoleMemberRequestBuilder":
        ...
        self._batch_create_app_role_member_request.paths["app_token"] = app_token
        return self
    ...
    def role_id(self, role_id: str) -> "BatchCreateAppRoleMemberRequestBuilder":
        ...
        self._batch_create_app_role_member_request.paths["role_id"] = role_id
        return self

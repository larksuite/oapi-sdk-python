...
class BatchGetAppTableRecordResponseBodyBuilder(object):
    def __init__(self) -> None:
        self._batch_get_app_table_record_response_body = (
            BatchGetAppTableRecordResponseBody()
        )

    def records(
        self, records: List[AppTableRecord]
    ) -> "BatchGetAppTableRecordResponseBodyBuilder":
        self._batch_get_app_table_record_response_body.records = records
        return self

    def forbidden_record_ids(
        self, forbidden_record_ids: List[str]
    ) -> "BatchGetAppTableRecordResponseBodyBuilder":
        self._batch_get_app_table_record_response_body.forbidden_record_ids = (
            forbidden_record_ids
        )
        return self

    def absent_record_ids(
        self, absent_record_ids: List[str]
    ) -> "BatchGetAppTableRecordResponseBodyBuilder":
        self._batch_get_app_table_record_response_body.absent_record_ids = (
            absent_record_ids
        )
        return self

...
class BatchCreateAppTableRecordRequestBuilder(object):
    ...
    def __init__(self, batch_create_app_table_record_request: BatchCreateAppTableRecordRequest = BatchCreateAppTableRecordRequest()) -> None:
    ...
    def user_id_type(self, user_id_type: str) -> "BatchCreateAppTableRecordRequestBuilder":
        ...
        self._batch_create_app_table_record_request.queries["user_id_type"] = str(user_id_type)
        return self
    ...
    def client_token(self, client_token: str) -> "BatchCreateAppTableRecordRequestBuilder":
        ...
        self._batch_create_app_table_record_request.queries["client_token"] = str(client_token)
        return self
    ...
    def app_token(self, app_token: str) -> "BatchCreateAppTableRecordRequestBuilder":
        ...
        self._batch_create_app_table_record_request.paths["app_token"] = app_token
        return self
    ...
    def table_id(self, table_id: str) -> "BatchCreateAppTableRecordRequestBuilder":
        ...
        self._batch_create_app_table_record_request.paths["table_id"] = table_id
        return self

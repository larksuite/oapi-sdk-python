...
class AppTableFormField(object):
    ...
    async def alist(self, request: ListAppTableFormFieldRequest, option: Optional[RequestOption] = None) -> ListAppTableFormFieldResponse:
        if option is None:
            option = RequestOption()
    ...
    async def apatch(self, request: PatchAppTableFormFieldRequest, option: Optional[RequestOption] = None) -> PatchAppTableFormFieldResponse:
        if option is None:
            option = RequestOption()

...
class AppTable(object):
    ...
    def batch_create(self, request: BatchCreateAppTableRequest, option: Optional[RequestOption] = None) -> BatchCreateAppTableResponse:
        if option is None:
    ...
    async def abatch_create(self, request: BatchCreateAppTableRequest, option: Optional[RequestOption] = None) -> BatchCreateAppTableResponse:
        if option is None:
            option = RequestOption()
    ...
    def batch_delete(self, request: BatchDeleteAppTableRequest, option: Optional[RequestOption] = None) -> BatchDeleteAppTableResponse:
        if option is None:
            option = RequestOption()
    ...
    async def abatch_delete(self, request: BatchDeleteAppTableRequest, option: Optional[RequestOption] = None) -> BatchDeleteAppTableResponse:
        if option is None:
            option = RequestOption()
    ...
    async def acreate(self, request: CreateAppTableRequest, option: Optional[RequestOption] = None) -> CreateAppTableResponse:
        if option is None:
            option = RequestOption()
    ...
    async def adelete(self, request: DeleteAppTableRequest, option: Optional[RequestOption] = None) -> DeleteAppTableResponse:
        if option is None:
            option = RequestOption()
    ...
    async def apatch(self, request: PatchAppTableRequest, option: Optional[RequestOption] = None) -> PatchAppTableResponse:
        if option is None:
            option = RequestOption()

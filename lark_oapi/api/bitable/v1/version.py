...
class V1(object):
    def __init__(self, config: Config) -> None:
        ...
        self.app_block_workflow: AppBlockWorkflow = AppBlockWorkflow(config)
        ...
        self.app_table_field_group: AppTableFieldGroup = AppTableFieldGroup(config)
        ...
        self.app_workflow: AppWorkflow = AppWorkflow(config)

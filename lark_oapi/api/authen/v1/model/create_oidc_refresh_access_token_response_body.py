...
class CreateOidcRefreshAccessTokenResponseBodyBuilder(object):
    def __init__(self) -> None:
        self._create_oidc_refresh_access_token_response_body = (
            CreateOidcRefreshAccessTokenResponseBody()
        )

    def access_token(
        self, access_token: str
    ) -> "CreateOidcRefreshAccessTokenResponseBodyBuilder":
    ...
    def refresh_token(
        ...
        self._create_oidc_refresh_access_token_response_body.refresh_token = (
            refresh_token
        )
        return self
    ...
    def refresh_expires_in(
        ...
        self._create_oidc_refresh_access_token_response_body.refresh_expires_in = (
            refresh_expires_in
        )
        return self

...
class CreateRefreshAccessTokenResponseBody(object):
    _types = {
        "access_token": str,
        "token_type": str,
        "expires_in": int,
    ...
    def builder() -> "CreateRefreshAccessTokenResponseBodyBuilder":
        return CreateRefreshAccessTokenResponseBodyBuilder()


class CreateRefreshAccessTokenResponseBodyBuilder(object):
    def __init__(self, create_refresh_access_token_response_body: CreateRefreshAccessTokenResponseBody = CreateRefreshAccessTokenResponseBody({})) -> None:
        self._create_refresh_access_token_response_body: CreateRefreshAccessTokenResponseBody = create_refresh_access_token_response_body
    ...
    def name(self, name: str) -> "CreateRefreshAccessTokenResponseBodyBuilder":
        self._create_refresh_access_token_response_body.name = name
        return self
    ...
    def open_id(self, open_id: str) -> "CreateRefreshAccessTokenResponseBodyBuilder":
        self._create_refresh_access_token_response_body.open_id = open_id
        return self
    
    def union_id(self, union_id: str) -> "CreateRefreshAccessTokenResponseBodyBuilder":
        self._create_refresh_access_token_response_body.union_id = union_id
        return self
    ...
    def user_id(self, user_id: str) -> "CreateRefreshAccessTokenResponseBodyBuilder":
        self._create_refresh_access_token_response_body.user_id = user_id
        return self
    ...
    def sid(self, sid: str) -> "CreateRefreshAccessTokenResponseBodyBuilder":
        self._create_refresh_access_token_response_body.sid = sid
        return self
    
    def build(self) -> "CreateRefreshAccessTokenResponseBody":
        return self._create_refresh_access_token_response_body
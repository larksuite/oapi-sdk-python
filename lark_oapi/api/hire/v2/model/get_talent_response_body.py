...
class GetTalentResponseBodyBuilder(object):
    ...
    def internship_list(self, internship_list: List[CompositeTalentInternshipInfo]) -> "GetTalentResponseBodyBuilder":
        ...
        return self
    def customized_data_list(self, customized_data_list: List[CompositeTalentCustomizedData]) -> "GetTalentResponseBodyBuilder":
    ...
    def resume_attachment_id_list(self, resume_attachment_id_list: List[str]) -> "GetTalentResponseBodyBuilder":
        ...
        return self
    def resume_attachment_list(self, resume_attachment_list: List[TalentResumeAttachment]) -> "GetTalentResponseBodyBuilder":
        self._get_talent_response_body.resume_attachment_list = resume_attachment_list
        return self
    def interview_registration_list(self, interview_registration_list: List[TalentInterviewRegistrationSimple]) -> "GetTalentResponseBodyBuilder":
    ...
    def talent_pool_id_list(self, talent_pool_id_list: List[str]) -> "GetTalentResponseBodyBuilder":
        ...
        return self
    def talent_folder_ref_list_v2(self, talent_folder_ref_list_v2: List[TalentFolder]) -> "GetTalentResponseBodyBuilder":

...
class JobRequirement(object):
    ...
    def create(self, request: CreateJobRequirementRequest, option: Optional[RequestOption] = None) -> CreateJobRequirementResponse:
        if option is None:
    ...
    async def acreate(self, request: CreateJobRequirementRequest, option: Optional[RequestOption] = None) -> CreateJobRequirementResponse:
        if option is None:
            option = RequestOption()
    ...
    def delete(self, request: DeleteJobRequirementRequest, option: Optional[RequestOption] = None) -> DeleteJobRequirementResponse:
        if option is None:
            option = RequestOption()
    ...
    async def adelete(self, request: DeleteJobRequirementRequest, option: Optional[RequestOption] = None) -> DeleteJobRequirementResponse:
        if option is None:
            option = RequestOption()
    ...
    def list(self, request: ListJobRequirementRequest, option: Optional[RequestOption] = None) -> ListJobRequirementResponse:
        if option is None:
            option = RequestOption()
    ...
    async def alist(self, request: ListJobRequirementRequest, option: Optional[RequestOption] = None) -> ListJobRequirementResponse:
        if option is None:
            option = RequestOption()
    ...
    def list_by_id(self, request: ListByIdJobRequirementRequest, option: Optional[RequestOption] = None) -> ListByIdJobRequirementResponse:
        if option is None:
            option = RequestOption()
    ...
    async def alist_by_id(self, request: ListByIdJobRequirementRequest, option: Optional[RequestOption] = None) -> ListByIdJobRequirementResponse:
        if option is None:
            option = RequestOption()
    ...
    def update(self, request: UpdateJobRequirementRequest, option: Optional[RequestOption] = None) -> UpdateJobRequirementResponse:
        if option is None:
            option = RequestOption()
    ...
    async def aupdate(self, request: UpdateJobRequirementRequest, option: Optional[RequestOption] = None) -> UpdateJobRequirementResponse:
        if option is None:
            option = RequestOption()

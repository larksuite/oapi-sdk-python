...
class ExamMarkingTask(object):
    ...
    def list(self, request: ListExamMarkingTaskRequest, option: Optional[RequestOption] = None) -> ListExamMarkingTaskResponse:
        if option is None:
    ...
    async def alist(self, request: ListExamMarkingTaskRequest, option: Optional[RequestOption] = None) -> ListExamMarkingTaskResponse:
        if option is None:
            option = RequestOption()

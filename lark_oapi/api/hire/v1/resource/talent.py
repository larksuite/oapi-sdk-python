...
class Talent(object):
    ...
    def add_to_folder(self, request: AddToFolderTalentRequest, option: RequestOption = RequestOption()) -> AddToFolderTalentResponse:
        # 鉴权、获取token
    ...
    def batch_get_id(self, request: BatchGetIdTalentRequest, option: RequestOption = RequestOption()) -> BatchGetIdTalentResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

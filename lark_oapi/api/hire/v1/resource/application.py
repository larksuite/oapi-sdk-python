...
class Application(object):
    ...
    def create(self, request: CreateApplicationRequest, option: RequestOption = RequestOption()) -> CreateApplicationResponse:
        # 鉴权、获取token
    ...
    def offer(self, request: OfferApplicationRequest, option: RequestOption = RequestOption()) -> OfferApplicationResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def terminate(self, request: TerminateApplicationRequest, option: RequestOption = RequestOption()) -> TerminateApplicationResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def transfer_onboard(self, request: TransferOnboardApplicationRequest, option: RequestOption = RequestOption()) -> TransferOnboardApplicationResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

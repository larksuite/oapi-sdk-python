...
class SiteResumeInternshipBuilder(object):
    def __init__(self, site_resume_internship: SiteResumeInternship = SiteResumeInternship({})) -> None:
        self._site_resume_internship: SiteResumeInternship = site_resume_internship

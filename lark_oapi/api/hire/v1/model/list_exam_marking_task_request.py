...
class ListExamMarkingTaskRequestBuilder(object):
    def __init__(self) -> None:
        ...
        self._list_exam_marking_task_request: ListExamMarkingTaskRequest = (
            list_exam_marking_task_request
        )
    ...
    ) -> "ListExamMarkingTaskRequestBuilder":
        self._list_exam_marking_task_request.activity_status = activity_status
        self._list_exam_marking_task_request.add_query(

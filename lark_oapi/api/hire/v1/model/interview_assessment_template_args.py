...
class InterviewAssessmentTemplateArgsBuilder(object):
    ...
    def conclusion_dimension(
        self, conclusion_dimension: InterviewAssessmentDimension
    ) -> "InterviewAssessmentTemplateArgsBuilder":
        self._interview_assessment_template_args.conclusion_dimension = (
            conclusion_dimension
        )
        return self

    def score_dimension(
        self, score_dimension: InterviewAssessmentDimension
    ) -> "InterviewAssessmentTemplateArgsBuilder":
        self._interview_assessment_template_args.score_dimension = score_dimension
        return self

    def content_dimension(
        self, content_dimension: InterviewAssessmentDimension
    ) -> "InterviewAssessmentTemplateArgsBuilder":
        self._interview_assessment_template_args.content_dimension = content_dimension
        return self

    def custom_dimension_list(
        self, custom_dimension_list: List[InterviewAssessmentDimension]
    ) -> "InterviewAssessmentTemplateArgsBuilder":
        self._interview_assessment_template_args.custom_dimension_list = (
            custom_dimension_list
        )
        return self

...
class AddToFolderTalentRequestBodyBuilder(object):
    def __init__(self, add_to_folder_talent_request_body: AddToFolderTalentRequestBody = AddToFolderTalentRequestBody({})) -> None:
        self._add_to_folder_talent_request_body: AddToFolderTalentRequestBody = add_to_folder_talent_request_body

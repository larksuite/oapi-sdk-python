...
class PermissionCollectionBuilder(object):
    ...
    def feature_permissions(
        self, feature_permissions: List[IdNameObject]
    ) -> "PermissionCollectionBuilder":
        self._permission_collection.feature_permissions = feature_permissions
        return self

    def management_permissions(
        self, management_permissions: List[IdNameObject]
    ) -> "PermissionCollectionBuilder":
        self._permission_collection.management_permissions = management_permissions
        return self

    def data_permissions(
        self, data_permissions: List[DataPermission]
    ) -> "PermissionCollectionBuilder":
        self._permission_collection.data_permissions = data_permissions
        return self

    def business_management_scopes(
        self, business_management_scopes: List[BusinessManagementScope]
    ) -> "PermissionCollectionBuilder":
        self._permission_collection.business_management_scopes = (

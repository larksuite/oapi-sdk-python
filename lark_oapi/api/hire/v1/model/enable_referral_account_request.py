...
class EnableReferralAccountRequestBuilder(object):
    def __init__(self) -> None:
        ...
        enable_referral_account_request.uri = (
            "/open-apis/hire/v1/referral_account/enable"
        )
        enable_referral_account_request.token_types = {AccessTokenType.TENANT}
        self._enable_referral_account_request: EnableReferralAccountRequest = (
            enable_referral_account_request
        )
    ...
    def request_body(
        self, request_body: EnableReferralAccountRequestBody
    ) -> "EnableReferralAccountRequestBuilder":

...
class DeactivateReferralAccountRequestBuilder(object):
    def __init__(self) -> None:
        ...
        deactivate_referral_account_request.uri = (
        ...
        self._deactivate_referral_account_request: DeactivateReferralAccountRequest = (
            deactivate_referral_account_request
        )

    def user_id_type(
        self, user_id_type: str
    ) -> "DeactivateReferralAccountRequestBuilder":
        self._deactivate_referral_account_request.user_id_type = user_id_type
        self._deactivate_referral_account_request.add_query(
    ...
    def referral_account_id(
        ...
        self._deactivate_referral_account_request.referral_account_id = (
            referral_account_id
        )
        self._deactivate_referral_account_request.paths["referral_account_id"] = str(
            referral_account_id
        )
        return self

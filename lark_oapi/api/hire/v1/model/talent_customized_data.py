...
class TalentCustomizedDataBuilder(object):
    def __init__(self, talent_customized_data: TalentCustomizedData = TalentCustomizedData({})) -> None:
        self._talent_customized_data: TalentCustomizedData = talent_customized_data

...
class P2HireEcoBackgroundCheckCreatedV1Data(object):
    ...
    def __init__(self, d=None):
        ...
        self.client_contact_info: Optional[EcoBackgroundCheckCreateEventContactInfo] = (
            None
        )
        self.custom_field_list: Optional[
            List[EcoBackgroundCheckCreateEventCustomKv]
        ] = None
        init(self, d, self._types)


class P2HireEcoBackgroundCheckCreatedV1(EventContext):
    _types = {"event": P2HireEcoBackgroundCheckCreatedV1Data}

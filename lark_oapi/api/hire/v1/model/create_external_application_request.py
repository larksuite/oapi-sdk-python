...
class CreateExternalApplicationRequestBuilder(object):
    def __init__(self) -> None:
        ...
        create_external_application_request.uri = (
            "/open-apis/hire/v1/external_applications"
        )
        create_external_application_request.token_types = {AccessTokenType.TENANT}
        self._create_external_application_request: CreateExternalApplicationRequest = (
            create_external_application_request
        )

    def request_body(
        self, request_body: ExternalApplication
    ) -> "CreateExternalApplicationRequestBuilder":

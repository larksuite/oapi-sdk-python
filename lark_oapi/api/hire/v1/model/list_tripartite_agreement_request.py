...
class ListTripartiteAgreementRequestBuilder(object):
    def __init__(self) -> None:
        ...
        list_tripartite_agreement_request.uri = (
            "/open-apis/hire/v1/tripartite_agreements"
        )
        list_tripartite_agreement_request.token_types = {AccessTokenType.TENANT}
        self._list_tripartite_agreement_request: ListTripartiteAgreementRequest = (
            list_tripartite_agreement_request
        )
    ...
    ) -> "ListTripartiteAgreementRequestBuilder":
        self._list_tripartite_agreement_request.application_id = application_id
        self._list_tripartite_agreement_request.add_query(
    ...
    def tripartite_agreement_id(
        ...
        self._list_tripartite_agreement_request.tripartite_agreement_id = (
            tripartite_agreement_id
        )
        self._list_tripartite_agreement_request.add_query(
            "tripartite_agreement_id", tripartite_agreement_id
        )
        return self

...
class BatchQueryExternalBackgroundCheckRequest(BaseRequest):
    def __init__(self) -> None:
        ...
        self.request_body: Optional[BatchQueryExternalBackgroundCheckRequestBody] = None

    @staticmethod
    def builder() -> "BatchQueryExternalBackgroundCheckRequestBuilder":
        return BatchQueryExternalBackgroundCheckRequestBuilder()
...
class BatchQueryExternalBackgroundCheckRequestBuilder(object):
    ...
    def external_application_id(self, external_application_id: str) -> "BatchQueryExternalBackgroundCheckRequestBuilder":
        ...
        self._batch_query_external_background_check_request.add_query("external_application_id", external_application_id)
        return self
    ...
    def build(self) -> BatchQueryExternalBackgroundCheckRequest:
        return self._batch_query_external_background_check_request

...
from .batch_change_talent_pool_talent_pool_request_body import (
    BatchChangeTalentPoolTalentPoolRequestBody,
)
...
class BatchChangeTalentPoolTalentPoolRequestBuilder(object):
    ...
    ) -> "BatchChangeTalentPoolTalentPoolRequestBuilder":
        self._batch_change_talent_pool_talent_pool_request.talent_pool_id = (
            talent_pool_id
        )
        self._batch_change_talent_pool_talent_pool_request.paths["talent_pool_id"] = (
            str(talent_pool_id)
        )
        return self

    def request_body(
        self, request_body: BatchChangeTalentPoolTalentPoolRequestBody
    ) -> "BatchChangeTalentPoolTalentPoolRequestBuilder":

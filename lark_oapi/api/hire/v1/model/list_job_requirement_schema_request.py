...
class ListJobRequirementSchemaRequestBuilder(object):
    ...
    def __init__(self, list_job_requirement_schema_request: ListJobRequirementSchemaRequest = ListJobRequirementSchemaRequest()) -> None:
    ...
    def page_token(self, page_token: str) -> "ListJobRequirementSchemaRequestBuilder":
        ...
        self._list_job_requirement_schema_request.queries["page_token"] = str(page_token)
        return self
    ...
    def page_size(self, page_size: int) -> "ListJobRequirementSchemaRequestBuilder":
        ...
        self._list_job_requirement_schema_request.queries["page_size"] = str(page_size)
        return self

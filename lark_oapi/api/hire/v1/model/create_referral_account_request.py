...
class CreateReferralAccountRequestBuilder(object):
    def __init__(self) -> None:
        ...
        self._create_referral_account_request: CreateReferralAccountRequest = (
            create_referral_account_request
        )
    ...
    def request_body(
        self, request_body: CreateReferralAccountRequestBody
    ) -> "CreateReferralAccountRequestBuilder":

...
class CreateByResumeWebsiteDeliveryRequestBuilder(object):
    ...
    ) -> "CreateByResumeWebsiteDeliveryRequestBuilder":
        self._create_by_resume_website_delivery_request.user_id_type = user_id_type
        self._create_by_resume_website_delivery_request.add_query(
    ...
    def website_id(
        ...
        self._create_by_resume_website_delivery_request.paths["website_id"] = str(
            website_id
        )
        return self

    def request_body(
        self, request_body: WebsiteDelivery
    ) -> "CreateByResumeWebsiteDeliveryRequestBuilder":

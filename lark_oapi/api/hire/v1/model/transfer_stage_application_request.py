...
class TransferStageApplicationRequestBuilder(object):
    def __init__(self) -> None:
        ...
        transfer_stage_application_request.uri = (
        ...
        self._transfer_stage_application_request: TransferStageApplicationRequest = (
            transfer_stage_application_request
        )

    def application_id(
        self, application_id: str
    ) -> "TransferStageApplicationRequestBuilder":
        self._transfer_stage_application_request.application_id = application_id
        self._transfer_stage_application_request.paths["application_id"] = str(
            application_id
        )
        return self

    def request_body(
        self, request_body: TransferStageApplicationRequestBody
    ) -> "TransferStageApplicationRequestBuilder":

...
class CombinedUpdateJobRequestBuilder(object):
    ...
    ) -> "CombinedUpdateJobRequestBuilder":
        self._combined_update_job_request.department_id_type = department_id_type
        self._combined_update_job_request.add_query(

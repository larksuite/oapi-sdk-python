...
class UpdateExternalApplicationRequestBuilder(object):
    def __init__(self) -> None:
        ...
        update_external_application_request.uri = (
        ...
        self._update_external_application_request: UpdateExternalApplicationRequest = (
            update_external_application_request
        )

    def external_application_id(
        self, external_application_id: str
    ) -> "UpdateExternalApplicationRequestBuilder":
        self._update_external_application_request.external_application_id = (
            external_application_id
        )
        self._update_external_application_request.paths["external_application_id"] = (
            str(external_application_id)
        )
        return self

    def request_body(
        self, request_body: ExternalApplication
    ) -> "UpdateExternalApplicationRequestBuilder":

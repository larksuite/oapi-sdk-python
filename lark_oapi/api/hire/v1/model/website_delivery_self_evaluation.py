...
class WebsiteDeliverySelfEvaluationBuilder(object):
    def __init__(self, website_delivery_self_evaluation: WebsiteDeliverySelfEvaluation = WebsiteDeliverySelfEvaluation({})) -> None:
        self._website_delivery_self_evaluation: WebsiteDeliverySelfEvaluation = website_delivery_self_evaluation

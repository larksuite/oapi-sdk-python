...
class GetInterviewRecordAttachmentRequestBuilder(object):
    def __init__(self) -> None:
        ...
        get_interview_record_attachment_request.uri = (
    ...
    ) -> "GetInterviewRecordAttachmentRequestBuilder":
        self._get_interview_record_attachment_request.application_id = application_id
        self._get_interview_record_attachment_request.add_query(
    ...
    def interview_record_id(
        ...
        self._get_interview_record_attachment_request.interview_record_id = (
            interview_record_id
        )
        self._get_interview_record_attachment_request.add_query(

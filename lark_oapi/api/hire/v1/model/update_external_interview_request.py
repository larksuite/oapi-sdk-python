...
class UpdateExternalInterviewRequestBuilder(object):
    def __init__(self) -> None:
        ...
        update_external_interview_request.uri = (
        ...
        self._update_external_interview_request: UpdateExternalInterviewRequest = (
            update_external_interview_request
        )

    def external_interview_id(
        self, external_interview_id: str
    ) -> "UpdateExternalInterviewRequestBuilder":
        self._update_external_interview_request.external_interview_id = (
            external_interview_id
        )
        self._update_external_interview_request.paths["external_interview_id"] = str(
            external_interview_id
        )
        return self

    def request_body(
        self, request_body: ExternalInterview
    ) -> "UpdateExternalInterviewRequestBuilder":

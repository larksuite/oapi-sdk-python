...
class OfferApplicationRequestBuilder(object):
    ...
    ) -> "OfferApplicationRequestBuilder":
        self._offer_application_request.department_id_type = department_id_type
        self._offer_application_request.add_query(

...
class GetWebsiteDeliveryTaskRequestBuilder(object):
    def __init__(self) -> None:
        ...
        get_website_delivery_task_request.uri = (
        ...
        self._get_website_delivery_task_request: GetWebsiteDeliveryTaskRequest = (
            get_website_delivery_task_request
        )
    ...
    def delivery_task_id(
        self, delivery_task_id: str
    ) -> "GetWebsiteDeliveryTaskRequestBuilder":
        self._get_website_delivery_task_request.delivery_task_id = delivery_task_id
        self._get_website_delivery_task_request.paths["delivery_task_id"] = str(
            delivery_task_id
        )
        return self

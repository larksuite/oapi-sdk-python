...
class SearchJobPublishRecordRequestBuilder(object):
    def __init__(self) -> None:
        ...
        search_job_publish_record_request.uri = (
            "/open-apis/hire/v1/job_publish_records/search"
        )
        search_job_publish_record_request.token_types = {AccessTokenType.TENANT}
        self._search_job_publish_record_request: SearchJobPublishRecordRequest = (
            search_job_publish_record_request
        )
    ...
    ) -> "SearchJobPublishRecordRequestBuilder":
        self._search_job_publish_record_request.department_id_type = department_id_type
        self._search_job_publish_record_request.add_query(
    ...
    def request_body(
        self, request_body: SearchJobPublishRecordRequestBody
    ) -> "SearchJobPublishRecordRequestBuilder":

...
class ListJobRequirementRequestBuilder(object):
    def __init__(self) -> None:
        ...
        self._list_job_requirement_request: ListJobRequirementRequest = (
            list_job_requirement_request
        )
    ...
    def create_time_begin(
        self, create_time_begin: str
    ) -> "ListJobRequirementRequestBuilder":
        self._list_job_requirement_request.create_time_begin = create_time_begin
        self._list_job_requirement_request.add_query(
            "create_time_begin", create_time_begin
        )
        return self

    def create_time_end(
        self, create_time_end: str
    ) -> "ListJobRequirementRequestBuilder":
    ...
    def update_time_begin(
        self, update_time_begin: str
    ) -> "ListJobRequirementRequestBuilder":

...
class TransferOnboardApplicationRequestBuilder(object):
    def __init__(self) -> None:
        ...
        transfer_onboard_application_request.uri = (
    ...
    ) -> "TransferOnboardApplicationRequestBuilder":
        self._transfer_onboard_application_request.user_id_type = user_id_type
        self._transfer_onboard_application_request.add_query(
    ...
    def department_id_type(
        ...
        self._transfer_onboard_application_request.department_id_type = (
            department_id_type
        )
        self._transfer_onboard_application_request.add_query(
    ...
    def job_family_id_type(
        ...
        self._transfer_onboard_application_request.job_family_id_type = (
            job_family_id_type
        )
        self._transfer_onboard_application_request.add_query(
    ...
    def employee_type_id_type(
        ...
        self._transfer_onboard_application_request.employee_type_id_type = (
    ...
    def application_id(
        ...
        self._transfer_onboard_application_request.paths["application_id"] = str(
            application_id
        )
        return self

    def request_body(
        self, request_body: TransferOnboardApplicationRequestBody
    ) -> "TransferOnboardApplicationRequestBuilder":

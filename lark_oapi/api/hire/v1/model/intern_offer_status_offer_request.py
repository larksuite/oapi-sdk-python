...
class InternOfferStatusOfferRequestBuilder(object):
    def __init__(self) -> None:
        ...
        intern_offer_status_offer_request.uri = (
        ...
        self._intern_offer_status_offer_request: InternOfferStatusOfferRequest = (
            intern_offer_status_offer_request
        )
    ...
    def request_body(
        self, request_body: InternOfferStatus
    ) -> "InternOfferStatusOfferRequestBuilder":

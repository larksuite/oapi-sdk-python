...
from .job_requirement_schema import JobRequirementSchema


class ListJobRequirementSchemaResponseBody(object):
    _types = {
        "items": List[JobRequirementSchema],
        "has_more": bool,
        "page_token": str,
    }

    def __init__(self, d):
        self.items: Optional[List[JobRequirementSchema]] = None
    ...
    def builder() -> "ListJobRequirementSchemaResponseBodyBuilder":
        return ListJobRequirementSchemaResponseBodyBuilder()


class ListJobRequirementSchemaResponseBodyBuilder(object):
    def __init__(self, list_job_requirement_schema_response_body: ListJobRequirementSchemaResponseBody = ListJobRequirementSchemaResponseBody({})) -> None:
        self._list_job_requirement_schema_response_body: ListJobRequirementSchemaResponseBody = list_job_requirement_schema_response_body

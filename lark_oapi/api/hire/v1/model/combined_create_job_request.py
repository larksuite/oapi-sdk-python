...
class CombinedCreateJobRequestBuilder(object):
    def __init__(self) -> None:
        ...
        self._combined_create_job_request: CombinedCreateJobRequest = (
            combined_create_job_request
        )
    ...
    ) -> "CombinedCreateJobRequestBuilder":
        self._combined_create_job_request.department_id_type = department_id_type
        self._combined_create_job_request.add_query(

...
class GetDetailJobRequest(BaseRequest):
    ...
    def builder() -> "GetDetailJobRequestBuilder":
        return GetDetailJobRequestBuilder()
...
class GetDetailJobRequestBuilder(object):
    ...
    def user_id_type(self, user_id_type: str) -> "GetDetailJobRequestBuilder":
        self._get_detail_job_request.user_id_type = user_id_type
    ...
    def job_level_id_type(self, job_level_id_type: str) -> "GetDetailJobRequestBuilder":
        self._get_detail_job_request.job_level_id_type = job_level_id_type
    ...
    def job_id(self, job_id: str) -> "GetDetailJobRequestBuilder":
        self._get_detail_job_request.job_id = job_id
        self._get_detail_job_request.paths["job_id"] = str(job_id)
        return self

    def build(self) -> GetDetailJobRequest:
        return self._get_detail_job_request

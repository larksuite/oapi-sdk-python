...
class WithdrawReferralAccountRequestBuilder(object):
    def __init__(self) -> None:
        ...
        withdraw_referral_account_request.uri = (
        ...
        self._withdraw_referral_account_request: WithdrawReferralAccountRequest = (
            withdraw_referral_account_request
        )

    def referral_account_id(
        self, referral_account_id: str
    ) -> "WithdrawReferralAccountRequestBuilder":
        self._withdraw_referral_account_request.referral_account_id = (
            referral_account_id
        )
        self._withdraw_referral_account_request.paths["referral_account_id"] = str(
            referral_account_id
        )
        return self

    def request_body(
        self, request_body: WithdrawReferralAccountRequestBody
    ) -> "WithdrawReferralAccountRequestBuilder":

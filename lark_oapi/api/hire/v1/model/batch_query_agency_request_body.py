...
class BatchQueryAgencyRequestBodyBuilder(object):
    ...
    def agency_supplier_id_list(
        self, agency_supplier_id_list: List[str]
    ) -> "BatchQueryAgencyRequestBodyBuilder":
        self._batch_query_agency_request_body.agency_supplier_id_list = (
    ...
    def filter_list(
        self, filter_list: List[CommonFilter]
    ) -> "BatchQueryAgencyRequestBodyBuilder":

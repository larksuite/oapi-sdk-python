...
class BatchUpdateEcoBackgroundCheckCustomFieldRequestBuilder(object):
    def __init__(self) -> None:
        batch_update_eco_background_check_custom_field_request = (
            BatchUpdateEcoBackgroundCheckCustomFieldRequest()
        )
        batch_update_eco_background_check_custom_field_request.http_method = (
            HttpMethod.PATCH
        )
        batch_update_eco_background_check_custom_field_request.uri = (
            "/open-apis/hire/v1/eco_background_check_custom_fields/batch_update"
        )
        batch_update_eco_background_check_custom_field_request.token_types = {
    ...
    ) -> "BatchUpdateEcoBackgroundCheckCustomFieldRequestBuilder":
        self._batch_update_eco_background_check_custom_field_request.request_body = (
            request_body
        )

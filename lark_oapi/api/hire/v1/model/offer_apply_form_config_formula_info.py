...
class OfferApplyFormConfigFormulaInfoBuilder(object):
    def __init__(self, offer_apply_form_config_formula_info: OfferApplyFormConfigFormulaInfo = OfferApplyFormConfigFormulaInfo({})) -> None:
        self._offer_apply_form_config_formula_info: OfferApplyFormConfigFormulaInfo = offer_apply_form_config_formula_info

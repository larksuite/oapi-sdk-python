...
class BatchUpdateEcoExamPaperRequestBuilder(object):
    def __init__(self) -> None:
        ...
        batch_update_eco_exam_paper_request.uri = (
            "/open-apis/hire/v1/eco_exam_papers/batch_update"
        )
        batch_update_eco_exam_paper_request.token_types = {AccessTokenType.TENANT}
        self._batch_update_eco_exam_paper_request: BatchUpdateEcoExamPaperRequest = (
            batch_update_eco_exam_paper_request
        )

    def request_body(
        self, request_body: EcoExamPaper
    ) -> "BatchUpdateEcoExamPaperRequestBuilder":

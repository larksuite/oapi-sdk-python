...
class InternOfferStatusOfferResponseBodyBuilder(object):
    def __init__(self, intern_offer_status_offer_response_body: InternOfferStatusOfferResponseBody = InternOfferStatusOfferResponseBody({})) -> None:
    ...
    def onboarding_info(self, onboarding_info: InternOfferOnboardingInfo) -> "InternOfferStatusOfferResponseBodyBuilder":
        self._intern_offer_status_offer_response_body.onboarding_info = onboarding_info
        return self
    
    def offboarding_info(self, offboarding_info: InternOfferOffboardingInfo) -> "InternOfferStatusOfferResponseBodyBuilder":

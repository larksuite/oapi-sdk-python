...
class GetByApplicationEmployeeRequestBuilder(object):
    def __init__(self) -> None:
        ...
        get_by_application_employee_request.uri = (
            "/open-apis/hire/v1/employees/get_by_application"
        )
        get_by_application_employee_request.token_types = {AccessTokenType.TENANT}
        self._get_by_application_employee_request: GetByApplicationEmployeeRequest = (
            get_by_application_employee_request
        )

    def application_id(
        self, application_id: str
    ) -> "GetByApplicationEmployeeRequestBuilder":
        self._get_by_application_employee_request.application_id = application_id
        self._get_by_application_employee_request.add_query(
    ...
    def department_id_type(
        ...
        self._get_by_application_employee_request.department_id_type = (
            department_id_type
        )
        self._get_by_application_employee_request.add_query(
    ...
    def job_family_id_type(
        ...
        self._get_by_application_employee_request.job_family_id_type = (
            job_family_id_type
        )
        self._get_by_application_employee_request.add_query(
    ...
    def employee_type_id_type(
        ...
        self._get_by_application_employee_request.employee_type_id_type = (

...
class UpdateResultEcoBackgroundCheckRequestBodyBuilder(object):
    def __init__(self) -> None:
        self._update_result_eco_background_check_request_body = (
            UpdateResultEcoBackgroundCheckRequestBody()
        )

    def background_check_id(
        self, background_check_id: str
    ) -> "UpdateResultEcoBackgroundCheckRequestBodyBuilder":
        self._update_result_eco_background_check_request_body.background_check_id = (
            background_check_id
        )
        return self
    ...
    def operator_role(
        ...
        self._update_result_eco_background_check_request_body.operator_role = (
            operator_role
        )
        return self
    ...
    def report_file_list(
        ...
        self._update_result_eco_background_check_request_body.report_file_list = (
            report_file_list
        )
        return self

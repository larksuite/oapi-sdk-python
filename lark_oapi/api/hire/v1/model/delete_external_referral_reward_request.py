...
class DeleteExternalReferralRewardRequestBuilder(object):
    def __init__(self) -> None:
        ...
        delete_external_referral_reward_request.uri = (
    ...
    def external_referral_reward_id(
        self, external_referral_reward_id: str
    ) -> "DeleteExternalReferralRewardRequestBuilder":
        self._delete_external_referral_reward_request.external_referral_reward_id = (
            external_referral_reward_id
        )
        self._delete_external_referral_reward_request.paths[
            "external_referral_reward_id"
        ] = str(external_referral_reward_id)
        return self

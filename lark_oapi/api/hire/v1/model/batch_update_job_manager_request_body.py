...
class BatchUpdateJobManagerRequestBodyBuilder(object):
    ...
    ) -> "BatchUpdateJobManagerRequestBodyBuilder":
    ...
    def assistant_id_list(
        ...
        self._batch_update_job_manager_request_body.assistant_id_list = (
            assistant_id_list
        )
        return self
    ...
    def hiring_manager_id_list(
        ...
        self._batch_update_job_manager_request_body.hiring_manager_id_list = (
            hiring_manager_id_list
        )
        return self

    def update_option_list(
        self, update_option_list: List[int]
    ) -> "BatchUpdateJobManagerRequestBodyBuilder":
        self._batch_update_job_manager_request_body.update_option_list = (
            update_option_list
        )
        return self

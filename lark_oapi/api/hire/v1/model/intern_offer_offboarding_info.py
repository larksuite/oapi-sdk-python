...
class InternOfferOffboardingInfoBuilder(object):
    ...
    def actual_offboarding_date(
        self, actual_offboarding_date: str
    ) -> "InternOfferOffboardingInfoBuilder":
        self._intern_offer_offboarding_info.actual_offboarding_date = (

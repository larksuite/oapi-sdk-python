...
class CombinedUpdateJobResponseBodyBuilder(object):
    ...
    ) -> "CombinedUpdateJobResponseBodyBuilder":
    ...
    def interview_registration_schema_info(
        ...
        self._combined_update_job_response_body.interview_registration_schema_info = (
    ...
    def onboard_registration_schema_info(
        ...
        self._combined_update_job_response_body.onboard_registration_schema_info = (
    ...
    def portal_website_apply_form_schema_info(
        ...
        self._combined_update_job_response_body.portal_website_apply_form_schema_info = portal_website_apply_form_schema_info
        return self

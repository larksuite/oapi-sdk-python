...
class OfferStatusOfferRequestBodyBuilder(object):
    ...
    ) -> "OfferStatusOfferRequestBodyBuilder":
    ...
    def termination_reason_id_list(
        ...
        self._offer_status_offer_request_body.termination_reason_id_list = (
    ...
    def termination_reason_note(
        ...
        self._offer_status_offer_request_body.termination_reason_note = (
    ...
    def cancel_offer_termination_type(
        ...
        self._offer_status_offer_request_body.cancel_offer_termination_type = (

...
class UpdateResultEcoExamRequestBuilder(object):
    def __init__(self) -> None:
        ...
        update_result_eco_exam_request.uri = (
            "/open-apis/hire/v1/eco_exams/:exam_id/update_result"
        )
        update_result_eco_exam_request.token_types = {AccessTokenType.TENANT}
        self._update_result_eco_exam_request: UpdateResultEcoExamRequest = (
            update_result_eco_exam_request
        )
    ...
    def request_body(
        self, request_body: UpdateResultEcoExamRequestBody
    ) -> "UpdateResultEcoExamRequestBuilder":

...
class EcoBackgroundCheckCreateEventCandidateInfoBuilder(object):
    def __init__(self, eco_background_check_create_event_candidate_info: EcoBackgroundCheckCreateEventCandidateInfo = EcoBackgroundCheckCreateEventCandidateInfo({})) -> None:

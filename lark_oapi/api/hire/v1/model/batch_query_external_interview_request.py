...
class BatchQueryExternalInterviewRequest(BaseRequest):
    def __init__(self) -> None:
        ...
        self.request_body: Optional[BatchQueryExternalInterviewRequestBody] = None

    @staticmethod
    def builder() -> "BatchQueryExternalInterviewRequestBuilder":
        return BatchQueryExternalInterviewRequestBuilder()
...
class BatchQueryExternalInterviewRequestBuilder(object):
    ...
    def page_size(self, page_size: int) -> "BatchQueryExternalInterviewRequestBuilder":
        self._batch_query_external_interview_request.page_size = page_size
    ...
    def build(self) -> BatchQueryExternalInterviewRequest:
        return self._batch_query_external_interview_request

...
class OfferApplyFormObjectDisplayConfigInfoBuilder(object):
    def __init__(self, offer_apply_form_object_display_config_info: OfferApplyFormObjectDisplayConfigInfo = OfferApplyFormObjectDisplayConfigInfo({})) -> None:
        self._offer_apply_form_object_display_config_info: OfferApplyFormObjectDisplayConfigInfo = offer_apply_form_object_display_config_info

...
class EcoBackgroundCheckCustomFieldBuilder(object):
    def __init__(self, eco_background_check_custom_field: EcoBackgroundCheckCustomField = EcoBackgroundCheckCustomField({})) -> None:
        self._eco_background_check_custom_field: EcoBackgroundCheckCustomField = eco_background_check_custom_field

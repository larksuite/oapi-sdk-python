...
class ApplicationPrehireOfferBuilder(object):
    ...
    def basic_info(
        self, basic_info: ApplicationPrehireOfferBasic
    ) -> "ApplicationPrehireOfferBuilder":
        self._application_prehire_offer.basic_info = basic_info
        return self

    def offer_onboard_profile(
        self, offer_onboard_profile: AppliOfferOnboardProfile
    ) -> "ApplicationPrehireOfferBuilder":
        self._application_prehire_offer.offer_onboard_profile = offer_onboard_profile
        return self

    def attachment_list(
        self, attachment_list: List[ApplicationOfferAttachment]
    ) -> "ApplicationPrehireOfferBuilder":

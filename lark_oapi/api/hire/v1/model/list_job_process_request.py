...
class ListJobProcessRequestBuilder(object):
    ...
    def __init__(self, list_job_process_request: ListJobProcessRequest = ListJobProcessRequest()) -> None:
    ...
    def page_size(self, page_size: int) -> "ListJobProcessRequestBuilder":
        ...
        self._list_job_process_request.queries["page_size"] = str(page_size)
        return self

    def page_token(self, page_token: str) -> "ListJobProcessRequestBuilder":
        self._list_job_process_request.page_token = page_token
        self._list_job_process_request.queries["page_token"] = str(page_token)
        return self

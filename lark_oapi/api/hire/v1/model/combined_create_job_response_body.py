...
class CombinedCreateJobResponseBodyBuilder(object):
    def __init__(self, combined_create_job_response_body: CombinedCreateJobResponseBody = CombinedCreateJobResponseBody({})) -> None:
    ...
    def interview_registration_schema_info(self, interview_registration_schema_info: RegistrationInfo) -> "CombinedCreateJobResponseBodyBuilder":

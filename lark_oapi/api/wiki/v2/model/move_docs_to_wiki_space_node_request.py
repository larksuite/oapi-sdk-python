...
class MoveDocsToWikiSpaceNodeRequestBuilder(object):
    def __init__(self) -> None:
        ...
        move_docs_to_wiki_space_node_request.uri = (
            "/open-apis/wiki/v2/spaces/:space_id/nodes/move_docs_to_wiki"
        )
        move_docs_to_wiki_space_node_request.token_types = {
            AccessTokenType.TENANT,
            AccessTokenType.USER,
        }
        self._move_docs_to_wiki_space_node_request: MoveDocsToWikiSpaceNodeRequest = (
            move_docs_to_wiki_space_node_request
        )
    ...
    def request_body(
        self, request_body: MoveDocsToWikiSpaceNodeRequestBody
    ) -> "MoveDocsToWikiSpaceNodeRequestBuilder":

...
class SpaceNode(object):
    ...
    def create(self, request: CreateSpaceNodeRequest, option: RequestOption = RequestOption()) -> CreateSpaceNodeResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def move_docs_to_wiki(self, request: MoveDocsToWikiSpaceNodeRequest, option: RequestOption = RequestOption()) -> MoveDocsToWikiSpaceNodeResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def update_title(self, request: UpdateTitleSpaceNodeRequest, option: RequestOption = RequestOption()) -> UpdateTitleSpaceNodeResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

...
class Approval(object):
    ...
    def subscribe(self, request: SubscribeApprovalRequest, option: RequestOption = RequestOption()) -> SubscribeApprovalResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def unsubscribe(self, request: UnsubscribeApprovalRequest, option: RequestOption = RequestOption()) -> UnsubscribeApprovalResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

...
class Instance(object):
    ...
    def add_sign(self, request: AddSignInstanceRequest, option: RequestOption = RequestOption()) -> AddSignInstanceResponse:
        # 鉴权、获取token
    ...
    def preview(self, request: PreviewInstanceRequest, option: RequestOption = RequestOption()) -> PreviewInstanceResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def search_cc(self, request: SearchCcInstanceRequest, option: RequestOption = RequestOption()) -> SearchCcInstanceResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def specified_rollback(self, request: SpecifiedRollbackInstanceRequest, option: RequestOption = RequestOption()) -> SpecifiedRollbackInstanceResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

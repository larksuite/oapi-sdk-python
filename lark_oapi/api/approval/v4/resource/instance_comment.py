...
class InstanceComment(object):
    ...
    def create(self, request: CreateInstanceCommentRequest, option: RequestOption = RequestOption()) -> CreateInstanceCommentResponse:
        # 鉴权、获取token
    ...
    def delete(self, request: DeleteInstanceCommentRequest, option: RequestOption = RequestOption()) -> DeleteInstanceCommentResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def list(self, request: ListInstanceCommentRequest, option: RequestOption = RequestOption()) -> ListInstanceCommentResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def remove(self, request: RemoveInstanceCommentRequest, option: RequestOption = RequestOption()) -> RemoveInstanceCommentResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

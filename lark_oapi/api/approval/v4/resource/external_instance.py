...
class ExternalInstance(object):
    ...
    def check(self, request: CheckExternalInstanceRequest, option: RequestOption = RequestOption()) -> CheckExternalInstanceResponse:
        # 鉴权、获取token
    ...
    def create(self, request: CreateExternalInstanceRequest, option: RequestOption = RequestOption()) -> CreateExternalInstanceResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

...
class CreateExternalApprovalRequestBuilder(object):
    def __init__(self) -> None:
        ...
        create_external_approval_request.uri = (
            "/open-apis/approval/v4/external_approvals"
        )
        create_external_approval_request.token_types = {AccessTokenType.TENANT}
        self._create_external_approval_request: CreateExternalApprovalRequest = (
            create_external_approval_request
        )

    def department_id_type(
        self, department_id_type: str
    ) -> "CreateExternalApprovalRequestBuilder":
        self._create_external_approval_request.department_id_type = department_id_type
        self._create_external_approval_request.add_query(
    ...
    def request_body(
        self, request_body: ExternalApproval
    ) -> "CreateExternalApprovalRequestBuilder":

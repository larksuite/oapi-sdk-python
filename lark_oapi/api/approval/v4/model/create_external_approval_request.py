...
class CreateExternalApprovalRequestBuilder(object):
    ...
    def __init__(self, create_external_approval_request: CreateExternalApprovalRequest = CreateExternalApprovalRequest()) -> None:
    ...
    def department_id_type(self, department_id_type: str) -> "CreateExternalApprovalRequestBuilder":
        ...
        self._create_external_approval_request.queries["department_id_type"] = str(department_id_type)
        return self
    ...
    def user_id_type(self, user_id_type: str) -> "CreateExternalApprovalRequestBuilder":
        ...
        self._create_external_approval_request.queries["user_id_type"] = str(user_id_type)
        return self

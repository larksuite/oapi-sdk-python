...
class CheckExternalInstanceResponseBodyBuilder(object):
    def __init__(self) -> None:
        self._check_external_instance_response_body = (
            CheckExternalInstanceResponseBody()
        )

    def diff_instances(
        self, diff_instances: List[ExteranlInstanceCheckResponse]
    ) -> "CheckExternalInstanceResponseBodyBuilder":

...
class QuerySessionResponseBodyBuilder(object):
    def __init__(self, query_session_response_body: QuerySessionResponseBody = QuerySessionResponseBody({})) -> None:
        self._query_session_response_body: QuerySessionResponseBody = query_session_response_body

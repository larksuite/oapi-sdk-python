...
class ListAccessRecordRequestBuilder(object):
    ...
    def user_id_type(self, user_id_type: str) -> "ListAccessRecordRequestBuilder":
        ...
        self._list_access_record_request.queries["user_id_type"] = str(user_id_type)
        return self

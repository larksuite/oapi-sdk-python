...
from ..model.create_app_avatar_upload_request import CreateAppAvatarUploadRequest
from ..model.create_app_avatar_upload_response import CreateAppAvatarUploadResponse


class AppAvatarUpload(object):

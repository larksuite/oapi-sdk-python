...
from ..model.patch_application_ability_request import PatchApplicationAbilityRequest
from ..model.patch_application_ability_response import PatchApplicationAbilityResponse


class ApplicationAbility(object):

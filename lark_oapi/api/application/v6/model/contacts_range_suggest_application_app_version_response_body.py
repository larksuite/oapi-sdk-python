...
class ContactsRangeSuggestApplicationAppVersionResponseBodyBuilder(object):
    def __init__(self, contacts_range_suggest_application_app_version_response_body: ContactsRangeSuggestApplicationAppVersionResponseBody = ContactsRangeSuggestApplicationAppVersionResponseBody({})) -> None:

...
class CheckWhiteBlackListApplicationVisibilityResponseBodyBuilder(object):
    def __init__(self, check_white_black_list_application_visibility_response_body: CheckWhiteBlackListApplicationVisibilityResponseBody = CheckWhiteBlackListApplicationVisibilityResponseBody({})) -> None:
        self._check_white_black_list_application_visibility_response_body: CheckWhiteBlackListApplicationVisibilityResponseBody = check_white_black_list_application_visibility_response_body

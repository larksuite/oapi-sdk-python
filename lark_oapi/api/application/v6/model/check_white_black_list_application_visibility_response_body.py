...
class CheckWhiteBlackListApplicationVisibilityResponseBody(object):
    _types = {
        ...
        "department_visibility_list": List[
            ApplicationVisibilityDepartmentWhiteBlackInfo
        ],
    ...
    def __init__(self, d=None):
        self.user_visibility_list: Optional[
            List[ApplicationVisibilityUserWhiteBlackInfo]
        ] = None
        self.department_visibility_list: Optional[
            List[ApplicationVisibilityDepartmentWhiteBlackInfo]
        ] = None
        self.group_visibility_list: Optional[
            List[ApplicationVisibilityGroupWhiteBlackInfo]
        ] = None
...
class CheckWhiteBlackListApplicationVisibilityResponseBodyBuilder(object):
    def __init__(self) -> None:
        self._check_white_black_list_application_visibility_response_body = (
            CheckWhiteBlackListApplicationVisibilityResponseBody()
        )

    def user_visibility_list(
        self, user_visibility_list: List[ApplicationVisibilityUserWhiteBlackInfo]
    ) -> "CheckWhiteBlackListApplicationVisibilityResponseBodyBuilder":
        self._check_white_black_list_application_visibility_response_body.user_visibility_list = user_visibility_list
        return self

    def department_visibility_list(
        self,
    ...
    def group_visibility_list(
        self, group_visibility_list: List[ApplicationVisibilityGroupWhiteBlackInfo]
    ) -> "CheckWhiteBlackListApplicationVisibilityResponseBodyBuilder":

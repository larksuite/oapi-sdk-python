...
class GetApplicationAppVersionResponseBodyBuilder(object):
    def __init__(self, get_application_app_version_response_body: GetApplicationAppVersionResponseBody = GetApplicationAppVersionResponseBody({})) -> None:
        self._get_application_app_version_response_body: GetApplicationAppVersionResponseBody = get_application_app_version_response_body

...
class ListApplicationAppVersionRequestBuilder(object):
    ...
    def __init__(self, list_application_app_version_request: ListApplicationAppVersionRequest = ListApplicationAppVersionRequest()) -> None:
    ...
    def lang(self, lang: str) -> "ListApplicationAppVersionRequestBuilder":
        ...
        self._list_application_app_version_request.queries["lang"] = str(lang)
        return self
    ...
    def page_size(self, page_size: int) -> "ListApplicationAppVersionRequestBuilder":
        ...
        self._list_application_app_version_request.queries["page_size"] = str(page_size)
        return self
    ...
    def page_token(self, page_token: str) -> "ListApplicationAppVersionRequestBuilder":
        ...
        self._list_application_app_version_request.queries["page_token"] = str(page_token)
        return self
    
    def order(self, order: int) -> "ListApplicationAppVersionRequestBuilder":
        self._list_application_app_version_request.order = order
        self._list_application_app_version_request.queries["order"] = str(order)
        return self
    ...
    def user_id_type(self, user_id_type: str) -> "ListApplicationAppVersionRequestBuilder":
        ...
        self._list_application_app_version_request.queries["user_id_type"] = str(user_id_type)
        return self
    ...
    def app_id(self, app_id: str) -> "ListApplicationAppVersionRequestBuilder":
        ...
        self._list_application_app_version_request.paths["app_id"] = app_id
        return self

...
class OverviewApplicationAppUsageResponseBodyBuilder(object):
    def __init__(self, overview_application_app_usage_response_body: OverviewApplicationAppUsageResponseBody = OverviewApplicationAppUsageResponseBody({})) -> None:
        self._overview_application_app_usage_response_body: OverviewApplicationAppUsageResponseBody = overview_application_app_usage_response_body

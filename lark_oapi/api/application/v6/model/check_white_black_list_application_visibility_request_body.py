...
class CheckWhiteBlackListApplicationVisibilityRequestBodyBuilder(object):
    def __init__(self,
                 check_white_black_list_application_visibility_request_body: CheckWhiteBlackListApplicationVisibilityRequestBody = CheckWhiteBlackListApplicationVisibilityRequestBody(
                     {})) -> None:

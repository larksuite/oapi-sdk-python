...
from .department_overview_application_app_usage_request_body import (
    DepartmentOverviewApplicationAppUsageRequestBody,
)
...
class DepartmentOverviewApplicationAppUsageRequestBuilder(object):
    def __init__(self) -> None:
        department_overview_application_app_usage_request = (
        ...
        department_overview_application_app_usage_request.token_types = {
    ...
    ) -> "DepartmentOverviewApplicationAppUsageRequestBuilder":
        self._department_overview_application_app_usage_request.department_id_type = (
            department_id_type
        )
        self._department_overview_application_app_usage_request.add_query(
    ...
    def app_id(
        ...
        self._department_overview_application_app_usage_request.paths["app_id"] = str(
            app_id
        )
        return self

    def request_body(
        self, request_body: DepartmentOverviewApplicationAppUsageRequestBody
    ) -> "DepartmentOverviewApplicationAppUsageRequestBuilder":
        self._department_overview_application_app_usage_request.request_body = (
            request_body
        )

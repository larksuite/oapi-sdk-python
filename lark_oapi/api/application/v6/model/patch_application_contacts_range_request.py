...
class PatchApplicationContactsRangeRequestBuilder(object):
    ...
    ) -> "PatchApplicationContactsRangeRequestBuilder":
        self._patch_application_contacts_range_request.user_id_type = user_id_type
        self._patch_application_contacts_range_request.add_query(
    ...
    def department_id_type(
        ...
        self._patch_application_contacts_range_request.department_id_type = (
            department_id_type
        )
        self._patch_application_contacts_range_request.add_query(
    ...
    def request_body(
        self, request_body: PatchApplicationContactsRangeRequestBody
    ) -> "PatchApplicationContactsRangeRequestBuilder":

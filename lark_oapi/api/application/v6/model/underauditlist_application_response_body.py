...
class UnderauditlistApplicationResponseBodyBuilder(object):
    def __init__(self, underauditlist_application_response_body: UnderauditlistApplicationResponseBody = UnderauditlistApplicationResponseBody({})) -> None:
        self._underauditlist_application_response_body: UnderauditlistApplicationResponseBody = underauditlist_application_response_body

...
class ContactsRangeSuggestApplicationAppVersionRequestBuilder(object):
    def __init__(self) -> None:
        contacts_range_suggest_application_app_version_request = (
            ContactsRangeSuggestApplicationAppVersionRequest()
        )
        contacts_range_suggest_application_app_version_request.http_method = (
            HttpMethod.GET
        )
        ...
        contacts_range_suggest_application_app_version_request.token_types = {
    ...
    ) -> "ContactsRangeSuggestApplicationAppVersionRequestBuilder":
        self._contacts_range_suggest_application_app_version_request.department_id_type = department_id_type
        self._contacts_range_suggest_application_app_version_request.add_query(
    ...
    def user_id_type(
        ...
        self._contacts_range_suggest_application_app_version_request.user_id_type = (
            user_id_type
        )
        self._contacts_range_suggest_application_app_version_request.add_query(
    ...
    def app_id(
        ...
        self._contacts_range_suggest_application_app_version_request.paths["app_id"] = (
            str(app_id)
        )
        return self
    ...
    def version_id(
        ...
        self._contacts_range_suggest_application_app_version_request.version_id = (
            version_id
        )
        self._contacts_range_suggest_application_app_version_request.paths[
            "version_id"
        ] = str(version_id)
        return self

...
class ContactsRangeSuggestApplicationAppVersionRequestBuilder(object):
    ...
    def __init__(self,
                 contacts_range_suggest_application_app_version_request: ContactsRangeSuggestApplicationAppVersionRequest = ContactsRangeSuggestApplicationAppVersionRequest()) -> None:
    ...
    def department_id_type(self, department_id_type: str) -> "ContactsRangeSuggestApplicationAppVersionRequestBuilder":
        ...
        self._contacts_range_suggest_application_app_version_request.queries["department_id_type"] = str(
            department_id_type)
        return self

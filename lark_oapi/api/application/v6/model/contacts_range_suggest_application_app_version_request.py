...
class ContactsRangeSuggestApplicationAppVersionRequestBuilder(object):
    ...
    def __init__(self, contacts_range_suggest_application_app_version_request: ContactsRangeSuggestApplicationAppVersionRequest = ContactsRangeSuggestApplicationAppVersionRequest()) -> None:
    ...
    def department_id_type(self, department_id_type: str) -> "ContactsRangeSuggestApplicationAppVersionRequestBuilder":
        ...
        self._contacts_range_suggest_application_app_version_request.queries["department_id_type"] = str(department_id_type)
        return self
    ...
    def user_id_type(self, user_id_type: str) -> "ContactsRangeSuggestApplicationAppVersionRequestBuilder":
        ...
        self._contacts_range_suggest_application_app_version_request.queries["user_id_type"] = str(user_id_type)
        return self
    ...
    def app_id(self, app_id: str) -> "ContactsRangeSuggestApplicationAppVersionRequestBuilder":
        ...
        self._contacts_range_suggest_application_app_version_request.paths["app_id"] = app_id
        return self
    ...
    def version_id(self, version_id: int) -> "ContactsRangeSuggestApplicationAppVersionRequestBuilder":
        ...
        self._contacts_range_suggest_application_app_version_request.paths["version_id"] = version_id
        return self

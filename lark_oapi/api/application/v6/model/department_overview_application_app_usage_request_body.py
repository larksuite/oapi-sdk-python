...
class DepartmentOverviewApplicationAppUsageRequestBodyBuilder(object):
    def __init__(self) -> None:
        self._department_overview_application_app_usage_request_body = (
            DepartmentOverviewApplicationAppUsageRequestBody()
        )

    def date(
        self, date: str
    ) -> "DepartmentOverviewApplicationAppUsageRequestBodyBuilder":
    ...
    def cycle_type(
        ...
        self._department_overview_application_app_usage_request_body.cycle_type = (
            cycle_type
        )
        return self
    ...
    def department_id(
        ...
        self._department_overview_application_app_usage_request_body.department_id = (
            department_id
        )
        return self
    ...
    def recursion(
        ...
        self._department_overview_application_app_usage_request_body.recursion = (
            recursion
        )
        return self
    ...
    def page_size(
        ...
        self._department_overview_application_app_usage_request_body.page_size = (
            page_size
        )
        return self
    ...
    def page_token(
        ...
        self._department_overview_application_app_usage_request_body.page_token = (
            page_token
        )
        return self

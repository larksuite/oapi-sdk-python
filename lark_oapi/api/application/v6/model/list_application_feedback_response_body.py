...
class ListApplicationFeedbackResponseBodyBuilder(object):
    def __init__(self, list_application_feedback_response_body: ListApplicationFeedbackResponseBody = ListApplicationFeedbackResponseBody({})) -> None:
        self._list_application_feedback_response_body: ListApplicationFeedbackResponseBody = list_application_feedback_response_body

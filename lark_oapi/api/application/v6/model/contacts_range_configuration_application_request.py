...
class ContactsRangeConfigurationApplicationRequestBuilder(object):
    ...
    def __init__(self, contacts_range_configuration_application_request: ContactsRangeConfigurationApplicationRequest = ContactsRangeConfigurationApplicationRequest()) -> None:
    ...
    def page_size(self, page_size: int) -> "ContactsRangeConfigurationApplicationRequestBuilder":
        ...
        self._contacts_range_configuration_application_request.queries["page_size"] = str(page_size)
        return self
    ...
    def page_token(self, page_token: str) -> "ContactsRangeConfigurationApplicationRequestBuilder":
        ...
        self._contacts_range_configuration_application_request.queries["page_token"] = str(page_token)
        return self
    ...
    def department_id_type(self, department_id_type: str) -> "ContactsRangeConfigurationApplicationRequestBuilder":
        ...
        self._contacts_range_configuration_application_request.queries["department_id_type"] = str(department_id_type)
        return self
    ...
    def user_id_type(self, user_id_type: str) -> "ContactsRangeConfigurationApplicationRequestBuilder":
        ...
        self._contacts_range_configuration_application_request.queries["user_id_type"] = str(user_id_type)
        return self
    ...
    def app_id(self, app_id: str) -> "ContactsRangeConfigurationApplicationRequestBuilder":
        ...
        self._contacts_range_configuration_application_request.paths["app_id"] = app_id
        return self

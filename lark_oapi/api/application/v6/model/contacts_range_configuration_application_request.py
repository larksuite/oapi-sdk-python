...
class ContactsRangeConfigurationApplicationRequestBuilder(object):
    def __init__(self) -> None:
        contacts_range_configuration_application_request = (
        ...
        contacts_range_configuration_application_request.token_types = {
    ...
    def page_size(
        self, page_size: int
    ) -> "ContactsRangeConfigurationApplicationRequestBuilder":
        self._contacts_range_configuration_application_request.page_size = page_size
        self._contacts_range_configuration_application_request.add_query(
            "page_size", page_size
        )
        return self
    ...
    def department_id_type(
        ...
        self._contacts_range_configuration_application_request.department_id_type = (
            department_id_type
        )
        self._contacts_range_configuration_application_request.add_query(
    ...
    def user_id_type(
        ...
        self._contacts_range_configuration_application_request.user_id_type = (
            user_id_type
        )
        self._contacts_range_configuration_application_request.add_query(
    ...
    def app_id(
        ...
        self._contacts_range_configuration_application_request.paths["app_id"] = str(
            app_id
        )
        return self

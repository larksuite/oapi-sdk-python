...
from .update_application_collaborators_request_body import (
    UpdateApplicationCollaboratorsRequestBody,
)
...
class UpdateApplicationCollaboratorsRequestBuilder(object):
    ...
    ) -> "UpdateApplicationCollaboratorsRequestBuilder":
        self._update_application_collaborators_request.user_id_type = user_id_type
        self._update_application_collaborators_request.add_query(
    ...
    def request_body(
        self, request_body: UpdateApplicationCollaboratorsRequestBody
    ) -> "UpdateApplicationCollaboratorsRequestBuilder":

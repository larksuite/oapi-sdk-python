...
class ApplicationVisibilityGroupWhiteBlackInfoBuilder(object):
    def __init__(self, application_visibility_group_white_black_info: ApplicationVisibilityGroupWhiteBlackInfo = ApplicationVisibilityGroupWhiteBlackInfo({})) -> None:
        self._application_visibility_group_white_black_info: ApplicationVisibilityGroupWhiteBlackInfo = application_visibility_group_white_black_info

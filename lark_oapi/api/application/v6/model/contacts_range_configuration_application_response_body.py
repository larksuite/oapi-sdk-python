...
class ContactsRangeConfigurationApplicationResponseBodyBuilder(object):
    def __init__(self,
                 contacts_range_configuration_application_response_body: ContactsRangeConfigurationApplicationResponseBody = ContactsRangeConfigurationApplicationResponseBody(
                     {})) -> None:

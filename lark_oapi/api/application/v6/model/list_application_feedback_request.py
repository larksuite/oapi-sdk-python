...
class ListApplicationFeedbackRequestBuilder(object):
    ...
    def __init__(self, list_application_feedback_request: ListApplicationFeedbackRequest = ListApplicationFeedbackRequest()) -> None:
    ...
    def from_date(self, from_date: str) -> "ListApplicationFeedbackRequestBuilder":
        ...
        self._list_application_feedback_request.queries["from_date"] = str(from_date)
        return self
    ...
    def to_date(self, to_date: str) -> "ListApplicationFeedbackRequestBuilder":
        ...
        self._list_application_feedback_request.queries["to_date"] = str(to_date)
        return self
    ...
    def feedback_type(self, feedback_type: int) -> "ListApplicationFeedbackRequestBuilder":
        ...
        self._list_application_feedback_request.queries["feedback_type"] = str(feedback_type)
        return self
    
    def status(self, status: int) -> "ListApplicationFeedbackRequestBuilder":
        self._list_application_feedback_request.status = status
        self._list_application_feedback_request.queries["status"] = str(status)
        return self
    ...
    def user_id_type(self, user_id_type: str) -> "ListApplicationFeedbackRequestBuilder":
        ...
        self._list_application_feedback_request.queries["user_id_type"] = str(user_id_type)
        return self
    ...
    def page_token(self, page_token: int) -> "ListApplicationFeedbackRequestBuilder":
        ...
        self._list_application_feedback_request.queries["page_token"] = str(page_token)
        return self
    ...
    def page_size(self, page_size: int) -> "ListApplicationFeedbackRequestBuilder":
        ...
        self._list_application_feedback_request.queries["page_size"] = str(page_size)
        return self
    
    def app_id(self, app_id: str) -> "ListApplicationFeedbackRequestBuilder":
        self._list_application_feedback_request.app_id = app_id
        self._list_application_feedback_request.paths["app_id"] = app_id
        return self

...
from .message_push_overview_application_app_usage_request_body import (
    MessagePushOverviewApplicationAppUsageRequestBody,
)
...
class MessagePushOverviewApplicationAppUsageRequestBuilder(object):
    def __init__(self) -> None:
        message_push_overview_application_app_usage_request = (
            MessagePushOverviewApplicationAppUsageRequest()
        )
        message_push_overview_application_app_usage_request.http_method = (
            HttpMethod.POST
        )
        ...
        message_push_overview_application_app_usage_request.token_types = {
    ...
    ) -> "MessagePushOverviewApplicationAppUsageRequestBuilder":
        self._message_push_overview_application_app_usage_request.department_id_type = (
            department_id_type
        )
        self._message_push_overview_application_app_usage_request.add_query(
    ...
    def app_id(
        ...
        self._message_push_overview_application_app_usage_request.paths["app_id"] = str(
            app_id
        )
        return self

    def request_body(
        self, request_body: MessagePushOverviewApplicationAppUsageRequestBody
    ) -> "MessagePushOverviewApplicationAppUsageRequestBuilder":
        self._message_push_overview_application_app_usage_request.request_body = (
            request_body
        )

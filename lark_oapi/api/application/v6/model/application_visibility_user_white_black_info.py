...
class ApplicationVisibilityUserWhiteBlackInfoBuilder(object):
    def __init__(self, application_visibility_user_white_black_info: ApplicationVisibilityUserWhiteBlackInfo = ApplicationVisibilityUserWhiteBlackInfo({})) -> None:
        self._application_visibility_user_white_black_info: ApplicationVisibilityUserWhiteBlackInfo = application_visibility_user_white_black_info

...
class GetApplicationCollaboratorsRequestBuilder(object):
    def __init__(self) -> None:
        ...
        get_application_collaborators_request.uri = (
            "/open-apis/application/v6/applications/:app_id/collaborators"
        )
        get_application_collaborators_request.token_types = {
    ...
    ) -> "GetApplicationCollaboratorsRequestBuilder":
        self._get_application_collaborators_request.user_id_type = user_id_type
        self._get_application_collaborators_request.add_query(

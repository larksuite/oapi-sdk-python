...
class ApplicationVisibilityDepartmentWhiteBlackInfoBuilder(object):
    def __init__(self, application_visibility_department_white_black_info: ApplicationVisibilityDepartmentWhiteBlackInfo = ApplicationVisibilityDepartmentWhiteBlackInfo({})) -> None:
        self._application_visibility_department_white_black_info: ApplicationVisibilityDepartmentWhiteBlackInfo = application_visibility_department_white_black_info

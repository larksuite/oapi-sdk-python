...
class ListAppRecommendRuleRequestBuilder(object):
    ...
    def __init__(self, list_app_recommend_rule_request: ListAppRecommendRuleRequest = ListAppRecommendRuleRequest()) -> None:
    ...
    def page_size(self, page_size: int) -> "ListAppRecommendRuleRequestBuilder":
        ...
        self._list_app_recommend_rule_request.queries["page_size"] = str(page_size)
        return self
    ...
    def page_token(self, page_token: str) -> "ListAppRecommendRuleRequestBuilder":
        ...
        self._list_app_recommend_rule_request.queries["page_token"] = str(page_token)
        return self
    ...
    def user_id_type(self, user_id_type: str) -> "ListAppRecommendRuleRequestBuilder":
        ...
        self._list_app_recommend_rule_request.queries["user_id_type"] = str(user_id_type)
        return self

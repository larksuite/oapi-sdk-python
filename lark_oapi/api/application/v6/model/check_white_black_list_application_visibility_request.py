...
from .check_white_black_list_application_visibility_request_body import CheckWhiteBlackListApplicationVisibilityRequestBody
...
class CheckWhiteBlackListApplicationVisibilityRequestBuilder(object):
    ...
    def __init__(self, check_white_black_list_application_visibility_request: CheckWhiteBlackListApplicationVisibilityRequest = CheckWhiteBlackListApplicationVisibilityRequest()) -> None:
    ...
    def department_id_type(self, department_id_type: str) -> "CheckWhiteBlackListApplicationVisibilityRequestBuilder":
        ...
        self._check_white_black_list_application_visibility_request.queries["department_id_type"] = str(department_id_type)
        return self

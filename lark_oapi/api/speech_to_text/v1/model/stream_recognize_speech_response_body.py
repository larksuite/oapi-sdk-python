...
class StreamRecognizeSpeechResponseBodyBuilder(object):
    def __init__(self, stream_recognize_speech_response_body: StreamRecognizeSpeechResponseBody = StreamRecognizeSpeechResponseBody({})) -> None:
        self._stream_recognize_speech_response_body: StreamRecognizeSpeechResponseBody = stream_recognize_speech_response_body

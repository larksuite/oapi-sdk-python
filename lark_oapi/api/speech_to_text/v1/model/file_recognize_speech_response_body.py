...
class FileRecognizeSpeechResponseBodyBuilder(object):
    def __init__(self, file_recognize_speech_response_body: FileRecognizeSpeechResponseBody = FileRecognizeSpeechResponseBody({})) -> None:
        self._file_recognize_speech_response_body: FileRecognizeSpeechResponseBody = file_recognize_speech_response_body

...
class UpdateBadgeGrantRequestBuilder(object):
    ...
    def user_id_type(self, user_id_type: str) -> "UpdateBadgeGrantRequestBuilder":
        ...
        self._update_badge_grant_request.queries["user_id_type"] = str(user_id_type)
        return self

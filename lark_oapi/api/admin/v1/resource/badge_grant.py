...
class BadgeGrant(object):
    ...
    def create(self, request: CreateBadgeGrantRequest, option: RequestOption = RequestOption()) -> CreateBadgeGrantResponse:
        # 鉴权、获取token
    ...
    def delete(self, request: DeleteBadgeGrantRequest, option: RequestOption = RequestOption()) -> DeleteBadgeGrantResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def update(self, request: UpdateBadgeGrantRequest, option: RequestOption = RequestOption()) -> UpdateBadgeGrantResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

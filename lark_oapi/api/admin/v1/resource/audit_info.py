...
class AuditInfo(object):
    ...
    def list(
        self, request: ListAuditInfoRequest, option: Optional[RequestOption] = None
        ...
        # 反序列化
        response: ListAuditInfoResponse = JSON.unmarshal(
            str(resp.content, UTF_8), ListAuditInfoResponse
        )
        response.raw = resp

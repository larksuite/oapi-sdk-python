...
class Notification(object):
    ...
    def cancel_approve(self, request: CancelApproveNotificationRequest, option: RequestOption = RequestOption()) -> CancelApproveNotificationResponse:
        # 鉴权、获取token
    ...
    def cancel_send(self, request: CancelSendNotificationRequest, option: RequestOption = RequestOption()) -> CancelSendNotificationResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def create(self, request: CreateNotificationRequest, option: RequestOption = RequestOption()) -> CreateNotificationResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def execute_send(self, request: ExecuteSendNotificationRequest, option: RequestOption = RequestOption()) -> ExecuteSendNotificationResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def patch(self, request: PatchNotificationRequest, option: RequestOption = RequestOption()) -> PatchNotificationResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def preview(self, request: PreviewNotificationRequest, option: RequestOption = RequestOption()) -> PreviewNotificationResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def submit_approve(self, request: SubmitApproveNotificationRequest, option: RequestOption = RequestOption()) -> SubmitApproveNotificationResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

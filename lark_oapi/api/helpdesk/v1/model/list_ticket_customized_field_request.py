...
class ListTicketCustomizedFieldRequestBuilder(object):
    ...
    def __init__(self, list_ticket_customized_field_request: ListTicketCustomizedFieldRequest = ListTicketCustomizedFieldRequest()) -> None:
    ...
    def page_token(self, page_token: str) -> "ListTicketCustomizedFieldRequestBuilder":
        ...
        self._list_ticket_customized_field_request.queries["page_token"] = str(page_token)
        return self
    ...
    def page_size(self, page_size: int) -> "ListTicketCustomizedFieldRequestBuilder":
        ...
        self._list_ticket_customized_field_request.queries["page_size"] = str(page_size)
        return self

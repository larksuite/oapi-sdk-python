...
class ExecuteSendNotificationRequestBuilder(object):
    ...
    def __init__(self, execute_send_notification_request: ExecuteSendNotificationRequest = ExecuteSendNotificationRequest()) -> None:
    ...
    def notification_id(self, notification_id: str) -> "ExecuteSendNotificationRequestBuilder":
        ...
        self._execute_send_notification_request.paths["notification_id"] = notification_id
        return self

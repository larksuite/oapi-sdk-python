...
class PatchAgentSkillRequestBuilder(object):
    def __init__(self) -> None:
        ...
        patch_agent_skill_request.uri = (
            "/open-apis/helpdesk/v1/agent_skills/:agent_skill_id"
        )
        patch_agent_skill_request.token_types = {AccessTokenType.USER}
        self._patch_agent_skill_request: PatchAgentSkillRequest = (
            patch_agent_skill_request
        )
    ...
    def request_body(
        self, request_body: PatchAgentSkillRequestBody
    ) -> "PatchAgentSkillRequestBuilder":

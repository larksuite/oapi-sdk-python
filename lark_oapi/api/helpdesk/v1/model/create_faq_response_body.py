...
class CreateFaqResponseBodyBuilder(object):
    def __init__(self, create_faq_response_body: CreateFaqResponseBody = CreateFaqResponseBody({})) -> None:
        self._create_faq_response_body: CreateFaqResponseBody = create_faq_response_body

...
class PatchAgentSchedulesRequestBuilder(object):
    def __init__(self) -> None:
        ...
        patch_agent_schedules_request.uri = (
            "/open-apis/helpdesk/v1/agents/:agent_id/schedules"
        )
        patch_agent_schedules_request.token_types = {AccessTokenType.USER}
        self._patch_agent_schedules_request: PatchAgentSchedulesRequest = (
            patch_agent_schedules_request
        )
    ...
    def request_body(
        self, request_body: PatchAgentSchedulesRequestBody
    ) -> "PatchAgentSchedulesRequestBuilder":

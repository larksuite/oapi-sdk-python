...
class CancelSendNotificationRequestBuilder(object):
    ...
    def __init__(self, cancel_send_notification_request: CancelSendNotificationRequest = CancelSendNotificationRequest()) -> None:
    ...
    def notification_id(self, notification_id: str) -> "CancelSendNotificationRequestBuilder":
        ...
        self._cancel_send_notification_request.paths["notification_id"] = notification_id
        return self

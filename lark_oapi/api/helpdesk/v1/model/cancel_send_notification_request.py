...
class CancelSendNotificationRequestBuilder(object):
    def __init__(self) -> None:
        ...
        cancel_send_notification_request.uri = (
        ...
        self._cancel_send_notification_request: CancelSendNotificationRequest = (
            cancel_send_notification_request
        )

    def notification_id(
        self, notification_id: str
    ) -> "CancelSendNotificationRequestBuilder":
        self._cancel_send_notification_request.notification_id = notification_id
        self._cancel_send_notification_request.paths["notification_id"] = str(
            notification_id
        )
        return self

    def request_body(
        self, request_body: CancelSendNotificationRequestBody
    ) -> "CancelSendNotificationRequestBuilder":

...
class ListTicketCustomizedFieldResponseBodyBuilder(object):
    def __init__(self) -> None:
        self._list_ticket_customized_field_response_body = (
            ListTicketCustomizedFieldResponseBody()
        )

    def has_more(
        self, has_more: bool
    ) -> "ListTicketCustomizedFieldResponseBodyBuilder":
    ...
    def next_page_token(
        ...
        self._list_ticket_customized_field_response_body.next_page_token = (
            next_page_token
        )
        return self

    def items(
        self, items: List[TicketCustomizedField]
    ) -> "ListTicketCustomizedFieldResponseBodyBuilder":

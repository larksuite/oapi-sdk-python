...
class Classification(object):
    ...
    def list(self, request: ListClassificationRequest, option: Optional[RequestOption] = None) -> ListClassificationResponse:
        if option is None:
    ...
    async def alist(self, request: ListClassificationRequest, option: Optional[RequestOption] = None) -> ListClassificationResponse:
        if option is None:
            option = RequestOption()

...
class ListMotoResponseBodyBuilder(object):
    def __init__(self, list_moto_response_body: ListMotoResponseBody = ListMotoResponseBody({})) -> None:
        self._list_moto_response_body: ListMotoResponseBody = list_moto_response_body

...
class CreateMotoRequestBuilder(object):
    ...
    def __init__(self, create_moto_request: CreateMotoRequest = CreateMotoRequest()) -> None:
    ...
    def department_id_type(self, department_id_type: str) -> "CreateMotoRequestBuilder":
        ...
        self._create_moto_request.queries["department_id_type"] = str(department_id_type)
        return self

    def user_id_type(self, user_id_type: str) -> "CreateMotoRequestBuilder":
        self._create_moto_request.user_id_type = user_id_type
        self._create_moto_request.queries["user_id_type"] = str(user_id_type)
        return self

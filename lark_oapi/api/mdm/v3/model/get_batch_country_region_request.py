...
class GetBatchCountryRegionRequestBuilder(object):
    def __init__(self) -> None:
        ...
        self._get_batch_country_region_request: GetBatchCountryRegionRequest = (
            get_batch_country_region_request
        )
    ...
    def request_body(
        self, request_body: GetBatchCountryRegionRequestBody
    ) -> "GetBatchCountryRegionRequestBuilder":

...
from ..model.get_batch_country_region_request import GetBatchCountryRegionRequest
from ..model.get_batch_country_region_response import GetBatchCountryRegionResponse


class BatchCountryRegion(object):

...
class ProjectCompanyDeptMappingBuilder(object):
    ...
    def project_union_id(
        self, project_union_id: str
    ) -> "ProjectCompanyDeptMappingBuilder":
        self._project_company_dept_mapping.project_union_id = project_union_id
        return self

    def company_union_id(
        self, company_union_id: str
    ) -> "ProjectCompanyDeptMappingBuilder":
        self._project_company_dept_mapping.company_union_id = company_union_id
        return self

    def is_all_department(
        self, is_all_department: bool
    ) -> "ProjectCompanyDeptMappingBuilder":
        self._project_company_dept_mapping.is_all_department = is_all_department
        return self

    def department_union_id(
        self, department_union_id: str
    ) -> "ProjectCompanyDeptMappingBuilder":

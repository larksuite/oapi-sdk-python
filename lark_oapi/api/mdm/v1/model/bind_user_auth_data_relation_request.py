...
class BindUserAuthDataRelationRequestBuilder(object):
    ...
    def __init__(self, bind_user_auth_data_relation_request: BindUserAuthDataRelationRequest = BindUserAuthDataRelationRequest()) -> None:
    ...
    def user_id_type(self, user_id_type: str) -> "BindUserAuthDataRelationRequestBuilder":
        ...
        self._bind_user_auth_data_relation_request.queries["user_id_type"] = str(user_id_type)
        return self

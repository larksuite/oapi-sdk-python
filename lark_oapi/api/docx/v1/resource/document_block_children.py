...
from lark_oapi.api.docx.v1.model.batch_delete_document_block_children_request import BatchDeleteDocumentBlockChildrenRequest
from lark_oapi.api.docx.v1.model.batch_delete_document_block_children_response import BatchDeleteDocumentBlockChildrenResponse
...
class DocumentBlockChildren(object):
    ...
    def batch_delete(self, request: BatchDeleteDocumentBlockChildrenRequest, option: RequestOption = RequestOption()) -> BatchDeleteDocumentBlockChildrenResponse:
        # 鉴权、获取token
    ...
    def create(self, request: CreateDocumentBlockChildrenRequest, option: RequestOption = RequestOption()) -> CreateDocumentBlockChildrenResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def get(self, request: GetDocumentBlockChildrenRequest, option: RequestOption = RequestOption()) -> GetDocumentBlockChildrenResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

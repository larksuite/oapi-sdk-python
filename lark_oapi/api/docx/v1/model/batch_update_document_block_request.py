...
class BatchUpdateDocumentBlockRequestBuilder(object):
    def __init__(self) -> None:
        ...
        batch_update_document_block_request.uri = (
            "/open-apis/docx/v1/documents/:document_id/blocks/batch_update"
        )
        batch_update_document_block_request.token_types = {
            AccessTokenType.TENANT,
            AccessTokenType.USER,
        }
        self._batch_update_document_block_request: BatchUpdateDocumentBlockRequest = (
    ...
    def document_revision_id(
        ...
        self._batch_update_document_block_request.document_revision_id = (
            document_revision_id
        )
        self._batch_update_document_block_request.add_query(
    ...
    def document_id(self, document_id: str) -> "BatchUpdateDocumentBlockRequestBuilder":
        ...
        self._batch_update_document_block_request.paths["document_id"] = str(
            document_id
        )
        return self

    def request_body(
        self, request_body: BatchUpdateDocumentBlockRequestBody
    ) -> "BatchUpdateDocumentBlockRequestBuilder":

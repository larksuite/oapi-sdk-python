...
class CreateDocumentBlockDescendantRequestBuilder(object):
    ...
    def document_revision_id(
        ...
        self._create_document_block_descendant_request.document_revision_id = (
            document_revision_id
        )
        self._create_document_block_descendant_request.add_query(
    ...
    def document_id(
        ...
        self._create_document_block_descendant_request.paths["document_id"] = str(
            document_id
        )
        return self
    ...
    def request_body(
        self, request_body: CreateDocumentBlockDescendantRequestBody
    ) -> "CreateDocumentBlockDescendantRequestBuilder":

...
class ConvertDocumentResponseBodyBuilder(object):
    ...
    def first_level_block_ids(
        self, first_level_block_ids: List[str]
    ) -> "ConvertDocumentResponseBodyBuilder":
        self._convert_document_response_body.first_level_block_ids = (
    ...
    def block_id_to_image_urls(
        self, block_id_to_image_urls: List[BlockIdToImageUrl]
    ) -> "ConvertDocumentResponseBodyBuilder":
        self._convert_document_response_body.block_id_to_image_urls = (

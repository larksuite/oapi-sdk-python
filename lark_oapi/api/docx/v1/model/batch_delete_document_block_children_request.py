...
class BatchDeleteDocumentBlockChildrenRequestBuilder(object):
    def __init__(self) -> None:
        batch_delete_document_block_children_request = (
        ...
        batch_delete_document_block_children_request.token_types = {
    ...
    def document_revision_id(
        ...
        self._batch_delete_document_block_children_request.document_revision_id = (
            document_revision_id
        )
        self._batch_delete_document_block_children_request.add_query(
    ...
    def document_id(
        ...
        self._batch_delete_document_block_children_request.paths["document_id"] = str(
            document_id
        )
        return self
    ...
    def block_id(
        ...
        self._batch_delete_document_block_children_request.paths["block_id"] = str(
            block_id
        )
        return self

    def request_body(
        self, request_body: BatchDeleteDocumentBlockChildrenRequestBody
    ) -> "BatchDeleteDocumentBlockChildrenRequestBuilder":

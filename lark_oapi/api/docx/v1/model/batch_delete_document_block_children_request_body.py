...
class BatchDeleteDocumentBlockChildrenRequestBodyBuilder(object):
    def __init__(self, batch_delete_document_block_children_request_body: BatchDeleteDocumentBlockChildrenRequestBody = BatchDeleteDocumentBlockChildrenRequestBody({})) -> None:

...
class CreateDocumentBlockChildrenResponseBodyBuilder(object):
    def __init__(self) -> None:
        self._create_document_block_children_response_body = (
            CreateDocumentBlockChildrenResponseBody()
        )

    def children(
        self, children: List[Block]
    ) -> "CreateDocumentBlockChildrenResponseBodyBuilder":
    ...
    def document_revision_id(
        ...
        self._create_document_block_children_response_body.document_revision_id = (

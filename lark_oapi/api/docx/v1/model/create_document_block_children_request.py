...
class CreateDocumentBlockChildrenRequestBuilder(object):
    def __init__(self) -> None:
        ...
        create_document_block_children_request.uri = (
            "/open-apis/docx/v1/documents/:document_id/blocks/:block_id/children"
        )
        create_document_block_children_request.token_types = {
    ...
    def document_revision_id(
        ...
        self._create_document_block_children_request.document_revision_id = (
            document_revision_id
        )
        self._create_document_block_children_request.add_query(
    ...
    def document_id(
        ...
        self._create_document_block_children_request.paths["document_id"] = str(
            document_id
        )
        return self
    ...
    def request_body(
        self, request_body: CreateDocumentBlockChildrenRequestBody
    ) -> "CreateDocumentBlockChildrenRequestBuilder":

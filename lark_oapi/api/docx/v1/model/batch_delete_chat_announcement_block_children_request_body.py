...
class BatchDeleteChatAnnouncementBlockChildrenRequestBody(object):
    _types = {
        "start_index": int,
        "end_index": int,
    }
    ...
    def builder() -> "BatchDeleteChatAnnouncementBlockChildrenRequestBodyBuilder":
        return BatchDeleteChatAnnouncementBlockChildrenRequestBodyBuilder()
...
class BatchDeleteChatAnnouncementBlockChildrenRequestBodyBuilder(object):
    ...
    def build(self) -> "BatchDeleteChatAnnouncementBlockChildrenRequestBody":
        return self._batch_delete_chat_announcement_block_children_request_body

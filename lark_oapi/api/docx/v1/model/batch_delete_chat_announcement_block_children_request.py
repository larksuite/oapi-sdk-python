...
class BatchDeleteChatAnnouncementBlockChildrenRequestBuilder(object):
    def __init__(self) -> None:
        batch_delete_chat_announcement_block_children_request = (
            BatchDeleteChatAnnouncementBlockChildrenRequest()
        )
        batch_delete_chat_announcement_block_children_request.http_method = (
            HttpMethod.DELETE
        )
        ...
        batch_delete_chat_announcement_block_children_request.token_types = {
    ...
    ) -> "BatchDeleteChatAnnouncementBlockChildrenRequestBuilder":
        self._batch_delete_chat_announcement_block_children_request.revision_id = (
            revision_id
        )
        self._batch_delete_chat_announcement_block_children_request.add_query(
    ...
    def client_token(
        ...
        self._batch_delete_chat_announcement_block_children_request.client_token = (
            client_token
        )
        self._batch_delete_chat_announcement_block_children_request.add_query(
    ...
    def chat_id(
        ...
        self._batch_delete_chat_announcement_block_children_request.paths["chat_id"] = (
            str(chat_id)
        )
        return self
    ...
    def block_id(
        ...
        self._batch_delete_chat_announcement_block_children_request.paths[
            "block_id"
        ] = str(block_id)
        return self

    def request_body(
        self, request_body: BatchDeleteChatAnnouncementBlockChildrenRequestBody
    ) -> "BatchDeleteChatAnnouncementBlockChildrenRequestBuilder":
        self._batch_delete_chat_announcement_block_children_request.request_body = (
            request_body
        )

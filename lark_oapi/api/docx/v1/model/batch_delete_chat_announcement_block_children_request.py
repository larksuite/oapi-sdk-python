...
from .batch_delete_chat_announcement_block_children_request_body import BatchDeleteChatAnnouncementBlockChildrenRequestBody
...
class BatchDeleteChatAnnouncementBlockChildrenRequestBuilder(object):
    ...
    def __init__(self) -> None:
        ...
        batch_delete_chat_announcement_block_children_request.token_types = {AccessTokenType.TENANT, AccessTokenType.USER}

...
class DeleteAppFeedCardBatchRequestBuilder(object):
    def __init__(self) -> None:
        ...
        self._delete_app_feed_card_batch_request: DeleteAppFeedCardBatchRequest = (
            delete_app_feed_card_batch_request
        )
    ...
    def request_body(
        self, request_body: DeleteAppFeedCardBatchRequestBody
    ) -> "DeleteAppFeedCardBatchRequestBuilder":

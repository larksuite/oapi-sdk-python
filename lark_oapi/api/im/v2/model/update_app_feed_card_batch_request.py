...
class UpdateAppFeedCardBatchRequestBuilder(object):
    def __init__(self) -> None:
        ...
        self._update_app_feed_card_batch_request: UpdateAppFeedCardBatchRequest = (
            update_app_feed_card_batch_request
        )
    ...
    def request_body(
        self, request_body: UpdateAppFeedCardBatchRequestBody
    ) -> "UpdateAppFeedCardBatchRequestBuilder":

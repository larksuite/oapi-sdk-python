...
class ChatMenuTree(object):
    ...
    def create(self, request: CreateChatMenuTreeRequest, option: RequestOption = RequestOption()) -> CreateChatMenuTreeResponse:
        # 鉴权、获取token
    ...
    def delete(self, request: DeleteChatMenuTreeRequest, option: RequestOption = RequestOption()) -> DeleteChatMenuTreeResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def sort(self, request: SortChatMenuTreeRequest, option: RequestOption = RequestOption()) -> SortChatMenuTreeResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

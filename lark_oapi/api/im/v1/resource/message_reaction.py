...
class MessageReaction(object):
    ...
    def create(self, request: CreateMessageReactionRequest, option: RequestOption = RequestOption()) -> CreateMessageReactionResponse:
        # 鉴权、获取token
    ...
    def delete(self, request: DeleteMessageReactionRequest, option: RequestOption = RequestOption()) -> DeleteMessageReactionResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def list(self, request: ListMessageReactionRequest, option: RequestOption = RequestOption()) -> ListMessageReactionResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

...
class MessageResource(object):
    ...
    def get(self, request: GetMessageResourceRequest, option: RequestOption = RequestOption()) -> GetMessageResourceResponse:
        # 鉴权、获取token
        ...
        # 反序列化
        response: GetMessageResourceResponse = JSON.unmarshal(str(resp.content, UTF_8), GetMessageResourceResponse)
        response.raw = resp

...
class ChatAnnouncement(object):
    ...
    def get(self, request: GetChatAnnouncementRequest, option: RequestOption = RequestOption()) -> GetChatAnnouncementResponse:
        # 鉴权、获取token
    ...
    def patch(self, request: PatchChatAnnouncementRequest, option: RequestOption = RequestOption()) -> PatchChatAnnouncementResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

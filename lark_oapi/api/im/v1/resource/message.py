...
class Message(object):
    ...
    def forward(self, request: ForwardMessageRequest, option: RequestOption = RequestOption()) -> ForwardMessageResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def merge_forward(self, request: MergeForwardMessageRequest, option: RequestOption = RequestOption()) -> MergeForwardMessageResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def read_users(self, request: ReadUsersMessageRequest, option: RequestOption = RequestOption()) -> ReadUsersMessageResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def urgent_app(self, request: UrgentAppMessageRequest, option: RequestOption = RequestOption()) -> UrgentAppMessageResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def urgent_phone(self, request: UrgentPhoneMessageRequest, option: RequestOption = RequestOption()) -> UrgentPhoneMessageResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def urgent_sms(self, request: UrgentSmsMessageRequest, option: RequestOption = RequestOption()) -> UrgentSmsMessageResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

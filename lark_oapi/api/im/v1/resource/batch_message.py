...
class BatchMessage(object):
    ...
    def delete(self, request: DeleteBatchMessageRequest, option: RequestOption = RequestOption()) -> DeleteBatchMessageResponse:
        # 鉴权、获取token
    ...
    def get_progress(self, request: GetProgressBatchMessageRequest, option: RequestOption = RequestOption()) -> GetProgressBatchMessageResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def read_user(self, request: ReadUserBatchMessageRequest, option: RequestOption = RequestOption()) -> ReadUserBatchMessageResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

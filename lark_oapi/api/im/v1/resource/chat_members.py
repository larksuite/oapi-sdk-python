...
class ChatMembers(object):
    ...
    def create(self, request: CreateChatMembersRequest, option: RequestOption = RequestOption()) -> CreateChatMembersResponse:
        # 鉴权、获取token
    ...
    def delete(self, request: DeleteChatMembersRequest, option: RequestOption = RequestOption()) -> DeleteChatMembersResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def is_in_chat(self, request: IsInChatChatMembersRequest, option: RequestOption = RequestOption()) -> IsInChatChatMembersResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def me_join(self, request: MeJoinChatMembersRequest, option: RequestOption = RequestOption()) -> MeJoinChatMembersResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

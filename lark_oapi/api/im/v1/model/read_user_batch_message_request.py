...
class ReadUserBatchMessageRequestBuilder(object):
    def __init__(self) -> None:
        ...
        read_user_batch_message_request.uri = (
        ...
        self._read_user_batch_message_request: ReadUserBatchMessageRequest = (
            read_user_batch_message_request
        )

    def batch_message_id(
        self, batch_message_id: str
    ) -> "ReadUserBatchMessageRequestBuilder":
        self._read_user_batch_message_request.batch_message_id = batch_message_id
        self._read_user_batch_message_request.paths["batch_message_id"] = str(
            batch_message_id
        )
        return self

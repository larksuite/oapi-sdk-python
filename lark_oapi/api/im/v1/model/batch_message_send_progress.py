...
class BatchMessageSendProgressBuilder(object):
    ...
    def valid_user_ids_count(
        self, valid_user_ids_count: int
    ) -> "BatchMessageSendProgressBuilder":
        self._batch_message_send_progress.valid_user_ids_count = valid_user_ids_count
        return self

    def success_user_ids_count(
        self, success_user_ids_count: int
    ) -> "BatchMessageSendProgressBuilder":
        self._batch_message_send_progress.success_user_ids_count = (
            success_user_ids_count
        )
        return self

    def read_user_ids_count(
        self, read_user_ids_count: int
    ) -> "BatchMessageSendProgressBuilder":

...
class CreateChatMembersRequestBuilder(object):
    def __init__(self) -> None:
        ...
        create_chat_members_request.token_types = {
            AccessTokenType.USER,
            AccessTokenType.TENANT,
        }
        self._create_chat_members_request: CreateChatMembersRequest = (
            create_chat_members_request
        )
    ...
    def request_body(
        self, request_body: CreateChatMembersRequestBody
    ) -> "CreateChatMembersRequestBuilder":

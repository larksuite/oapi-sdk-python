...
class UpdateChatModerationRequestBuilder(object):
    ...
    def __init__(self, update_chat_moderation_request: UpdateChatModerationRequest = UpdateChatModerationRequest()) -> None:
    ...
    def user_id_type(self, user_id_type: str) -> "UpdateChatModerationRequestBuilder":
        ...
        self._update_chat_moderation_request.queries["user_id_type"] = str(user_id_type)
        return self
    
    def chat_id(self, chat_id: str) -> "UpdateChatModerationRequestBuilder":
        self._update_chat_moderation_request.chat_id = chat_id
        self._update_chat_moderation_request.paths["chat_id"] = chat_id
        return self

...
class PutTopNoticeChatTopNoticeRequestBuilder(object):
    ...
    def __init__(self, put_top_notice_chat_top_notice_request: PutTopNoticeChatTopNoticeRequest = PutTopNoticeChatTopNoticeRequest()) -> None:
    ...
    def chat_id(self, chat_id: str) -> "PutTopNoticeChatTopNoticeRequestBuilder":
        ...
        self._put_top_notice_chat_top_notice_request.paths["chat_id"] = chat_id
        return self

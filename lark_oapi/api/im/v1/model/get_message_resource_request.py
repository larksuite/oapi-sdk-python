...
class GetMessageResourceRequestBuilder(object):
    def __init__(self) -> None:
        ...
        get_message_resource_request.uri = (
            "/open-apis/im/v1/messages/:message_id/resources/:file_key"
        )
        get_message_resource_request.token_types = {
            AccessTokenType.TENANT,
            AccessTokenType.USER,
        }
        self._get_message_resource_request: GetMessageResourceRequest = (
            get_message_resource_request
        )

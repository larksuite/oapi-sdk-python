...
class DeleteChatMenuTreeRequestBuilder(object):
    def __init__(self) -> None:
        ...
        self._delete_chat_menu_tree_request: DeleteChatMenuTreeRequest = (
            delete_chat_menu_tree_request
        )
    ...
    def request_body(
        self, request_body: DeleteChatMenuTreeRequestBody
    ) -> "DeleteChatMenuTreeRequestBuilder":

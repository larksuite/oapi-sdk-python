...
class SortTabsChatTabRequestBuilder(object):
    def __init__(self) -> None:
        ...
        sort_tabs_chat_tab_request.uri = (
            "/open-apis/im/v1/chats/:chat_id/chat_tabs/sort_tabs"
        )
        sort_tabs_chat_tab_request.token_types = {
            AccessTokenType.TENANT,
            AccessTokenType.USER,
        }
        self._sort_tabs_chat_tab_request: SortTabsChatTabRequest = (
            sort_tabs_chat_tab_request
        )
    ...
    def request_body(
        self, request_body: SortTabsChatTabRequestBody
    ) -> "SortTabsChatTabRequestBuilder":

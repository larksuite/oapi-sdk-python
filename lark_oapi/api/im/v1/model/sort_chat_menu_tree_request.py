...
class SortChatMenuTreeRequestBuilder(object):
    def __init__(self) -> None:
        ...
        sort_chat_menu_tree_request.uri = (
            "/open-apis/im/v1/chats/:chat_id/menu_tree/sort"
        )
        sort_chat_menu_tree_request.token_types = {AccessTokenType.TENANT}
        self._sort_chat_menu_tree_request: SortChatMenuTreeRequest = (
            sort_chat_menu_tree_request
        )
    ...
    def request_body(
        self, request_body: SortChatMenuTreeRequestBody
    ) -> "SortChatMenuTreeRequestBuilder":

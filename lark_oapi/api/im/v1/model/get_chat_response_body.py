...
class GetChatResponseBodyBuilder(object):
    def __init__(self, get_chat_response_body: GetChatResponseBody = GetChatResponseBody({})) -> None:
        self._get_chat_response_body: GetChatResponseBody = get_chat_response_body

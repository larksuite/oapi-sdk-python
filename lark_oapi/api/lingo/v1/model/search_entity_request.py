...
class SearchEntityRequestBuilder(object):
    ...
    def __init__(self) -> None:
        ...
        search_entity_request.uri = "/open-apis/lingo/v1/entities/search"
    ...
    def repo_id(self, repo_id: int) -> "SearchEntityRequestBuilder":
        self._search_entity_request.repo_id = repo_id
        self._search_entity_request.add_query("repo_id", repo_id)
        return self

...
class Entity(object):
    ...
    def delete(
        self, request: DeleteEntityRequest, option: Optional[RequestOption] = None
        ...
        # 反序列化
        response: DeleteEntityResponse = JSON.unmarshal(
            str(resp.content, UTF_8), DeleteEntityResponse
        )
        response.raw = resp

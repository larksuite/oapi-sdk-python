...
class BatchUpdateLumpSumPaymentResponseBody(object):
    _types = {
    ...
    @staticmethod
    def builder() -> "BatchUpdateLumpSumPaymentResponseBodyBuilder":
        return BatchUpdateLumpSumPaymentResponseBodyBuilder()
...
class BatchUpdateLumpSumPaymentResponseBodyBuilder(object):
    ...
    def build(self) -> "BatchUpdateLumpSumPaymentResponseBody":
        return self._batch_update_lump_sum_payment_response_body

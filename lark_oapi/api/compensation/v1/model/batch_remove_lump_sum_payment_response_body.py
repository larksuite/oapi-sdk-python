...
class BatchRemoveLumpSumPaymentResponseBodyBuilder(object):
    def __init__(self) -> None:
        self._batch_remove_lump_sum_payment_response_body = (
            BatchRemoveLumpSumPaymentResponseBody()
        )

    def operate_results(
        self, operate_results: List[LumpSumPaymentOperateResult]
    ) -> "BatchRemoveLumpSumPaymentResponseBodyBuilder":
        self._batch_remove_lump_sum_payment_response_body.operate_results = (
            operate_results
        )
        return self

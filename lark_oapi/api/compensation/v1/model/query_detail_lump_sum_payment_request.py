...
class QueryDetailLumpSumPaymentRequest(BaseRequest):
    def __init__(self) -> None:
        ...
        self.request_body: Optional[QueryDetailLumpSumPaymentRequestBody] = None

    @staticmethod
    def builder() -> "QueryDetailLumpSumPaymentRequestBuilder":
        return QueryDetailLumpSumPaymentRequestBuilder()
...
class QueryDetailLumpSumPaymentRequestBuilder(object):
    ...
    def page_size(self, page_size: int) -> "QueryDetailLumpSumPaymentRequestBuilder":
        self._query_detail_lump_sum_payment_request.page_size = page_size
        self._query_detail_lump_sum_payment_request.add_query("page_size", page_size)
        return self

    def page_token(self, page_token: str) -> "QueryDetailLumpSumPaymentRequestBuilder":
        self._query_detail_lump_sum_payment_request.page_token = page_token
    ...
    def build(self) -> QueryDetailLumpSumPaymentRequest:
        return self._query_detail_lump_sum_payment_request

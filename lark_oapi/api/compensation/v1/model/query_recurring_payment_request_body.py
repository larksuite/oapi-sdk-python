...
class QueryRecurringPaymentRequestBody(object):
    _types = {
        "ids": List[str],
        "unique_ids": List[str],
        "user_ids": List[str],
    ...
    def __init__(self, d=None):
        ...
        self.start_date_gte: Optional[str] = None
        self.start_date_lte: Optional[str] = None
        self.end_date_gte: Optional[str] = None
        self.end_date_lte: Optional[str] = None
    ...
    @staticmethod
    def builder() -> "QueryRecurringPaymentRequestBodyBuilder":
        return QueryRecurringPaymentRequestBodyBuilder()


class QueryRecurringPaymentRequestBodyBuilder(object):
    def __init__(self) -> None:
        self._query_recurring_payment_request_body = QueryRecurringPaymentRequestBody()

    def ids(self, ids: List[str]) -> "QueryRecurringPaymentRequestBodyBuilder":
    ...
    def build(self) -> "QueryRecurringPaymentRequestBody":
        return self._query_recurring_payment_request_body

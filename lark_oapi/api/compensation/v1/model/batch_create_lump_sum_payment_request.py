...
class BatchCreateLumpSumPaymentRequestBuilder(object):
    def __init__(self) -> None:
        ...
        batch_create_lump_sum_payment_request.uri = (
    ...
    ) -> "BatchCreateLumpSumPaymentRequestBuilder":
        self._batch_create_lump_sum_payment_request.user_id_type = user_id_type
        self._batch_create_lump_sum_payment_request.add_query(
            "user_id_type", user_id_type
        )
        return self

    def request_body(
        self, request_body: BatchCreateLumpSumPaymentRequestBody
    ) -> "BatchCreateLumpSumPaymentRequestBuilder":

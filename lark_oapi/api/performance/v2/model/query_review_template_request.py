...
class QueryReviewTemplateRequestBuilder(object):
    def __init__(self) -> None:
        ...
        query_review_template_request.uri = (
            "/open-apis/performance/v2/review_templates/query"
        )
        query_review_template_request.token_types = {AccessTokenType.TENANT}
        self._query_review_template_request: QueryReviewTemplateRequest = (
            query_review_template_request
        )
    ...
    def request_body(
        self, request_body: QueryReviewTemplateRequestBody
    ) -> "QueryReviewTemplateRequestBuilder":

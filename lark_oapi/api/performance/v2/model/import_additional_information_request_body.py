...
class ImportAdditionalInformationRequestBodyBuilder(object):
    def __init__(self) -> None:
        self._import_additional_information_request_body = (
            ImportAdditionalInformationRequestBody()
        )

    def semester_id(
        self, semester_id: str
    ) -> "ImportAdditionalInformationRequestBodyBuilder":
    ...
    def additional_informations(
        ...
        self._import_additional_information_request_body.additional_informations = (
    ...
    def import_record_name(
        ...
        self._import_additional_information_request_body.import_record_name = (
            import_record_name
        )
        return self

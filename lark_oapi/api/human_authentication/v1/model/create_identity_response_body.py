...
class CreateIdentityResponseBodyBuilder(object):
    def __init__(self, create_identity_response_body: CreateIdentityResponseBody = CreateIdentityResponseBody({})) -> None:
        self._create_identity_response_body: CreateIdentityResponseBody = create_identity_response_body

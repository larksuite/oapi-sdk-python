...
class V1(object):
    def __init__(self, config: Config) -> None:
        ...
        self.application_environment_variable: ApplicationEnvironmentVariable = (
            ApplicationEnvironmentVariable(config)
        )
        ...
        self.application_object_record: ApplicationObjectRecord = (
            ApplicationObjectRecord(config)
        )
        self.application_record_permission_member: ApplicationRecordPermissionMember = (
            ApplicationRecordPermissionMember(config)
        )
        self.application_role_member: ApplicationRoleMember = ApplicationRoleMember(
            config
        )
        ...
        self.tenant_app_metrics: TenantAppMetrics = TenantAppMetrics(config)

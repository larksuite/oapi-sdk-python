...
class BatchRemoveAuthorizationApplicationRecordPermissionMemberRequest(BaseRequest):
    ...
    @staticmethod
    def builder() -> (
        "BatchRemoveAuthorizationApplicationRecordPermissionMemberRequestBuilder"
    ):
...
class BatchRemoveAuthorizationApplicationRecordPermissionMemberRequestBuilder(object):
    def __init__(self) -> None:
        batch_remove_authorization_application_record_permission_member_request = (
        ...
        batch_remove_authorization_application_record_permission_member_request.token_types = {
    ...
    def request_body(
        self,
        request_body: BatchRemoveAuthorizationApplicationRecordPermissionMemberRequestBody,
    ) -> "BatchRemoveAuthorizationApplicationRecordPermissionMemberRequestBuilder":

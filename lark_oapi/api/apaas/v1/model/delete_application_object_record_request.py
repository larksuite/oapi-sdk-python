...
class DeleteApplicationObjectRecordRequestBuilder(object):
    def __init__(self) -> None:
        delete_application_object_record_request = (
    ...
    def namespace(
        self, namespace: str
    ) -> "DeleteApplicationObjectRecordRequestBuilder":
        self._delete_application_object_record_request.namespace = namespace
        self._delete_application_object_record_request.paths["namespace"] = str(
            namespace
        )
        return self
    ...
    def object_api_name(
        ...
        self._delete_application_object_record_request.paths["object_api_name"] = str(
            object_api_name
        )
        return self

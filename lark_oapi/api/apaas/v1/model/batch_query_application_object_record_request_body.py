...
class BatchQueryApplicationObjectRecordRequestBodyBuilder(object):
    def __init__(self) -> None:
        self._batch_query_application_object_record_request_body = (
            BatchQueryApplicationObjectRecordRequestBody()
        )

    def select(
        self, select: List[str]
    ) -> "BatchQueryApplicationObjectRecordRequestBodyBuilder":
    ...
    def use_page_token(
        self, use_page_token: bool
    ) -> "BatchQueryApplicationObjectRecordRequestBodyBuilder":
        self._batch_query_application_object_record_request_body.use_page_token = (
            use_page_token
        )
        return self
    ...
    def need_total_count(
        self, need_total_count: bool
    ) -> "BatchQueryApplicationObjectRecordRequestBodyBuilder":
        self._batch_query_application_object_record_request_body.need_total_count = (
            need_total_count
        )
        return self

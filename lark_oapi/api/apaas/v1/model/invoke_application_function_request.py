...
from .invoke_application_function_request_body import (
    InvokeApplicationFunctionRequestBody,
)
...
class InvokeApplicationFunctionRequestBuilder(object):
    def __init__(self) -> None:
        ...
        self._invoke_application_function_request: InvokeApplicationFunctionRequest = (
            invoke_application_function_request
        )
    ...
    def function_api_name(
        self, function_api_name: str
    ) -> "InvokeApplicationFunctionRequestBuilder":
        self._invoke_application_function_request.function_api_name = function_api_name
        self._invoke_application_function_request.paths["function_api_name"] = str(
            function_api_name
        )
        return self

    def request_body(
        self, request_body: InvokeApplicationFunctionRequestBody
    ) -> "InvokeApplicationFunctionRequestBuilder":

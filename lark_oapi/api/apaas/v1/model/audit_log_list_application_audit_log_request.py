...
class AuditLogListApplicationAuditLogRequestBuilder(object):
    ...
    def page_size(
        self, page_size: str
    ) -> "AuditLogListApplicationAuditLogRequestBuilder":
        self._audit_log_list_application_audit_log_request.page_size = page_size
        self._audit_log_list_application_audit_log_request.add_query(
            "page_size", page_size
        )
        return self
    ...
    def from_(self, from_: str) -> "AuditLogListApplicationAuditLogRequestBuilder":
        ...
        self._audit_log_list_application_audit_log_request.add_query("from", from_)
        return self
    ...
    def namespace(
        ...
        self._audit_log_list_application_audit_log_request.paths["namespace"] = str(
            namespace
        )
        return self

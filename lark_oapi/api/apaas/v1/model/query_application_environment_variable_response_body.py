...
class QueryApplicationEnvironmentVariableResponseBodyBuilder(object):
    def __init__(self) -> None:
        self._query_application_environment_variable_response_body = (
            QueryApplicationEnvironmentVariableResponseBody()
        )

    def items(
        self, items: List[EnvironmentVariable]
    ) -> "QueryApplicationEnvironmentVariableResponseBodyBuilder":

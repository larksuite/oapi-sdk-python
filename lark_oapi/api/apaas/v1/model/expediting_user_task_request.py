...
class ExpeditingUserTaskRequestBuilder(object):
    def __init__(self) -> None:
        ...
        expediting_user_task_request.uri = (
            "/open-apis/apaas/v1/user_tasks/:task_id/expediting"
        )
        expediting_user_task_request.token_types = {AccessTokenType.TENANT}
        self._expediting_user_task_request: ExpeditingUserTaskRequest = (
            expediting_user_task_request
        )
    ...
    def request_body(
        self, request_body: ExpeditingUserTaskRequestBody
    ) -> "ExpeditingUserTaskRequestBuilder":

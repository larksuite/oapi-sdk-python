...
class PatchSystemStatusRequestBuilder(object):
    def __init__(self) -> None:
        ...
        patch_system_status_request.uri = (
        ...
        self._patch_system_status_request: PatchSystemStatusRequest = (
            patch_system_status_request
        )

    def system_status_id(
        self, system_status_id: int
    ) -> "PatchSystemStatusRequestBuilder":
        self._patch_system_status_request.system_status_id = system_status_id
        self._patch_system_status_request.paths["system_status_id"] = str(
            system_status_id
        )
        return self

    def request_body(
        self, request_body: PatchSystemStatusRequestBody
    ) -> "PatchSystemStatusRequestBuilder":

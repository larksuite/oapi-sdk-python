...
class BatchCloseSystemStatusResponseBodyBuilder(object):
    def __init__(self, batch_close_system_status_response_body: BatchCloseSystemStatusResponseBody = BatchCloseSystemStatusResponseBody({})) -> None:
        self._batch_close_system_status_response_body: BatchCloseSystemStatusResponseBody = batch_close_system_status_response_body

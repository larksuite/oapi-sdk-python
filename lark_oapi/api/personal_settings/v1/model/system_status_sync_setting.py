...
class SystemStatusSyncSettingBuilder(object):
    def __init__(self, system_status_sync_setting: SystemStatusSyncSetting = SystemStatusSyncSetting({})) -> None:
        self._system_status_sync_setting: SystemStatusSyncSetting = system_status_sync_setting

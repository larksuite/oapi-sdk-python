...
class BatchCloseSystemStatusRequestBuilder(object):
    def __init__(self) -> None:
        ...
        self._batch_close_system_status_request: BatchCloseSystemStatusRequest = (
            batch_close_system_status_request
        )
    ...
    ) -> "BatchCloseSystemStatusRequestBuilder":
        self._batch_close_system_status_request.system_status_id = system_status_id
        self._batch_close_system_status_request.paths["system_status_id"] = str(
            system_status_id
        )
        return self

    def request_body(
        self, request_body: BatchCloseSystemStatusRequestBody
    ) -> "BatchCloseSystemStatusRequestBuilder":

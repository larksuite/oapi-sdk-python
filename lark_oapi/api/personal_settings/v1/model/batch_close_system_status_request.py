...
class BatchCloseSystemStatusRequestBuilder(object):
    ...
    def __init__(self, batch_close_system_status_request: BatchCloseSystemStatusRequest = BatchCloseSystemStatusRequest()) -> None:
    ...
    def user_id_type(self, user_id_type: str) -> "BatchCloseSystemStatusRequestBuilder":
        ...
        self._batch_close_system_status_request.queries["user_id_type"] = str(user_id_type)
        return self
    ...
    def system_status_id(self, system_status_id: int) -> "BatchCloseSystemStatusRequestBuilder":
        ...
        self._batch_close_system_status_request.paths["system_status_id"] = system_status_id
        return self

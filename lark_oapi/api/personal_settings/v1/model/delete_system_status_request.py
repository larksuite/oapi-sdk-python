...
class DeleteSystemStatusRequestBuilder(object):
    ...
    def __init__(self, delete_system_status_request: DeleteSystemStatusRequest = DeleteSystemStatusRequest()) -> None:
    ...
    def system_status_id(self, system_status_id: int) -> "DeleteSystemStatusRequestBuilder":
        ...
        self._delete_system_status_request.paths["system_status_id"] = system_status_id
        return self

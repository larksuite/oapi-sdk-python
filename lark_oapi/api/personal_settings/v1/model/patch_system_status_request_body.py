...
class PatchSystemStatusRequestBodyBuilder(object):
    def __init__(self, patch_system_status_request_body: PatchSystemStatusRequestBody = PatchSystemStatusRequestBody({})) -> None:
        self._patch_system_status_request_body: PatchSystemStatusRequestBody = patch_system_status_request_body

...
class SystemStatusI18nNameBuilder(object):
    def __init__(self, system_status_i18n_name: SystemStatusI18nName = SystemStatusI18nName({})) -> None:
        self._system_status_i18n_name: SystemStatusI18nName = system_status_i18n_name

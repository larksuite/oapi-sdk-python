...
class SystemStatusUserOpenResultEntityBuilder(object):
    def __init__(self, system_status_user_open_result_entity: SystemStatusUserOpenResultEntity = SystemStatusUserOpenResultEntity({})) -> None:
        self._system_status_user_open_result_entity: SystemStatusUserOpenResultEntity = system_status_user_open_result_entity

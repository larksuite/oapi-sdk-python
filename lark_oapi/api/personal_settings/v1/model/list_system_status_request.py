...
class ListSystemStatusRequestBuilder(object):
    ...
    def __init__(self, list_system_status_request: ListSystemStatusRequest = ListSystemStatusRequest()) -> None:
    ...
    def page_size(self, page_size: int) -> "ListSystemStatusRequestBuilder":
        ...
        self._list_system_status_request.queries["page_size"] = str(page_size)
        return self

    def page_token(self, page_token: str) -> "ListSystemStatusRequestBuilder":
        self._list_system_status_request.page_token = page_token
        self._list_system_status_request.queries["page_token"] = str(page_token)
        return self

...
class ListSystemStatusResponseBodyBuilder(object):
    def __init__(self, list_system_status_response_body: ListSystemStatusResponseBody = ListSystemStatusResponseBody({})) -> None:
        self._list_system_status_response_body: ListSystemStatusResponseBody = list_system_status_response_body

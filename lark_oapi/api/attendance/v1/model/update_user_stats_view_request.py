...
class UpdateUserStatsViewRequestBuilder(object):
    def __init__(self) -> None:
        ...
        update_user_stats_view_request.uri = (
        ...
        self._update_user_stats_view_request: UpdateUserStatsViewRequest = (
            update_user_stats_view_request
        )
    ...
    def user_stats_view_id(
        self, user_stats_view_id: str
    ) -> "UpdateUserStatsViewRequestBuilder":
        self._update_user_stats_view_request.user_stats_view_id = user_stats_view_id
        self._update_user_stats_view_request.paths["user_stats_view_id"] = str(
            user_stats_view_id
        )
        return self

    def request_body(
        self, request_body: UpdateUserStatsViewRequestBody
    ) -> "UpdateUserStatsViewRequestBuilder":

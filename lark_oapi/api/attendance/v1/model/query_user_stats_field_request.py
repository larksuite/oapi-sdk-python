...
class QueryUserStatsFieldRequestBuilder(object):
    def __init__(self) -> None:
        ...
        query_user_stats_field_request.uri = (
            "/open-apis/attendance/v1/user_stats_fields/query"
        )
        query_user_stats_field_request.token_types = {AccessTokenType.TENANT}
        self._query_user_stats_field_request: QueryUserStatsFieldRequest = (
            query_user_stats_field_request
        )
    ...
    def request_body(
        self, request_body: QueryUserStatsFieldRequestBody
    ) -> "QueryUserStatsFieldRequestBuilder":

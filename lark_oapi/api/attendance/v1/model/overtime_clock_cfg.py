...
class OvertimeClockCfgBuilder(object):
    ...
    def allow_punch_approval(
        self, allow_punch_approval: bool
    ) -> "OvertimeClockCfgBuilder":
        self._overtime_clock_cfg.allow_punch_approval = allow_punch_approval
        return self

    def need_clock_over_time_start_and_end(
        self, need_clock_over_time_start_and_end: bool
    ) -> "OvertimeClockCfgBuilder":
        self._overtime_clock_cfg.need_clock_over_time_start_and_end = (
            need_clock_over_time_start_and_end
        )
        return self

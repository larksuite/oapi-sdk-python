...
class ShiftAttendanceTimeConfigBuilder(object):
    ...
    def attendance_time(
        self, attendance_time: float
    ) -> "ShiftAttendanceTimeConfigBuilder":
        self._shift_attendance_time_config.attendance_time = attendance_time
        return self

    def on_attendance_time(
        self, on_attendance_time: float
    ) -> "ShiftAttendanceTimeConfigBuilder":
        self._shift_attendance_time_config.on_attendance_time = on_attendance_time
        return self

    def off_attendance_time(
        self, off_attendance_time: float
    ) -> "ShiftAttendanceTimeConfigBuilder":

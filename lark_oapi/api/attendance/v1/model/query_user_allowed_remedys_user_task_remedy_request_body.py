...
class QueryUserAllowedRemedysUserTaskRemedyRequestBodyBuilder(object):
    def __init__(self, query_user_allowed_remedys_user_task_remedy_request_body: QueryUserAllowedRemedysUserTaskRemedyRequestBody = QueryUserAllowedRemedysUserTaskRemedyRequestBody({})) -> None:

...
class QueryUserAllowedRemedysUserTaskRemedyResponseBodyBuilder(object):
    def __init__(self) -> None:
        self._query_user_allowed_remedys_user_task_remedy_response_body = (
            QueryUserAllowedRemedysUserTaskRemedyResponseBody()
        )

    def user_allowed_remedys(
        self, user_allowed_remedys: List[UserAllowedRemedy]
    ) -> "QueryUserAllowedRemedysUserTaskRemedyResponseBodyBuilder":

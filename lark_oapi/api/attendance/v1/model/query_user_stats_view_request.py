...
class QueryUserStatsViewRequestBuilder(object):
    def __init__(self) -> None:
        ...
        query_user_stats_view_request.uri = (
            "/open-apis/attendance/v1/user_stats_views/query"
        )
        query_user_stats_view_request.token_types = {AccessTokenType.TENANT}
        self._query_user_stats_view_request: QueryUserStatsViewRequest = (
            query_user_stats_view_request
        )
    ...
    def request_body(
        self, request_body: QueryUserStatsViewRequestBody
    ) -> "QueryUserStatsViewRequestBuilder":

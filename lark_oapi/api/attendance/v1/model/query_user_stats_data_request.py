...
class QueryUserStatsDataRequestBuilder(object):
    def __init__(self) -> None:
        ...
        query_user_stats_data_request.uri = (
            "/open-apis/attendance/v1/user_stats_datas/query"
        )
        query_user_stats_data_request.token_types = {AccessTokenType.TENANT}
        self._query_user_stats_data_request: QueryUserStatsDataRequest = (
            query_user_stats_data_request
        )
    ...
    def request_body(
        self, request_body: QueryUserStatsDataRequestBody
    ) -> "QueryUserStatsDataRequestBuilder":

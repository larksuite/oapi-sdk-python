...
class GetShiftResponseBodyBuilder(object):
    ...
    def sub_shift_leader_ids(
        self, sub_shift_leader_ids: List[str]
    ) -> "GetShiftResponseBodyBuilder":
    ...
    def flexible_rule(
        self, flexible_rule: List[FlexibleRule]
    ) -> "GetShiftResponseBodyBuilder":
    ...
    def punch_time_rule(
        self, punch_time_rule: List[PunchTimeRule]
    ) -> "GetShiftResponseBodyBuilder":
    ...
    def rest_time_rule(
        self, rest_time_rule: List[RestRule]
    ) -> "GetShiftResponseBodyBuilder":
        self._get_shift_response_body.rest_time_rule = rest_time_rule
        return self

    def overtime_rule(
        self, overtime_rule: List[OvertimeRule]
    ) -> "GetShiftResponseBodyBuilder":
    ...
    def late_minutes_as_serious_late(
        ...
        self._get_shift_response_body.late_minutes_as_serious_late = (
    ...
    def shift_attendance_time_config(
        ...
        self._get_shift_response_body.shift_attendance_time_config = (
    ...
    def late_off_late_on_setting(
        ...
        self._get_shift_response_body.late_off_late_on_setting = (
    ...
    def rest_time_flexible_configs(
        ...
        self._get_shift_response_body.rest_time_flexible_configs = (

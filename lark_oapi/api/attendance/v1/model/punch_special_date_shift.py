...
class PunchSpecialDateShiftBuilder(object):
    def __init__(self, punch_special_date_shift: PunchSpecialDateShift = PunchSpecialDateShift({})) -> None:
        self._punch_special_date_shift: PunchSpecialDateShift = punch_special_date_shift

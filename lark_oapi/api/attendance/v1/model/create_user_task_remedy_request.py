...
class CreateUserTaskRemedyRequestBuilder(object):
    ...
    def __init__(self, create_user_task_remedy_request: CreateUserTaskRemedyRequest = CreateUserTaskRemedyRequest()) -> None:
    ...
    def employee_type(self, employee_type: str) -> "CreateUserTaskRemedyRequestBuilder":
        ...
        self._create_user_task_remedy_request.queries["employee_type"] = str(employee_type)
        return self

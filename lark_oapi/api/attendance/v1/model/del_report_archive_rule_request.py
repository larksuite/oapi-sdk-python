...
class DelReportArchiveRuleRequestBuilder(object):
    def __init__(self) -> None:
        ...
        del_report_archive_rule_request.uri = (
            "/open-apis/attendance/v1/archive_rule/del_report"
        )
        del_report_archive_rule_request.token_types = {
            AccessTokenType.TENANT,
            AccessTokenType.USER,
        }
        self._del_report_archive_rule_request: DelReportArchiveRuleRequest = (
            del_report_archive_rule_request
        )
    ...
    def request_body(
        self, request_body: DelReportArchiveRuleRequestBody
    ) -> "DelReportArchiveRuleRequestBuilder":

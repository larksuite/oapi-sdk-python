...
class QueryUserTaskRemedyRequestBuilder(object):
    def __init__(self) -> None:
        ...
        query_user_task_remedy_request.uri = (
            "/open-apis/attendance/v1/user_task_remedys/query"
        )
        query_user_task_remedy_request.token_types = {AccessTokenType.TENANT}
        self._query_user_task_remedy_request: QueryUserTaskRemedyRequest = (
            query_user_task_remedy_request
        )
    ...
    def request_body(
        self, request_body: QueryUserTaskRemedyRequestBody
    ) -> "QueryUserTaskRemedyRequestBuilder":

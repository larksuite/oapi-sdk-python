...
class CreateUserApprovalRequestBuilder(object):
    ...
    def __init__(self, create_user_approval_request: CreateUserApprovalRequest = CreateUserApprovalRequest()) -> None:
    ...
    def employee_type(self, employee_type: str) -> "CreateUserApprovalRequestBuilder":
        ...
        self._create_user_approval_request.queries["employee_type"] = str(employee_type)
        return self

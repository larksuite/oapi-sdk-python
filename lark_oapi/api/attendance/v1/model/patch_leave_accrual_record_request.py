...
class PatchLeaveAccrualRecordRequestBuilder(object):
    ...
    def __init__(self, patch_leave_accrual_record_request: PatchLeaveAccrualRecordRequest = PatchLeaveAccrualRecordRequest()) -> None:
    ...
    def user_id_type(self, user_id_type: str) -> "PatchLeaveAccrualRecordRequestBuilder":
        ...
        self._patch_leave_accrual_record_request.queries["user_id_type"] = str(user_id_type)
        return self
    ...
    def leave_id(self, leave_id: str) -> "PatchLeaveAccrualRecordRequestBuilder":
        ...
        self._patch_leave_accrual_record_request.paths["leave_id"] = leave_id
        return self

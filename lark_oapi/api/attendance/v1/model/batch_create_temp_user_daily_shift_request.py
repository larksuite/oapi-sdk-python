...
class BatchCreateTempUserDailyShiftRequestBuilder(object):
    ...
    ) -> "BatchCreateTempUserDailyShiftRequestBuilder":
        self._batch_create_temp_user_daily_shift_request.employee_type = employee_type
        self._batch_create_temp_user_daily_shift_request.add_query(
            "employee_type", employee_type
        )
        return self

    def request_body(
        self, request_body: BatchCreateTempUserDailyShiftRequestBody
    ) -> "BatchCreateTempUserDailyShiftRequestBuilder":

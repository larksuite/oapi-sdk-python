...
class QueryUserTaskResponseBodyBuilder(object):
    ...
    def user_task_results(
        self, user_task_results: List[UserTask]
    ) -> "QueryUserTaskResponseBodyBuilder":
        self._query_user_task_response_body.user_task_results = user_task_results
        return self

    def invalid_user_ids(
        self, invalid_user_ids: List[str]
    ) -> "QueryUserTaskResponseBodyBuilder":
        self._query_user_task_response_body.invalid_user_ids = invalid_user_ids
        return self

    def unauthorized_user_ids(
        self, unauthorized_user_ids: List[str]
    ) -> "QueryUserTaskResponseBodyBuilder":
        self._query_user_task_response_body.unauthorized_user_ids = (

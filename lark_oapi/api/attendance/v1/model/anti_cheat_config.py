...
class AntiCheatConfigBuilder(object):
    ...
    def intercept_suspected_cheat_punch(
        self, intercept_suspected_cheat_punch: bool
    ) -> "AntiCheatConfigBuilder":
        self._anti_cheat_config.intercept_suspected_cheat_punch = (
            intercept_suspected_cheat_punch
        )
        return self

    def check_cheat_software_punch(
        self, check_cheat_software_punch: bool
    ) -> "AntiCheatConfigBuilder":
    ...
    def check_simulate_wifi_punch(
        self, check_simulate_wifi_punch: bool
    ) -> "AntiCheatConfigBuilder":
        self._anti_cheat_config.check_simulate_wifi_punch = check_simulate_wifi_punch
        return self

    def check_change_device_punch(
        self, check_change_device_punch: bool
    ) -> "AntiCheatConfigBuilder":
        self._anti_cheat_config.check_change_device_punch = check_change_device_punch
        return self

    def allow_change_device_num(
        self, allow_change_device_num: int
    ) -> "AntiCheatConfigBuilder":
        self._anti_cheat_config.allow_change_device_num = allow_change_device_num
        return self

    def suspected_cheat_handle_method(
        self, suspected_cheat_handle_method: int
    ) -> "AntiCheatConfigBuilder":
        self._anti_cheat_config.suspected_cheat_handle_method = (
            suspected_cheat_handle_method
        )
        return self

...
class QueryUserApprovalRequestBuilder(object):
    def __init__(self) -> None:
        ...
        query_user_approval_request.uri = (
            "/open-apis/attendance/v1/user_approvals/query"
        )
        query_user_approval_request.token_types = {AccessTokenType.TENANT}
        self._query_user_approval_request: QueryUserApprovalRequest = (
            query_user_approval_request
        )
    ...
    def request_body(
        self, request_body: QueryUserApprovalRequestBody
    ) -> "QueryUserApprovalRequestBuilder":

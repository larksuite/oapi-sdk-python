...
class ModifyUserSettingRequestBuilder(object):
    def __init__(self) -> None:
        ...
        modify_user_setting_request.uri = (
            "/open-apis/attendance/v1/user_settings/modify"
        )
        modify_user_setting_request.token_types = {AccessTokenType.TENANT}
        self._modify_user_setting_request: ModifyUserSettingRequest = (
            modify_user_setting_request
        )
    ...
    def request_body(
        self, request_body: ModifyUserSettingRequestBody
    ) -> "ModifyUserSettingRequestBuilder":

...
class QueryUserAllowedRemedysUserTaskRemedyRequestBuilder(object):
    ...
    def __init__(self, query_user_allowed_remedys_user_task_remedy_request: QueryUserAllowedRemedysUserTaskRemedyRequest = QueryUserAllowedRemedysUserTaskRemedyRequest()) -> None:
    ...
    def employee_type(self, employee_type: str) -> "QueryUserAllowedRemedysUserTaskRemedyRequestBuilder":
        ...
        self._query_user_allowed_remedys_user_task_remedy_request.queries["employee_type"] = str(employee_type)
        return self

...
from .query_user_allowed_remedys_user_task_remedy_request_body import (
    QueryUserAllowedRemedysUserTaskRemedyRequestBody,
)
...
class QueryUserAllowedRemedysUserTaskRemedyRequestBuilder(object):
    def __init__(self) -> None:
        query_user_allowed_remedys_user_task_remedy_request = (
            QueryUserAllowedRemedysUserTaskRemedyRequest()
        )
        query_user_allowed_remedys_user_task_remedy_request.http_method = (
            HttpMethod.POST
        )
        query_user_allowed_remedys_user_task_remedy_request.uri = (
            "/open-apis/attendance/v1/user_task_remedys/query_user_allowed_remedys"
        )
        query_user_allowed_remedys_user_task_remedy_request.token_types = {
    ...
    ) -> "QueryUserAllowedRemedysUserTaskRemedyRequestBuilder":
        self._query_user_allowed_remedys_user_task_remedy_request.employee_type = (
            employee_type
        )
        self._query_user_allowed_remedys_user_task_remedy_request.add_query(
            "employee_type", employee_type
        )
        return self

    def request_body(
        self, request_body: QueryUserAllowedRemedysUserTaskRemedyRequestBody
    ) -> "QueryUserAllowedRemedysUserTaskRemedyRequestBuilder":
        self._query_user_allowed_remedys_user_task_remedy_request.request_body = (
            request_body
        )

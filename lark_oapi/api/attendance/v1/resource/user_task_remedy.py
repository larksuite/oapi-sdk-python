...
from lark_oapi.api.attendance.v1.model.query_user_allowed_remedys_user_task_remedy_request import QueryUserAllowedRemedysUserTaskRemedyRequest
from lark_oapi.api.attendance.v1.model.query_user_allowed_remedys_user_task_remedy_response import QueryUserAllowedRemedysUserTaskRemedyResponse
...
class UserTaskRemedy(object):
    ...
    def create(self, request: CreateUserTaskRemedyRequest, option: RequestOption = RequestOption()) -> CreateUserTaskRemedyResponse:
        # 鉴权、获取token
    ...
    def query(self, request: QueryUserTaskRemedyRequest, option: RequestOption = RequestOption()) -> QueryUserTaskRemedyResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def query_user_allowed_remedys(self, request: QueryUserAllowedRemedysUserTaskRemedyRequest, option: RequestOption = RequestOption()) -> QueryUserAllowedRemedysUserTaskRemedyResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

...
class UserStatsView(object):
    ...
    def query(self, request: QueryUserStatsViewRequest, option: RequestOption = RequestOption()) -> QueryUserStatsViewResponse:
        # 鉴权、获取token
    ...
    def update(self, request: UpdateUserStatsViewRequest, option: RequestOption = RequestOption()) -> UpdateUserStatsViewResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

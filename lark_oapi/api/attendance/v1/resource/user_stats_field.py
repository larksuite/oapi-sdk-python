...
class UserStatsField(object):
    ...
    def query(self, request: QueryUserStatsFieldRequest, option: Optional[RequestOption] = None) -> QueryUserStatsFieldResponse:
        if option is None:
    ...
    async def aquery(self, request: QueryUserStatsFieldRequest, option: Optional[RequestOption] = None) -> QueryUserStatsFieldResponse:
        if option is None:
            option = RequestOption()

...
class User(object):
    ...
    def batch_get_id(self, request: BatchGetIdUserRequest, option: RequestOption = RequestOption()) -> BatchGetIdUserResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def find_by_department(self, request: FindByDepartmentUserRequest, option: RequestOption = RequestOption()) -> FindByDepartmentUserResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def resurrect(self, request: ResurrectUserRequest, option: RequestOption = RequestOption()) -> ResurrectUserResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

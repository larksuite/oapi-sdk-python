...
class GroupMember(object):
    ...
    def batch_add(self, request: BatchAddGroupMemberRequest, option: RequestOption = RequestOption()) -> BatchAddGroupMemberResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def batch_remove(self, request: BatchRemoveGroupMemberRequest, option: RequestOption = RequestOption()) -> BatchRemoveGroupMemberResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def remove(self, request: RemoveGroupMemberRequest, option: RequestOption = RequestOption()) -> RemoveGroupMemberResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def simplelist(self, request: SimplelistGroupMemberRequest, option: RequestOption = RequestOption()) -> SimplelistGroupMemberResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

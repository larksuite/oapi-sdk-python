...
class Department(object):
    ...
    async def abatch(self, request: BatchDepartmentRequest, option: Optional[RequestOption] = None) -> BatchDepartmentResponse:
        if option is None:
            option = RequestOption()
    ...
    def children(self, request: ChildrenDepartmentRequest, option: Optional[RequestOption] = None) -> ChildrenDepartmentResponse:
        if option is None:
            option = RequestOption()
    ...
    async def achildren(self, request: ChildrenDepartmentRequest, option: Optional[RequestOption] = None) -> ChildrenDepartmentResponse:
        if option is None:
            option = RequestOption()
    ...
    def create(self, request: CreateDepartmentRequest, option: Optional[RequestOption] = None) -> CreateDepartmentResponse:
        if option is None:
            option = RequestOption()
    ...
    async def acreate(self, request: CreateDepartmentRequest, option: Optional[RequestOption] = None) -> CreateDepartmentResponse:
        if option is None:
            option = RequestOption()
    ...
    async def aget(self, request: GetDepartmentRequest, option: Optional[RequestOption] = None) -> GetDepartmentResponse:
        if option is None:
            option = RequestOption()
    ...
    async def alist(self, request: ListDepartmentRequest, option: Optional[RequestOption] = None) -> ListDepartmentResponse:
        if option is None:
            option = RequestOption()
    ...
    def parent(self, request: ParentDepartmentRequest, option: Optional[RequestOption] = None) -> ParentDepartmentResponse:
        if option is None:
            option = RequestOption()
    ...
    async def aparent(self, request: ParentDepartmentRequest, option: Optional[RequestOption] = None) -> ParentDepartmentResponse:
        if option is None:
            option = RequestOption()
    ...
    def unbind_department_chat(self, request: UnbindDepartmentChatDepartmentRequest, option: Optional[RequestOption] = None) -> UnbindDepartmentChatDepartmentResponse:
        if option is None:
            option = RequestOption()
    ...
    async def aunbind_department_chat(self, request: UnbindDepartmentChatDepartmentRequest, option: Optional[RequestOption] = None) -> UnbindDepartmentChatDepartmentResponse:
        if option is None:
            option = RequestOption()
    ...
    def update(self, request: UpdateDepartmentRequest, option: Optional[RequestOption] = None) -> UpdateDepartmentResponse:
        if option is None:
            option = RequestOption()
    ...
    async def aupdate(self, request: UpdateDepartmentRequest, option: Optional[RequestOption] = None) -> UpdateDepartmentResponse:
        if option is None:
            option = RequestOption()
    ...
    def update_department_id(self, request: UpdateDepartmentIdDepartmentRequest, option: Optional[RequestOption] = None) -> UpdateDepartmentIdDepartmentResponse:
        if option is None:
            option = RequestOption()
        ...
        # 反序列化
        response: UpdateDepartmentIdDepartmentResponse = JSON.unmarshal(str(resp.content, UTF_8), UpdateDepartmentIdDepartmentResponse)
        response.raw = resp

        return response
        

    async def aupdate_department_id(self, request: UpdateDepartmentIdDepartmentRequest, option: Optional[RequestOption] = None) -> UpdateDepartmentIdDepartmentResponse:
        if option is None:
            option = RequestOption()

...
class Group(object):
    ...
    def member_belong(self, request: MemberBelongGroupRequest, option: RequestOption = RequestOption()) -> MemberBelongGroupResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def simplelist(self, request: SimplelistGroupRequest, option: RequestOption = RequestOption()) -> SimplelistGroupResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

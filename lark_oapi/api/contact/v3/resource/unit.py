...
class Unit(object):
    ...
    def bind_department(self, request: BindDepartmentUnitRequest, option: RequestOption = RequestOption()) -> BindDepartmentUnitResponse:
        # 鉴权、获取token
    ...
    def list_department(self, request: ListDepartmentUnitRequest, option: RequestOption = RequestOption()) -> ListDepartmentUnitResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def unbind_department(self, request: UnbindDepartmentUnitRequest, option: RequestOption = RequestOption()) -> UnbindDepartmentUnitResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

...
class BatchDeleteFunctionalRoleMemberRequestBodyBuilder(object):
    def __init__(self, batch_delete_functional_role_member_request_body: BatchDeleteFunctionalRoleMemberRequestBody = BatchDeleteFunctionalRoleMemberRequestBody({})) -> None:

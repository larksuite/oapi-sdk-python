...
class ListUserRequestBuilder(object):
    ...
    def user_id_type(self, user_id_type: str) -> "ListUserRequestBuilder":
        ...
        self._list_user_request.queries["user_id_type"] = str(user_id_type)
        return self

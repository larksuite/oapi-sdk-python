...
class RemoveGroupMemberRequestBuilder(object):
    ...
    def request_body(
        self, request_body: RemoveGroupMemberRequestBody
    ) -> "RemoveGroupMemberRequestBuilder":

...
class BatchRemoveGroupMemberRequestBuilder(object):
    def __init__(self) -> None:
        ...
        batch_remove_group_member_request.uri = (
        ...
        self._batch_remove_group_member_request: BatchRemoveGroupMemberRequest = (
            batch_remove_group_member_request
        )
    ...
    def request_body(
        self, request_body: BatchRemoveGroupMemberRequestBody
    ) -> "BatchRemoveGroupMemberRequestBuilder":

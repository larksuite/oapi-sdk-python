...
class BatchDeleteFunctionalRoleMemberResponseBodyBuilder(object):
    def __init__(self, batch_delete_functional_role_member_response_body: BatchDeleteFunctionalRoleMemberResponseBody = BatchDeleteFunctionalRoleMemberResponseBody({})) -> None:

...
class BatchDeleteFunctionalRoleMemberResponseBodyBuilder(object):
    def __init__(self) -> None:
        self._batch_delete_functional_role_member_response_body = (
            BatchDeleteFunctionalRoleMemberResponseBody()
        )

    def result(
        self, result: List[FunctionalRoleMemberResult]
    ) -> "BatchDeleteFunctionalRoleMemberResponseBodyBuilder":

...
class GetDepartmentRequestBuilder(object):
    ...
    def __init__(self, get_department_request: GetDepartmentRequest = GetDepartmentRequest()) -> None:
    ...
    def user_id_type(self, user_id_type: str) -> "GetDepartmentRequestBuilder":
        ...
        self._get_department_request.queries["user_id_type"] = str(user_id_type)
        return self
    ...
    def department_id_type(self, department_id_type: str) -> "GetDepartmentRequestBuilder":
        ...
        self._get_department_request.queries["department_id_type"] = str(department_id_type)
        return self
    ...
    def department_id(self, department_id: str) -> "GetDepartmentRequestBuilder":
        ...
        self._get_department_request.paths["department_id"] = department_id
        return self

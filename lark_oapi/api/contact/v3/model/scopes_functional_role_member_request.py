...
class ScopesFunctionalRoleMemberRequestBuilder(object):
    def __init__(self) -> None:
        ...
        scopes_functional_role_member_request.uri = (
    ...
    ) -> "ScopesFunctionalRoleMemberRequestBuilder":
        self._scopes_functional_role_member_request.user_id_type = user_id_type
        self._scopes_functional_role_member_request.add_query(
    ...
    def department_id_type(
        ...
        self._scopes_functional_role_member_request.department_id_type = (
            department_id_type
        )
        self._scopes_functional_role_member_request.add_query(
    ...
    def request_body(
        self, request_body: ScopesFunctionalRoleMemberRequestBody
    ) -> "ScopesFunctionalRoleMemberRequestBuilder":

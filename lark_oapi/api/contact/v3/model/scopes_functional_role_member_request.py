...
class ScopesFunctionalRoleMemberRequestBuilder(object):
    ...
    def __init__(self, scopes_functional_role_member_request: ScopesFunctionalRoleMemberRequest = ScopesFunctionalRoleMemberRequest()) -> None:
    ...
    def user_id_type(self, user_id_type: str) -> "ScopesFunctionalRoleMemberRequestBuilder":
        ...
        self._scopes_functional_role_member_request.queries["user_id_type"] = str(user_id_type)
        return self
    ...
    def department_id_type(self, department_id_type: str) -> "ScopesFunctionalRoleMemberRequestBuilder":
        ...
        self._scopes_functional_role_member_request.queries["department_id_type"] = str(department_id_type)
        return self
    ...
    def role_id(self, role_id: str) -> "ScopesFunctionalRoleMemberRequestBuilder":
        ...
        self._scopes_functional_role_member_request.paths["role_id"] = role_id
        return self

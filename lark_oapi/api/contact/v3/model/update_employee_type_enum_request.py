...
class UpdateEmployeeTypeEnumRequestBuilder(object):
    def __init__(self) -> None:
        ...
        update_employee_type_enum_request.uri = (
            "/open-apis/contact/v3/employee_type_enums/:enum_id"
        )
        update_employee_type_enum_request.token_types = {AccessTokenType.TENANT}
        self._update_employee_type_enum_request: UpdateEmployeeTypeEnumRequest = (
            update_employee_type_enum_request
        )
    ...
    def request_body(
        self, request_body: EmployeeTypeEnum
    ) -> "UpdateEmployeeTypeEnumRequestBuilder":

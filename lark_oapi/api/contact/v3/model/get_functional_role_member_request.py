...
class GetFunctionalRoleMemberRequestBuilder(object):
    def __init__(self) -> None:
        ...
        get_functional_role_member_request.uri = (
        ...
        self._get_functional_role_member_request: GetFunctionalRoleMemberRequest = (
            get_functional_role_member_request
        )

    def user_id_type(
        self, user_id_type: str
    ) -> "GetFunctionalRoleMemberRequestBuilder":
    ...
    def department_id_type(
        ...
        self._get_functional_role_member_request.add_query(

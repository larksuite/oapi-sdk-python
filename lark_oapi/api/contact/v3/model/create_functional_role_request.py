...
class CreateFunctionalRoleRequestBuilder(object):
    def __init__(self) -> None:
        ...
        self._create_functional_role_request: CreateFunctionalRoleRequest = (
            create_functional_role_request
        )

    def request_body(
        self, request_body: CreateFunctionalRoleRequestBody
    ) -> "CreateFunctionalRoleRequestBuilder":

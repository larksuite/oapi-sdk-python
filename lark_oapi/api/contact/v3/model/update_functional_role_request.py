...
class UpdateFunctionalRoleRequestBuilder(object):
    def __init__(self) -> None:
        ...
        update_functional_role_request.uri = (
            "/open-apis/contact/v3/functional_roles/:role_id"
        )
        update_functional_role_request.token_types = {AccessTokenType.TENANT}
        self._update_functional_role_request: UpdateFunctionalRoleRequest = (
            update_functional_role_request
        )
    ...
    def request_body(
        self, request_body: UpdateFunctionalRoleRequestBody
    ) -> "UpdateFunctionalRoleRequestBuilder":

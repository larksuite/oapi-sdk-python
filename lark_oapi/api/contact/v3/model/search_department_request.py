...
class SearchDepartmentRequestBuilder(object):
    ...
    def user_id_type(self, user_id_type: str) -> "SearchDepartmentRequestBuilder":
        ...
        self._search_department_request.queries["user_id_type"] = str(user_id_type)
        return self

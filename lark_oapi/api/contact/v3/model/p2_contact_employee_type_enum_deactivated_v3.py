...
class P2ContactEmployeeTypeEnumDeactivatedV3Data(object):
    _types = {
...
class P2ContactEmployeeTypeEnumDeactivatedV3(EventContext):
    _types = {"event": P2ContactEmployeeTypeEnumDeactivatedV3Data}

    def __init__(self, d=None):
        super().__init__(d)
        self._types.update(super()._types)
        self.event: Optional[P2ContactEmployeeTypeEnumDeactivatedV3Data] = None
        init(self, d, self._types)

...
class CreateEmployeeTypeEnumRequestBuilder(object):
    def __init__(self) -> None:
        ...
        create_employee_type_enum_request.uri = (
            "/open-apis/contact/v3/employee_type_enums"
        )
        create_employee_type_enum_request.token_types = {AccessTokenType.TENANT}
        self._create_employee_type_enum_request: CreateEmployeeTypeEnumRequest = (
            create_employee_type_enum_request
        )

    def request_body(
        self, request_body: EmployeeTypeEnum
    ) -> "CreateEmployeeTypeEnumRequestBuilder":

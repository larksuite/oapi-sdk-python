...
class BatchAddGroupMemberRequestBuilder(object):
    def __init__(self) -> None:
        ...
        batch_add_group_member_request.uri = (
            "/open-apis/contact/v3/group/:group_id/member/batch_add"
        )
        batch_add_group_member_request.token_types = {AccessTokenType.TENANT}
        self._batch_add_group_member_request: BatchAddGroupMemberRequest = (
            batch_add_group_member_request
        )
    ...
    def request_body(
        self, request_body: BatchAddGroupMemberRequestBody
    ) -> "BatchAddGroupMemberRequestBuilder":

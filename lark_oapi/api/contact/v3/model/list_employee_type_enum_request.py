...
class ListEmployeeTypeEnumRequestBuilder(object):
    ...
    def __init__(self, list_employee_type_enum_request: ListEmployeeTypeEnumRequest = ListEmployeeTypeEnumRequest()) -> None:
    ...
    def page_token(self, page_token: str) -> "ListEmployeeTypeEnumRequestBuilder":
        ...
        self._list_employee_type_enum_request.queries["page_token"] = str(page_token)
        return self
    ...
    def page_size(self, page_size: int) -> "ListEmployeeTypeEnumRequestBuilder":
        ...
        self._list_employee_type_enum_request.queries["page_size"] = str(page_size)
        return self

...
class PatchUserRequestBuilder(object):
    ...
    def user_id_type(self, user_id_type: str) -> "PatchUserRequestBuilder":
        ...
        self._patch_user_request.queries["user_id_type"] = str(user_id_type)
        return self
    ...
    def department_id_type(self, department_id_type: str) -> "PatchUserRequestBuilder":
        ...
        self._patch_user_request.queries["department_id_type"] = str(department_id_type)
        return self

    def user_id(self, user_id: str) -> "PatchUserRequestBuilder":
        self._patch_user_request.user_id = user_id
        self._patch_user_request.paths["user_id"] = user_id
        return self

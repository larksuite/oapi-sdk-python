...
class BatchDeleteFunctionalRoleMemberRequestBuilder(object):
    ...
    ) -> "BatchDeleteFunctionalRoleMemberRequestBuilder":
        self._batch_delete_functional_role_member_request.user_id_type = user_id_type
        self._batch_delete_functional_role_member_request.add_query(
    ...
    def role_id(self, role_id: str) -> "BatchDeleteFunctionalRoleMemberRequestBuilder":
        ...
        self._batch_delete_functional_role_member_request.paths["role_id"] = str(
            role_id
        )
        return self

    def request_body(
        self, request_body: BatchDeleteFunctionalRoleMemberRequestBody
    ) -> "BatchDeleteFunctionalRoleMemberRequestBuilder":

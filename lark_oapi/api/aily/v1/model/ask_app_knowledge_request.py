...
class AskAppKnowledgeRequestBuilder(object):
    def __init__(self) -> None:
        ...
        ask_app_knowledge_request.token_types = {
            AccessTokenType.USER,
            AccessTokenType.TENANT,
        }
        self._ask_app_knowledge_request: AskAppKnowledgeRequest = (
            ask_app_knowledge_request
        )
    ...
    def request_body(
        self, request_body: AskAppKnowledgeRequestBody
    ) -> "AskAppKnowledgeRequestBuilder":

...
class CreateAilySessionRunRequestBuilder(object):
    def __init__(self) -> None:
        ...
        create_aily_session_run_request.uri = (
            "/open-apis/aily/v1/sessions/:aily_session_id/runs"
        )
        create_aily_session_run_request.token_types = {
            AccessTokenType.USER,
            AccessTokenType.TENANT,
        }
        self._create_aily_session_run_request: CreateAilySessionRunRequest = (
            create_aily_session_run_request
        )

    def aily_session_id(
        self, aily_session_id: str
    ) -> "CreateAilySessionRunRequestBuilder":
        self._create_aily_session_run_request.aily_session_id = aily_session_id
        self._create_aily_session_run_request.paths["aily_session_id"] = str(
            aily_session_id
        )
        return self

    def request_body(
        self, request_body: CreateAilySessionRunRequestBody
    ) -> "CreateAilySessionRunRequestBuilder":

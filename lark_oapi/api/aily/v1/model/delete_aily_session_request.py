...
class DeleteAilySessionRequestBuilder(object):
    def __init__(self) -> None:
        ...
        delete_aily_session_request.token_types = {
            AccessTokenType.USER,
            AccessTokenType.TENANT,
        }
        self._delete_aily_session_request: DeleteAilySessionRequest = (
            delete_aily_session_request
        )

    def aily_session_id(
        self, aily_session_id: str
    ) -> "DeleteAilySessionRequestBuilder":
        self._delete_aily_session_request.aily_session_id = aily_session_id
        self._delete_aily_session_request.paths["aily_session_id"] = str(
            aily_session_id
        )
        return self

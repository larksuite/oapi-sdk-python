...
class GetAilySessionAilyMessageRequestBuilder(object):
    def __init__(self) -> None:
        ...
        get_aily_session_aily_message_request.uri = (
            "/open-apis/aily/v1/sessions/:aily_session_id/messages/:aily_message_id"
        )
        get_aily_session_aily_message_request.token_types = {
    ...
    ) -> "GetAilySessionAilyMessageRequestBuilder":
        self._get_aily_session_aily_message_request.aily_session_id = aily_session_id
        self._get_aily_session_aily_message_request.paths["aily_session_id"] = str(
            aily_session_id
        )
        return self

    def aily_message_id(
        self, aily_message_id: str
    ) -> "GetAilySessionAilyMessageRequestBuilder":
        self._get_aily_session_aily_message_request.aily_message_id = aily_message_id
        self._get_aily_session_aily_message_request.paths["aily_message_id"] = str(
            aily_message_id
        )
        return self

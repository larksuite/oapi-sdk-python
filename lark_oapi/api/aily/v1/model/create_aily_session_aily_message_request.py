...
class CreateAilySessionAilyMessageRequestBuilder(object):
    def __init__(self) -> None:
        ...
        create_aily_session_aily_message_request.uri = (
            "/open-apis/aily/v1/sessions/:aily_session_id/messages"
        )
        create_aily_session_aily_message_request.token_types = {
    ...
    ) -> "CreateAilySessionAilyMessageRequestBuilder":
        self._create_aily_session_aily_message_request.aily_session_id = aily_session_id
        self._create_aily_session_aily_message_request.paths["aily_session_id"] = str(
            aily_session_id
        )
        return self

    def request_body(
        self, request_body: CreateAilySessionAilyMessageRequestBody
    ) -> "CreateAilySessionAilyMessageRequestBuilder":

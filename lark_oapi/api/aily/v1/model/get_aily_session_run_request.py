...
class GetAilySessionRunRequestBuilder(object):
    def __init__(self) -> None:
        ...
        get_aily_session_run_request.uri = (
            "/open-apis/aily/v1/sessions/:aily_session_id/runs/:run_id"
        )
        get_aily_session_run_request.token_types = {
            AccessTokenType.USER,
            AccessTokenType.TENANT,
        }
        self._get_aily_session_run_request: GetAilySessionRunRequest = (
            get_aily_session_run_request
        )

    def aily_session_id(
        self, aily_session_id: str
    ) -> "GetAilySessionRunRequestBuilder":
        self._get_aily_session_run_request.aily_session_id = aily_session_id
        self._get_aily_session_run_request.paths["aily_session_id"] = str(
            aily_session_id
        )
        return self

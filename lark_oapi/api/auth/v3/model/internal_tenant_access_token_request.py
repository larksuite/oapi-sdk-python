...
class InternalTenantAccessTokenRequestBuilder(object):
    def __init__(self) -> None:
        ...
        internal_tenant_access_token_request.uri = (
            "/open-apis/auth/v3/tenant_access_token/internal"
        )
        internal_tenant_access_token_request.token_types = {}
        self._internal_tenant_access_token_request: InternalTenantAccessTokenRequest = (
            internal_tenant_access_token_request
        )

    def request_body(
        self, request_body: InternalTenantAccessTokenRequestBody

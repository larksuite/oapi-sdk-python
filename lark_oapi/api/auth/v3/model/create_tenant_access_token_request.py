...
class CreateTenantAccessTokenRequestBuilder(object):
    def __init__(self) -> None:
        ...
        create_tenant_access_token_request.uri = (
            "/open-apis/auth/v3/tenant_access_token"
        )
        create_tenant_access_token_request.token_types = {}
        self._create_tenant_access_token_request: CreateTenantAccessTokenRequest = (
            create_tenant_access_token_request
        )

    def request_body(
        self, request_body: CreateTenantAccessTokenRequestBody
    ) -> "CreateTenantAccessTokenRequestBuilder":

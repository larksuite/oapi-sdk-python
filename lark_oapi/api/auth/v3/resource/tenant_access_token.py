...
class TenantAccessToken(object):
    ...
    def create(self, request: CreateTenantAccessTokenRequest, option: RequestOption = RequestOption()) -> CreateTenantAccessTokenResponse:
        # 鉴权、获取token
    ...
    def internal(self, request: InternalTenantAccessTokenRequest, option: RequestOption = RequestOption()) -> InternalTenantAccessTokenResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

...
class DeleteDataSourceRequestBuilder(object):
    ...
    def __init__(self, delete_data_source_request: DeleteDataSourceRequest = DeleteDataSourceRequest()) -> None:
    ...
    def data_source_id(self, data_source_id: str) -> "DeleteDataSourceRequestBuilder":
        ...
        self._delete_data_source_request.paths["data_source_id"] = data_source_id
        return self

...
class DeleteDataSourceItemRequestBuilder(object):
    def __init__(self) -> None:
        ...
        delete_data_source_item_request.uri = (
        ...
        self._delete_data_source_item_request: DeleteDataSourceItemRequest = (
            delete_data_source_item_request
        )

    def data_source_id(
        self, data_source_id: str
    ) -> "DeleteDataSourceItemRequestBuilder":
        self._delete_data_source_item_request.data_source_id = data_source_id
        self._delete_data_source_item_request.paths["data_source_id"] = str(
            data_source_id
        )
        return self

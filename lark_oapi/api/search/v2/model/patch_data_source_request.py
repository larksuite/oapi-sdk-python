...
class PatchDataSourceRequestBuilder(object):
    def __init__(self) -> None:
        ...
        patch_data_source_request.uri = (
            "/open-apis/search/v2/data_sources/:data_source_id"
        )
        patch_data_source_request.token_types = {AccessTokenType.TENANT}
        self._patch_data_source_request: PatchDataSourceRequest = (
            patch_data_source_request
        )
    ...
    def request_body(
        self, request_body: PatchDataSourceRequestBody
    ) -> "PatchDataSourceRequestBuilder":

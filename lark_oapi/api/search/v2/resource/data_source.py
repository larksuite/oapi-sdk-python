...
class DataSource(object):
    ...
    def create(self, request: CreateDataSourceRequest, option: RequestOption = RequestOption()) -> CreateDataSourceResponse:
        # 鉴权、获取token
    ...
    def delete(self, request: DeleteDataSourceRequest, option: RequestOption = RequestOption()) -> DeleteDataSourceResponse:
        # 鉴权、获取token
        verify(self.config, request, option)
    ...
    def patch(self, request: PatchDataSourceRequest, option: RequestOption = RequestOption()) -> PatchDataSourceResponse:
        # 鉴权、获取token
        verify(self.config, request, option)

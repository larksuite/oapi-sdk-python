...
class ProgressRecord(object):
    ...
    def create(self, request: CreateProgressRecordRequest, option: Optional[RequestOption] = None) -> CreateProgressRecordResponse:
        if option is None:
    ...
    async def acreate(self, request: CreateProgressRecordRequest, option: Optional[RequestOption] = None) -> CreateProgressRecordResponse:
        if option is None:
            option = RequestOption()
    ...
    def delete(self, request: DeleteProgressRecordRequest, option: Optional[RequestOption] = None) -> DeleteProgressRecordResponse:
        if option is None:
            option = RequestOption()
    ...
    async def adelete(self, request: DeleteProgressRecordRequest, option: Optional[RequestOption] = None) -> DeleteProgressRecordResponse:
        if option is None:
            option = RequestOption()
    ...
    def get(self, request: GetProgressRecordRequest, option: Optional[RequestOption] = None) -> GetProgressRecordResponse:
        if option is None:
            option = RequestOption()
    ...
    async def aget(self, request: GetProgressRecordRequest, option: Optional[RequestOption] = None) -> GetProgressRecordResponse:
        if option is None:
            option = RequestOption()
    ...
    def update(self, request: UpdateProgressRecordRequest, option: Optional[RequestOption] = None) -> UpdateProgressRecordResponse:
        if option is None:
            option = RequestOption()
    ...
    async def aupdate(self, request: UpdateProgressRecordRequest, option: Optional[RequestOption] = None) -> UpdateProgressRecordResponse:
        if option is None:
            option = RequestOption()

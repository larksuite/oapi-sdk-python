...
class BatchUpdateMetricSourceTableItemResponseBodyBuilder(object):
    def __init__(self, batch_update_metric_source_table_item_response_body: BatchUpdateMetricSourceTableItemResponseBody = BatchUpdateMetricSourceTableItemResponseBody({})) -> None:

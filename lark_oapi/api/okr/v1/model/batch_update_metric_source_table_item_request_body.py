...
class BatchUpdateMetricSourceTableItemRequestBodyBuilder(object):
    def __init__(self, batch_update_metric_source_table_item_request_body: BatchUpdateMetricSourceTableItemRequestBody = BatchUpdateMetricSourceTableItemRequestBody({})) -> None:

...
class PatchMetricSourceTableItemRequestBuilder(object):
    ...
    def __init__(self, patch_metric_source_table_item_request: PatchMetricSourceTableItemRequest = PatchMetricSourceTableItemRequest()) -> None:
    ...
    def user_id_type(self, user_id_type: str) -> "PatchMetricSourceTableItemRequestBuilder":
        ...
        self._patch_metric_source_table_item_request.queries["user_id_type"] = str(user_id_type)
        return self
    ...
    def metric_source_id(self, metric_source_id: str) -> "PatchMetricSourceTableItemRequestBuilder":
        ...
        self._patch_metric_source_table_item_request.paths["metric_source_id"] = metric_source_id
        return self
    ...
    def metric_table_id(self, metric_table_id: str) -> "PatchMetricSourceTableItemRequestBuilder":
        ...
        self._patch_metric_source_table_item_request.paths["metric_table_id"] = metric_table_id
        return self
    ...
    def metric_item_id(self, metric_item_id: str) -> "PatchMetricSourceTableItemRequestBuilder":
        ...
        self._patch_metric_source_table_item_request.paths["metric_item_id"] = metric_item_id
        return self

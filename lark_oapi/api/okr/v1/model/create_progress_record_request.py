...
class CreateProgressRecordRequestBuilder(object):
    ...
    def __init__(self, create_progress_record_request: CreateProgressRecordRequest = CreateProgressRecordRequest()) -> None:
    ...
    def user_id_type(self, user_id_type: str) -> "CreateProgressRecordRequestBuilder":
        ...
        self._create_progress_record_request.queries["user_id_type"] = str(user_id_type)
        return self

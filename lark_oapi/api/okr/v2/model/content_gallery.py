...
class ContentGallery(object):
    _types = {
        "images": List[ContentImageItem],
    }

    def __init__(self, d=None):
        self.images: Optional[List[ContentImageItem]] = None
...
class ContentGalleryBuilder(object):
    ...
    def images(self, images: List[ContentImageItem]) -> "ContentGalleryBuilder":
        self._content_gallery.images = images
        return self

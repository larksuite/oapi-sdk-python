...
class EventDispatcherHandlerBuilder(object):
	...
	def register_p2_moments_dislike_created_v1(self, f: Callable[[P2MomentsDislikeCreatedV1], None]) -> "EventDispatcherHandlerBuilder":
	...
	def register_p2_moments_dislike_deleted_v1(self, f: Callable[[P2MomentsDislikeDeletedV1], None]) -> "EventDispatcherHandlerBuilder":

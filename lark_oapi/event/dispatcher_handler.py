...
class EventDispatcherHandler(HttpHandler):
    ...
    def do(self, req: RawRequest) -> RawResponse:
        ...
        try:
            ...
            # Token check: if verification_token is configured, every request
            # must pass — including requests that omit the token entirely.
    ...
    def _do_without_validation(self, payload: bytes) -> Any:
        # Internal: for already-authenticated channels (e.g. WebSocket) only.
        # Skips token / signature / decryption checks — do not call externally.

...
def main():
	...
	# 构造请求对象
	request: CreateAgentScheduleRequest = lark.helpdesk.v1.CreateAgentScheduleRequest.builder() \
		.request_body(lark.helpdesk.v1.CreateAgentScheduleRequestBody.builder()
					  .agent_schedules([])
					  .build()) \
		.build()

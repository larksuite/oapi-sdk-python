...
def main():
	...
	# 构造请求对象
	request: StartServiceTicketRequest = lark.helpdesk.v1.StartServiceTicketRequest.builder() \
		.request_body(lark.helpdesk.v1.StartServiceTicketRequestBody.builder()
					  .human_service(False)
					  .appointed_agents([])

...
def main():
	...
	# 构造请求对象
	request: CreateEmployeesInternationalAssignmentRequest = CreateEmployeesInternationalAssignmentRequest.builder() \
	...
	# 发起请求
	response: CreateEmployeesInternationalAssignmentResponse = client.corehr.v2.employees_international_assignment.create(request)

	# 处理失败返回
	if not response.success():
		lark.logger.error(
			f"client.corehr.v2.employees_international_assignment.create failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}")
		return
...
async def amain():
	...
	# 发起请求
	response: CreateEmployeesInternationalAssignmentResponse = await client.corehr.v2.employees_international_assignment.acreate(request)

	# 处理失败返回
	if not response.success():
		lark.logger.error(
			f"client.corehr.v2.employees_international_assignment.acreate failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}")
		return

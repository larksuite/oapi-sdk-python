...
def main():
    ...
    # 发起请求
    response: CreateEmployeesInternationalAssignmentResponse = client.corehr.v2.employees_international_assignment.create(
        request)
...
async def amain():
    ...
    # 发起请求
    response: CreateEmployeesInternationalAssignmentResponse = await client.corehr.v2.employees_international_assignment.acreate(
        request)

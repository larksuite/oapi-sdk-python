...
def main():
    ...
    # 发起请求
    response: ExtractEntityResponse = client.lingo.v1.entity.extract(request)

    # 处理失败返回
    if not response.success():
        lark.logger.error(
            f"client.lingo.v1.entity.extract failed, code: {response.code}, msg: {response.msg}, log_id: {response.get_log_id()}")
        return

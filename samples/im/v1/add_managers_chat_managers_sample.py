...
def main():
	...
	# 构造请求对象
	request: AddManagersChatManagersRequest = lark.im.v1.AddManagersChatManagersRequest.builder() \
		.chat_id("oc_a0553eda9014c201e6969b478895c230") \
		.member_id_type("open_id") \
		.request_body(lark.im.v1.AddManagersChatManagersRequestBody.builder()
					  .manager_ids([])
					  .build()) \
		.build()

...
def main():
	...
	# 构造请求对象
	request: UpdateSpreadsheetSheetFilterRequest = lark.sheets.v3.UpdateSpreadsheetSheetFilterRequest.builder() \
		.spreadsheet_token("") \
		.sheet_id("") \
		.request_body(lark.sheets.v3.UpdateSheetFilter.builder()
					  .col("str")

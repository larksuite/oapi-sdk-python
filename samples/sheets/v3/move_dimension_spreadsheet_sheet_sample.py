...
def main():
	...
	# 构造请求对象
	request: MoveDimensionSpreadsheetSheetRequest = lark.sheets.v3.MoveDimensionSpreadsheetSheetRequest.builder() \
		.spreadsheet_token("") \
		.sheet_id("") \
		.request_body(lark.sheets.v3.MoveDimension.builder()

...
def main():
	...
	# 构造请求对象
	request: PatchReserveConfigDisableInformRequest = lark.vc.v1.PatchReserveConfigDisableInformRequest.builder() \
		.reserve_config_id("omm_3c5dd7e09bac0c1758fcf9511bd1a771") \
		.user_id_type("user_id") \
		.request_body(lark.vc.v1.PatchReserveConfigDisableInformRequestBody.builder()
					  .scope_type(2)

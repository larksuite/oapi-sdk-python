...
def main():
	...
	# 构造请求对象
	request: SetRoomAccessCodeRoomConfigRequest = lark.vc.v1.SetRoomAccessCodeRoomConfigRequest.builder() \
		.request_body(lark.vc.v1.SetRoomAccessCodeRoomConfigRequestBody.builder()
					  .scope(5)
					  .country_id("1")
					  .district_id("2")
					  .building_id("3")

...
def main():
	...
	# 构造请求对象
	request: SetCheckboardAccessCodeRoomConfigRequest = lark.vc.v1.SetCheckboardAccessCodeRoomConfigRequest.builder() \
		.request_body(lark.vc.v1.SetCheckboardAccessCodeRoomConfigRequestBody.builder()
					  .scope(5)
					  .country_id("1")
					  .district_id("2")
					  .building_id("3")

...
def main():
	...
	# 构造请求对象
	request: CreateLeaveGrantingRecordRequest = lark.corehr.v1.CreateLeaveGrantingRecordRequest.builder() \
		.user_id_type("open_id") \
		.request_body(lark.corehr.v1.CreateLeaveGrantingRecordRequestBody.builder()

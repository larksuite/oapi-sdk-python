...
def main():
	...
	# 构造请求对象
	request: BatchDeleteFunctionalRoleMemberRequest = lark.contact.v3.BatchDeleteFunctionalRoleMemberRequest.builder() \
		.role_id("7vrj3vk70xk7v5r") \
		.user_id_type("open_id") \
		.request_body(lark.contact.v3.BatchDeleteFunctionalRoleMemberRequestBody.builder()
					  .members([])
					  .build()) \
		.build()

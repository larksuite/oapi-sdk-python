...
def main():
	...
	# 构造请求对象
	request: ScopesFunctionalRoleMemberRequest = lark.contact.v3.ScopesFunctionalRoleMemberRequest.builder() \
		.role_id("7vrj3vk70xk7v5r") \
		.user_id_type("open_id") \
		.department_id_type("open_department_id") \
		.request_body(lark.contact.v3.ScopesFunctionalRoleMemberRequestBody.builder()
					  .members([])
					  .departments([])
					  .build()) \
		.build()

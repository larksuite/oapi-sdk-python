...
def main():
	...
	# 构造请求对象
	request: UnbindDepartmentChatDepartmentRequest = lark.contact.v3.UnbindDepartmentChatDepartmentRequest.builder() \
		.department_id_type("open_department_id") \
		.request_body(lark.contact.v3.UnbindDepartmentChatDepartmentRequestBody.builder()
					  .department_id("D096")
					  .build()) \
		.build()

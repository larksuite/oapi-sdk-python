...
def main():
	...
	# 构造请求对象
	request: BatchCreateFunctionalRoleMemberRequest = lark.contact.v3.BatchCreateFunctionalRoleMemberRequest.builder() \
		.role_id("7vrj3vk70xk7v5r") \
		.user_id_type("open_id") \
		.request_body(lark.contact.v3.BatchCreateFunctionalRoleMemberRequestBody.builder()
					  .members([])
					  .build()) \
		.build()

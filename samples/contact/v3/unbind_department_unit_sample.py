...
def main():
	...
	# 构造请求对象
	request: UnbindDepartmentUnitRequest = lark.contact.v3.UnbindDepartmentUnitRequest.builder() \
		.request_body(lark.contact.v3.UnbindDepartmentUnitRequestBody.builder()
					  .unit_id("BU121")

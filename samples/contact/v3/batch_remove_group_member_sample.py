...
def main():
	...
	# 构造请求对象
	request: BatchRemoveGroupMemberRequest = lark.contact.v3.BatchRemoveGroupMemberRequest.builder() \
		.group_id("test_group") \
		.request_body(lark.contact.v3.BatchRemoveGroupMemberRequestBody.builder()
					  .members([])
					  .build()) \
		.build()

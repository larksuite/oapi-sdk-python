...
def main():
	...
	# 构造请求对象
	request: BatchDeleteAppTableRequest = lark.bitable.v1.BatchDeleteAppTableRequest.builder() \
		.app_token("appbcbWCzen6D8dezhoCH2RpMAh") \
		.request_body(lark.bitable.v1.BatchDeleteAppTableRequestBody.builder()
					  .table_ids([])
					  .build()) \
		.build()

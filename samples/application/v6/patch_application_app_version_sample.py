...
def main():
	...
	# 构造请求对象
	request: PatchApplicationAppVersionRequest = lark.application.v6.PatchApplicationAppVersionRequest.builder() \
		...
		.reject_reason("拒绝理由") \
		.request_body(lark.application.v6.ApplicationAppVersion.builder()
					  .status(1)
					  .build()) \
		.build()

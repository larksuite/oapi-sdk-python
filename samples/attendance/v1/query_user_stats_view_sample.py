...
def main():
	...
	# 构造请求对象
	request: QueryUserStatsViewRequest = lark.attendance.v1.QueryUserStatsViewRequest.builder() \
		.employee_type("employee_id") \
		.request_body(lark.attendance.v1.QueryUserStatsViewRequestBody.builder()
					  .locale("zh")
					  .stats_type("daily")
					  .user_id("dd31248a")
					  .build()) \

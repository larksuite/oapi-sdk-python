...
def main():
	...
	# 构造请求对象
	request: QueryUserStatsFieldRequest = lark.attendance.v1.QueryUserStatsFieldRequest.builder() \
		.employee_type("employee_id") \
		.request_body(lark.attendance.v1.QueryUserStatsFieldRequestBody.builder()
					  .locale("zh")
					  .stats_type("daily")
					  .start_date(20210316)
					  .end_date(20210323)

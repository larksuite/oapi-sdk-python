...
def main():
	...
	# 构造请求对象
	request: ModifyUserSettingRequest = lark.attendance.v1.ModifyUserSettingRequest.builder() \
		.employee_type("employee_id") \
		.request_body(lark.attendance.v1.ModifyUserSettingRequestBody.builder()

...
def main():
	...
	# 构造请求对象
	request: QueryUserStatsDataRequest = lark.attendance.v1.QueryUserStatsDataRequest.builder() \
		.employee_type("employee_id") \
		.request_body(lark.attendance.v1.QueryUserStatsDataRequestBody.builder()
					  .locale("zh")
					  .stats_type("month")
					  .start_date(20210316)
					  .end_date(20210323)

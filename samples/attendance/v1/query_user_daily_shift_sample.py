...
def main():
	...
	# 构造请求对象
	request: QueryUserDailyShiftRequest = lark.attendance.v1.QueryUserDailyShiftRequest.builder() \
		.employee_type("employee_id") \
		.request_body(lark.attendance.v1.QueryUserDailyShiftRequestBody.builder()
					  .user_ids([])

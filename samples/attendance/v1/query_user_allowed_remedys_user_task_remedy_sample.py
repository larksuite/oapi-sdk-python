...
def main():
	...
	# 构造请求对象
	request: QueryUserAllowedRemedysUserTaskRemedyRequest = lark.attendance.v1.QueryUserAllowedRemedysUserTaskRemedyRequest.builder() \
		.employee_type("employee_id") \
		.request_body(lark.attendance.v1.QueryUserAllowedRemedysUserTaskRemedyRequestBody.builder()
					  .user_id("abd754f7")

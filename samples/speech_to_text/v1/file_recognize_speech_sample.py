...
def main():
	...
	# 构造请求对象
	request: FileRecognizeSpeechRequest = lark.speech_to_text.v1.FileRecognizeSpeechRequest.builder() \
		.request_body(lark.speech_to_text.v1.FileRecognizeSpeechRequestBody.builder()

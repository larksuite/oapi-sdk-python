...
def main():
	...
	# 构造请求对象
	request: CreateRefreshAccessTokenRequest = lark.authen.v1.CreateRefreshAccessTokenRequest.builder() \
		.request_body(lark.authen.v1.CreateRefreshAccessTokenRequestBody.builder()

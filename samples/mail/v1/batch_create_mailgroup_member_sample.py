...
def main():
	...
	# 构造请求对象
	request: BatchCreateMailgroupMemberRequest = lark.mail.v1.BatchCreateMailgroupMemberRequest.builder() \
		.mailgroup_id("xxxxxxxxxxxxxxx or test_mail_group@xxx.xx") \
		.user_id_type("open_id") \
		.department_id_type("department_id") \
		.request_body(lark.mail.v1.BatchCreateMailgroupMemberRequestBody.builder()
					  .items([])
					  .build()) \
		.build()

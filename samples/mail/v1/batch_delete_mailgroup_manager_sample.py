...
def main():
	...
	# 构造请求对象
	request: BatchDeleteMailgroupManagerRequest = lark.mail.v1.BatchDeleteMailgroupManagerRequest.builder() \
		.mailgroup_id("xxxxxxxxxxxxxxx 或 test_mail_group@xxx.xx") \
		.user_id_type("open_id") \
		.request_body(lark.mail.v1.BatchDeleteMailgroupManagerRequestBody.builder()

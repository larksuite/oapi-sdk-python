...
def main():
	...
	# 构造请求对象
	request: CreateExternalBackgroundCheckRequest = lark.hire.v1.CreateExternalBackgroundCheckRequest.builder() \
		.request_body(lark.hire.v1.ExternalBackgroundCheck.builder()
					  .external_id("123")

...
def main():
	...
	# 构造请求对象
	request: BatchCloseSystemStatusRequest = lark.personal_settings.v1.BatchCloseSystemStatusRequest.builder() \
		.system_status_id("7101214603622940671") \
		.user_id_type("open_id") \
		.request_body(lark.personal_settings.v1.BatchCloseSystemStatusRequestBody.builder()
					  .user_list([])
					  .build()) \
		.build()

...
class ImageGetReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'get')
...
class ImagePutReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'put')
        conf = root_service.conf
        req = Request(http_path, 'POST', [ACCESS_TOKEN_TYPE_TENANT], self.body,  output_class=Image, request_opts=self.request_opts)
        resp = req.do(conf)
        return resp

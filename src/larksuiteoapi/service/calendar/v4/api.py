...
class CalendarCreateReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'calendars')
        conf = root_service.conf
        req = Request(http_path, 'POST', [ACCESS_TOKEN_TYPE_TENANT, ACCESS_TOKEN_TYPE_USER],
...
class CalendarEventDeleteReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'calendars/:calendar_id/events/:event_id')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        req = Request(http_path, 'DELETE', [ACCESS_TOKEN_TYPE_TENANT, ACCESS_TOKEN_TYPE_USER],
...
class CalendarEventGetReqCall(object):
    ...
    def do(self):
        ...
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        req = Request(http_path, 'GET', [ACCESS_TOKEN_TYPE_TENANT, ACCESS_TOKEN_TYPE_USER],
                      None, request_opts=self.request_opts)
        resp = req.do(conf)
        return resp
...
class CalendarPatchReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'calendars/:calendar_id')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        req = Request(http_path, 'PATCH', [ACCESS_TOKEN_TYPE_TENANT, ACCESS_TOKEN_TYPE_USER],
...
class CalendarAclListReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'calendars/:calendar_id/acls')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
...
class CalendarAclDeleteReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'calendars/:calendar_id/acls/:acl_id')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        req = Request(http_path, 'DELETE', [ACCESS_TOKEN_TYPE_TENANT, ACCESS_TOKEN_TYPE_USER],
                      None, request_opts=self.request_opts)
...
class CalendarEventCreateReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'calendars/:calendar_id/events')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        req = Request(http_path, 'POST', [ACCESS_TOKEN_TYPE_TENANT, ACCESS_TOKEN_TYPE_USER],
...
class CalendarEventAttendeeListReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'calendars/:calendar_id/events/:event_id/attendees')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        self.request_opts += [set_query_params(self.query_params)]
        req = Request(http_path, 'GET', [ACCESS_TOKEN_TYPE_TENANT, ACCESS_TOKEN_TYPE_USER],
...
class CalendarEventAttendeeBatchDeleteReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'calendars/:calendar_id/events/:event_id/attendees/batch_delete')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        req = Request(http_path, 'POST', [ACCESS_TOKEN_TYPE_TENANT, ACCESS_TOKEN_TYPE_USER],
...
class CalendarSearchReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'calendars/search')
        conf = root_service.conf
        self.request_opts += [set_query_params(self.query_params)]
        req = Request(http_path, 'POST', [ACCESS_TOKEN_TYPE_TENANT],
...
class FreebusyListReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'freebusy/list')
        conf = root_service.conf
        self.request_opts += [set_query_params(self.query_params)]
        req = Request(http_path, 'POST', [ACCESS_TOKEN_TYPE_TENANT],
...
class TimeoffEventDeleteReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'timeoff_events/:timeoff_event_id')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        req = Request(http_path, 'DELETE', [ACCESS_TOKEN_TYPE_TENANT],
                      None, request_opts=self.request_opts)
        resp = req.do(conf)
        return resp
...
class TimeoffEventCreateReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'timeoff_events')
        conf = root_service.conf
        self.request_opts += [set_query_params(self.query_params)]
        req = Request(http_path, 'POST', [ACCESS_TOKEN_TYPE_TENANT],
...
class CalendarUnsubscribeReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'calendars/:calendar_id/unsubscribe')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
...
class CalendarEventSearchReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'calendars/:calendar_id/events/search')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        self.request_opts += [set_query_params(self.query_params)]
...
class CalendarSubscribeReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'calendars/:calendar_id/subscribe')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        req = Request(http_path, 'POST', [ACCESS_TOKEN_TYPE_USER, ACCESS_TOKEN_TYPE_TENANT],
                      None, request_opts=self.request_opts)
...
class SettingGenerateCaldavConfReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'settings/generate_caldav_conf')
        conf = root_service.conf
        req = Request(http_path, 'POST', [ACCESS_TOKEN_TYPE_USER],
...
class CalendarEventSubscriptionReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'calendars/:calendar_id/events/subscription')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        req = Request(http_path, 'POST', [ACCESS_TOKEN_TYPE_USER],
                      None, request_opts=self.request_opts)
...
class CalendarSubscriptionReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'calendars/subscription')
        conf = root_service.conf
        req = Request(http_path, 'POST', [ACCESS_TOKEN_TYPE_USER],
                      None, request_opts=self.request_opts)
        resp = req.do(conf)
...
class CalendarAclSubscriptionReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'calendars/:calendar_id/acls/subscription')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        req = Request(http_path, 'POST', [ACCESS_TOKEN_TYPE_USER],
                      None, request_opts=self.request_opts)
...
class CalendarEventAttendeeChatMemberListReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'calendars/:calendar_id/events/:event_id/attendees/:attendee_id/chat_members')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        self.request_opts += [set_query_params(self.query_params)]
        req = Request(http_path, 'GET', [ACCESS_TOKEN_TYPE_TENANT, ACCESS_TOKEN_TYPE_USER],

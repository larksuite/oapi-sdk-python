...
class Service(object):
    def __init__(self, conf):
        ...
        self.department_events = DepartmentEventService(self)
        self.group_events = GroupEventService(self)
        self.user_events = UserEventService(self)
...
class DepartmentEventService(object):
    def __init__(self, service):
        # type: (Service) -> None
        self.service = service


class GroupEventService(object):
    def __init__(self, service):
        # type: (Service) -> None
        self.service = service
...
class UserDeleteReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'users/:user_id')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        self.request_opts += [set_query_params(self.query_params)]
...
class DepartmentListReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'departments')
        conf = root_service.conf
        self.request_opts += [set_query_params(self.query_params)]
        req = Request(http_path, 'GET', [ACCESS_TOKEN_TYPE_TENANT, ACCESS_TOKEN_TYPE_USER],
                      None, request_opts=self.request_opts)
...
class UserGroupUpdateUserGroupIdReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'user_groups/:user_group_id/update_user_group_id')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        req = Request(http_path, 'PATCH', [ACCESS_TOKEN_TYPE_TENANT],
                      self.body, request_opts=self.request_opts)
        resp = req.do(conf)
        return resp
...
class DepartmentUnitDeleteReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'department_units/:unit_id')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        req = Request(http_path, 'DELETE', [ACCESS_TOKEN_TYPE_TENANT],
                      None, request_opts=self.request_opts)
...
class UserUpdateReqCall(object):
    ...
    def do(self):
        ...
        self.request_opts += [set_path_params(self.path_params)]
        self.request_opts += [set_query_params(self.query_params)]
        req = Request(http_path, 'PUT', [ACCESS_TOKEN_TYPE_TENANT],
...
class UserCreateReqCall(object):
    ...
    def set_need_send_notification(self, needSendNotification):
        # type: (bool) -> UserCreateReqCall
        self.query_params['need_send_notification'] = needSendNotification
        return self
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'users')
        conf = root_service.conf
        self.request_opts += [set_query_params(self.query_params)]
...
class UserUpdateUserIdReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'users/:user_id/update_user_id')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        self.request_opts += [set_query_params(self.query_params)]
        req = Request(http_path, 'PATCH', [ACCESS_TOKEN_TYPE_TENANT],
...
class UserGroupMemberCreateReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'user_groups/:user_group_id/members')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        self.request_opts += [set_query_params(self.query_params)]
        req = Request(http_path, 'POST', [ACCESS_TOKEN_TYPE_TENANT],
...
class UserGroupDeleteReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'user_groups/:user_group_id')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        req = Request(http_path, 'DELETE', [ACCESS_TOKEN_TYPE_TENANT],
                      None, request_opts=self.request_opts)
...
class UserGroupCreateReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'user_groups')
        conf = root_service.conf
        req = Request(http_path, 'POST', [ACCESS_TOKEN_TYPE_TENANT],
...
class UserGroupListReqCall(object):
    ...
    def do(self):
        ...
        conf = root_service.conf
        self.request_opts += [set_query_params(self.query_params)]
        req = Request(http_path, 'GET', [ACCESS_TOKEN_TYPE_TENANT],
                      None, request_opts=self.request_opts)
        resp = req.do(conf)
        return resp
...
class UserGroupMemberDeleteReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'user_groups/:user_group_id/members/:user_id')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        self.request_opts += [set_query_params(self.query_params)]
        req = Request(http_path, 'DELETE', [ACCESS_TOKEN_TYPE_TENANT],
...
class DepartmentUnitCreateReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'department_units')
        conf = root_service.conf
        req = Request(http_path, 'POST', [ACCESS_TOKEN_TYPE_TENANT],
...
class DepartmentParentReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'departments/parent')
        conf = root_service.conf
        self.request_opts += [set_query_params(self.query_params)]
        req = Request(http_path, 'GET', [ACCESS_TOKEN_TYPE_TENANT, ACCESS_TOKEN_TYPE_USER],
                      None, request_opts=self.request_opts)
...
class DepartmentUpdateDepartmentIdReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'departments/:department_id/update_department_id')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        self.request_opts += [set_query_params(self.query_params)]
        req = Request(http_path, 'PATCH', [ACCESS_TOKEN_TYPE_TENANT],
...
class DepartmentUnbindDepartmentChatReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'departments/unbind_department_chat')
        conf = root_service.conf
        self.request_opts += [set_query_params(self.query_params)]
        req = Request(http_path, 'POST', [ACCESS_TOKEN_TYPE_TENANT],
                      self.body, request_opts=self.request_opts)
...
class DepartmentSearchReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'departments/search')
        conf = root_service.conf
        self.request_opts += [set_query_params(self.query_params)]

...
class MeetingEventMeeting(object):
    ...
    sponsor = attr.ib(type=MeetingEventUser, default=None, metadata={'json': 'sponsor'})
...
class MeetingRecording(object):
    __int_to_string_fields__ = attr.ib(type=List[str], default=["id", "meeting_id", "start_time", "duration"])
    id = attr.ib(type=int, default=None, metadata={'json': 'id'})
...
class RecordingPermissionObject(object):
    id = attr.ib(type=str, default=None, metadata={'json': 'id'})
    permission_type = attr.ib(type=int, default=None, metadata={'json': 'permission_type'})
    permission = attr.ib(type=int, default=None, metadata={'json': 'permission'})
...
@to_json_decorator
@attr.s
class ReservePermissionGroup(object):
    can_be_host = attr.ib(type=bool, default=None, metadata={'json': 'can_be_host'})
    can_share_meeting = attr.ib(type=bool, default=None, metadata={'json': 'can_share_meeting'})
    can_join = attr.ib(type=bool, default=None, metadata={'json': 'can_join'})
...
class Room(object):
    ...
    is_disabled = attr.ib(type=str, default=None, metadata={'json': 'is_disabled'})
    rooms_status = attr.ib(type=int, default=None, metadata={'json': 'rooms_status'})
...
class MeetingInviteResult(object):
    invitees_result = attr.ib(type=List[MeetingParticipantResult], default=None, metadata={'json': 'invitees_result'})
...
class MeetingListResult(object):
    ...
    items = attr.ib(type=List[Meeting], default=None, metadata={'json': 'items'})
...
@attr.s
class MeetingInterviewMeetingCreatedEventData(object):
    meeting = attr.ib(type=MeetingEventMeeting, default=None, metadata={'json': 'meeting'})


@attr.s
class MeetingInterviewMeetingCreatedEvent(BaseEventV2):
    event = attr.ib(type=MeetingInterviewMeetingCreatedEventData, default=None)

...
class ReserveApplyReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'reserves/apply')
...
class ReserveDeleteReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'reserves/:reserve_id')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        req = Request(http_path, 'DELETE', [ACCESS_TOKEN_TYPE_USER],
...
class MeetingEndReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'meetings/:meeting_id/end')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        req = Request(http_path, 'PATCH', [ACCESS_TOKEN_TYPE_USER],
                      None, request_opts=self.request_opts)
        resp = req.do(conf)
        return resp
...
class MeetingRecordingGetReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'meetings/:meeting_id/recording')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        req = Request(http_path, 'GET', [ACCESS_TOKEN_TYPE_USER],
                      None, request_opts=self.request_opts)
...
class MeetingGetReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'meetings/:meeting_id')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        self.request_opts += [set_query_params(self.query_params)]
...
class ReserveGetActiveMeetingReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'reserves/:reserve_id/get_active_meeting')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        self.request_opts += [set_query_params(self.query_params)]
        req = Request(http_path, 'GET', [ACCESS_TOKEN_TYPE_USER],
...
class ReportGetDailyReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'reports/get_daily')
        conf = root_service.conf
        self.request_opts += [set_query_params(self.query_params)]
...
class ReportGetTopUserReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'reports/get_top_user')
        conf = root_service.conf
        self.request_opts += [set_query_params(self.query_params)]
        req = Request(http_path, 'GET', [ACCESS_TOKEN_TYPE_TENANT],
                      None, request_opts=self.request_opts)
...
class MeetingInviteReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'meetings/:meeting_id/invite')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        self.request_opts += [set_query_params(self.query_params)]
        req = Request(http_path, 'PATCH', [ACCESS_TOKEN_TYPE_USER],
...
class MeetingListReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'meetings')
        conf = root_service.conf
        self.request_opts += [set_query_params(self.query_params)]
        req = Request(http_path, 'GET', [ACCESS_TOKEN_TYPE_USER, ACCESS_TOKEN_TYPE_TENANT],
                      None, request_opts=self.request_opts)
...
class RoomConfigQueryReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'room_configs/query')
        conf = root_service.conf
        self.request_opts += [set_query_params(self.query_params)]
        req = Request(http_path, 'GET', [ACCESS_TOKEN_TYPE_TENANT],
                      None, request_opts=self.request_opts)
...
class RoomConfigSetReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'room_configs/set')
        conf = root_service.conf
...
class MeetingSetHostReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'meetings/:meeting_id/set_host')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        self.request_opts += [set_query_params(self.query_params)]
        req = Request(http_path, 'PATCH', [ACCESS_TOKEN_TYPE_USER],
...
class MeetingRecordingSetPermissionReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'meetings/:meeting_id/recording/set_permission')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        self.request_opts += [set_query_params(self.query_params)]
        req = Request(http_path, 'PATCH', [ACCESS_TOKEN_TYPE_USER],
...
class MeetingRecordingStartReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'meetings/:meeting_id/recording/start')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        req = Request(http_path, 'PATCH', [ACCESS_TOKEN_TYPE_USER],
                      self.body, request_opts=self.request_opts)
...
class MeetingRecordingStopReqCall(object):
    ...
    def do(self):
        ...
        http_path = path.join(root_service.base_path, 'meetings/:meeting_id/recording/stop')
        conf = root_service.conf
        self.request_opts += [set_path_params(self.path_params)]
        req = Request(http_path, 'PATCH', [ACCESS_TOKEN_TYPE_USER],
                      None, request_opts=self.request_opts)
...
class ReserveUpdateReqCall(object):
    ...
    def do(self):
        ...
        self.request_opts += [set_path_params(self.path_params)]
        self.request_opts += [set_query_params(self.query_params)]
        req = Request(http_path, 'PUT', [ACCESS_TOKEN_TYPE_USER],
